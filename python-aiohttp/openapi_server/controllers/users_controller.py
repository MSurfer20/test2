...
async def update_status(request: web.Request, status_text=None, away=None, emoji_name=None, emoji_code=None, reaction_type=None) -> web.Response:
    """Update your status
