...
/**
  * Represents the Swagger definition for GetMessages_allOf.
...
object GetMessagesAllOf {
  implicit lazy val getMessagesAllOfJsonFormat: Format[GetMessagesAllOf] = Json.format[GetMessagesAllOf]
}
