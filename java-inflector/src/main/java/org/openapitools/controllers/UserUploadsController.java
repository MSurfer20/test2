...
public class UserUploadsController  {
  ...
  /*
    public ResponseContext getFileTemporaryUrl(RequestContext request , Integer realmIdStr, String filename) {
        return new ResponseContext().status(Status.INTERNAL_SERVER_ERROR).entity( "Not implemented" );
    }
  */

  /*
    public ResponseContext uploadFile(RequestContext request , FormDataContentDisposition fileDetail) {
        return new ResponseContext().status(Status.INTERNAL_SERVER_ERROR).entity( "Not implemented" );
    }
  */
