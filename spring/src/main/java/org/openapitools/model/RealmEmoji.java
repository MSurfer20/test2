...
public class RealmEmoji   {
  ...
  private JsonNullable<Integer> authorId = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<Integer> getAuthorId() {
    return authorId;
  }

  public void setAuthorId(JsonNullable<Integer> authorId) {
