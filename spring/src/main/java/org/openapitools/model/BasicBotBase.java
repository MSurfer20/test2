...
public class BasicBotBase   {
  ...
  private JsonNullable<String> defaultSendingStream = JsonNullable.undefined();

  @JsonProperty("default_events_register_stream")
  private JsonNullable<String> defaultEventsRegisterStream = JsonNullable.undefined();
  ...
  private JsonNullable<Integer> ownerId = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<String> getDefaultSendingStream() {
    return defaultSendingStream;
  }

  public void setDefaultSendingStream(JsonNullable<String> defaultSendingStream) {
  ...
  */
  ...
  public JsonNullable<String> getDefaultEventsRegisterStream() {
    return defaultEventsRegisterStream;
  }

  public void setDefaultEventsRegisterStream(JsonNullable<String> defaultEventsRegisterStream) {
  ...
  */
  ...
  public JsonNullable<Integer> getOwnerId() {
    return ownerId;
  }

  public void setOwnerId(JsonNullable<Integer> ownerId) {
