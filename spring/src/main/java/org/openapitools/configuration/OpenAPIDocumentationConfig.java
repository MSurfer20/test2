...
public class OpenAPIDocumentationConfig {
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
            ...
            .termsOfServiceUrl("https://zulip.com")
            .version("1.0.0")
            .contact(new Contact("","", ""))
            .build();
    }
    ...
    @Bean
    public Docket customImplementation(ServletContext servletContext, @Value("${openapi.zulipREST.base-path:/api/v1}") String basePath) {
