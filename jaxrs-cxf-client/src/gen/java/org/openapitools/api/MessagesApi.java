...
public interface MessagesApi  {
    ...
    @ApiOperation(value = "Add an emoji reaction", tags={  })
    @ApiResponses(value = { 
    ...
    public JsonSuccess addReaction(@PathParam("message_id") Integer messageId, @QueryParam("emoji_name") String emojiName, @QueryParam("emoji_code") String emojiCode, @QueryParam("reaction_type") String reactionType);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Check if messages match a narrow", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success.", response = Object.class) })
    public Object checkMessagesMatchNarrow(@QueryParam("msg_ids") List<Integer> msgIds, @QueryParam("narrow") List<Object> narrow);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Delete a message", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success.", response = JsonSuccess.class),
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get public temporary URL", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get a message's edit history", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success.", response = JsonSuccessBase.class),
    ...
    @Path("/messages/{message_id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get a message's raw Markdown", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success.", response = JsonSuccessBase.class),
        @ApiResponse(code = 400, message = "Bad request.", response = InvalidMessageError.class) })
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Mark all messages as read", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success.", response = JsonSuccess.class) })
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Mark messages in a stream as read", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success.", response = JsonSuccess.class) })
    public JsonSuccess markStreamAsRead(@QueryParam("stream_id") Integer streamId);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Mark messages in a topic as read", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success.", response = JsonSuccess.class) })
    public JsonSuccess markTopicAsRead(@QueryParam("stream_id") Integer streamId, @QueryParam("topic_name") String topicName);
    ...
    @Path("/messages/{message_id}/reactions")
    @Produces({ "application/json" })
    @ApiOperation(value = "Remove an emoji reaction", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success.", response = JsonSuccess.class),
        @ApiResponse(code = 400, message = "Bad request.", response = CodedError.class) })
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Render message", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success.", response = JsonSuccessBase.class) })
    public JsonSuccessBase renderMessage(@QueryParam("content") String content);
    ...
    @Path("/messages")
    @Produces({ "application/json" })
    @ApiOperation(value = "Send a message", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success.", response = JsonSuccessBase.class),
        @ApiResponse(code = 400, message = "Bad request.", response = OneOfobjectobject.class) })
    public JsonSuccessBase sendMessage(@QueryParam("type") String type, @QueryParam("to") List<Integer> to, @QueryParam("content") String content, @QueryParam("topic") String topic, @QueryParam("queue_id") String queueId, @QueryParam("local_id") String localId);
    ...
    @Path("/messages/{message_id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Edit a message", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success.", response = JsonSuccess.class),
        @ApiResponse(code = 400, message = "Bad request.", response = CodedError.class) })
    ...
    @Path("/messages/flags")
    @Produces({ "application/json" })
    @ApiOperation(value = "Update personal message flags", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success.", response = JsonSuccessBase.class) })
    public JsonSuccessBase updateMessageFlags(@QueryParam("messages") List<Integer> messages, @QueryParam("op") String op, @QueryParam("flag") String flag);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Upload a file", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success.", response = JsonSuccessBase.class) })
