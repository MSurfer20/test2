...
public interface UsersApi  {
    ...
    public JsonSuccessBase createUser(@QueryParam("email") String email, @QueryParam("password") String password, @QueryParam("full_name") String fullName);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Create a user group", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success.", response = JsonSuccess.class),
        @ApiResponse(code = 400, message = "Bad request.", response = JsonError.class) })
    public JsonSuccess createUserGroup(@QueryParam("name") String name, @QueryParam("description") String description, @QueryParam("members") List<Integer> members);
    ...
    @Path("/users/me")
    @Produces({ "application/json" })
    @ApiOperation(value = "Deactivate own user", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success.", response = JsonSuccess.class),
        @ApiResponse(code = 400, message = "Bad request.", response = JsonError.class) })
    ...
    @Path("/users/{user_id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Deactivate a user", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success", response = JsonSuccess.class),
        @ApiResponse(code = 400, message = "Bad request", response = JsonError.class) })
    ...
    @Path("/attachments")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get attachments", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success.", response = JsonSuccessBase.class) })
    ...
    @Path("/users/me")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get own user", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success", response = JsonSuccessBase.class) })
    ...
    @Path("/users/{user_id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get a user", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success.", response = JsonSuccessBase.class) })
    ...
    @Path("/users/{email}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get a user by email", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success.", response = JsonSuccessBase.class) })
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get user presence", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success.", response = JsonSuccessBase.class) })
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Mute a user", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success.", response = JsonSuccess.class),
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Reactivate a user", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Delete a user group", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success.", response = JsonSuccess.class),
        @ApiResponse(code = 400, message = "Bad request.", response = JsonError.class) })
    ...
    @Path("/typing")
    @Produces({ "application/json" })
    @ApiOperation(value = "Set \"typing\" status", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success.", response = JsonSuccess.class),
        @ApiResponse(code = 400, message = "Bad request.", response = JsonError.class) })
    public JsonSuccess setTypingStatus(@QueryParam("op") String op, @QueryParam("to") List<Integer> to, @QueryParam("type") @DefaultValue("private")String type, @QueryParam("topic") String topic);
    ...
    @Path("/users/me/muted_users/{muted_user_id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Unmute a user", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success.", response = JsonSuccess.class),
    ...
    @Path("/user_groups/{user_group_id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Update a user group", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success.", response = JsonSuccess.class),
        @ApiResponse(code = 400, message = "Bad request.", response = JsonError.class) })
    public JsonSuccess updateUserGroup(@PathParam("user_group_id") Integer userGroupId, @QueryParam("name") String name, @QueryParam("description") String description);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Update user group members", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success.", response = JsonSuccess.class) })
