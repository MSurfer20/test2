...
public interface DraftsApi  {
    ...
    @ApiOperation(value = "Create drafts", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{draft_id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Delete a draft", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success.", response = JsonSuccess.class),
    ...
    @Path("/{draft_id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Edit a draft", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success.", response = JsonSuccess.class),
        @ApiResponse(code = 404, message = "Not Found.", response = JsonError.class) })
    public JsonSuccess editDraft(@PathParam("draft_id") Integer draftId, @QueryParam("draft") Draft draft);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get drafts", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success.", response = JsonSuccess.class) })
