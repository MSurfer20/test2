...
class BotAllOf {
  /// Returns a new [BotAllOf] instance.
  BotAllOf({
    this.userId,
    this.fullName,
    this.apiKey,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is BotAllOf &&
     other.userId == userId &&
  ...
  /// Returns a new [BotAllOf] instance and imports its values from
  /// [json] if it's non-null, null if [json] is null.
  static BotAllOf fromJson(Map<String, dynamic> json) => json == null
    ? null
    : BotAllOf(
  ...
  static List<BotAllOf> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <BotAllOf>[]
      : json.map((dynamic value) => BotAllOf.fromJson(value)).toList(growable: true == growable);

  static Map<String, BotAllOf> mapFromJson(Map<String, dynamic> json) {
    final map = <String, BotAllOf>{};
    if (json?.isNotEmpty == true) {
      json.forEach((key, value) => map[key] = BotAllOf.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of BotAllOf-objects as value to a dart map
  static Map<String, List<BotAllOf>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<BotAllOf>>{};
    if (json?.isNotEmpty == true) {
      json.forEach((key, value) {
        map[key] = BotAllOf.listFromJson(value, emptyIsNull: emptyIsNull, growable: growable,);
      });
    }
    return map;
  }
