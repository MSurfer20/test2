...
class GetMessagesAllOf {
  /// Returns a new [GetMessagesAllOf] instance.
  GetMessagesAllOf({
    this.avatarUrl,
    this.client,
    this.content,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is GetMessagesAllOf &&
  ...
  /// Returns a new [GetMessagesAllOf] instance and imports its values from
  /// [json] if it's non-null, null if [json] is null.
  static GetMessagesAllOf fromJson(Map<String, dynamic> json) => json == null
    ? null
    : GetMessagesAllOf(
  ...
  static List<GetMessagesAllOf> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <GetMessagesAllOf>[]
      : json.map((dynamic value) => GetMessagesAllOf.fromJson(value)).toList(growable: true == growable);

  static Map<String, GetMessagesAllOf> mapFromJson(Map<String, dynamic> json) {
    final map = <String, GetMessagesAllOf>{};
    if (json?.isNotEmpty == true) {
      json.forEach((key, value) => map[key] = GetMessagesAllOf.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of GetMessagesAllOf-objects as value to a dart map
  static Map<String, List<GetMessagesAllOf>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<GetMessagesAllOf>>{};
    if (json?.isNotEmpty == true) {
      json.forEach((key, value) {
        map[key] = GetMessagesAllOf.listFromJson(value, emptyIsNull: emptyIsNull, growable: growable,);
      });
    }
    return map;
  }
