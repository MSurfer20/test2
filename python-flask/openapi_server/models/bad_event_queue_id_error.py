...
from openapi_server.models.bad_event_queue_id_error_all_of import BadEventQueueIdErrorAllOf  # noqa: E501
...
class BadEventQueueIdError(Model):
    ...
    def __init__(self, result=None, msg=None, code=None, queue_id=None):  # noqa: E501
