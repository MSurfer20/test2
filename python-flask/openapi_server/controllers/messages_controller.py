...
from openapi_server.models.invalid_message_error import InvalidMessageError  # noqa: E501
...
def add_reaction(message_id, emoji_name, emoji_code=None, reaction_type=None):  # noqa: E501
...
def check_messages_match_narrow(msg_ids, narrow):  # noqa: E501
...
def delete_message(message_id):  # noqa: E501
    """Delete a message
...
def get_file_temporary_url(realm_id_str, filename):  # noqa: E501
...
def get_message_history(message_id):  # noqa: E501
...
def get_messages(num_before, num_after, anchor=None, narrow=None, client_gravatar=None, apply_markdown=None, use_first_unread_anchor=None):  # noqa: E501
    """Get messages
    ...
    if connexion.request.is_json:
        anchor =  OneOfstringinteger.from_dict(connexion.request.get_json())  # noqa: E501
    return 'do some magic!'


def get_raw_message(message_id):  # noqa: E501
...
def mark_all_as_read():  # noqa: E501
...
def mark_stream_as_read(stream_id):  # noqa: E501
...
def mark_topic_as_read(stream_id, topic_name):  # noqa: E501
...
def remove_reaction(message_id, emoji_name=None, emoji_code=None, reaction_type=None):  # noqa: E501
...
def render_message(content):  # noqa: E501
    """Render message
...
def send_message(type, to, content, topic=None, queue_id=None, local_id=None):  # noqa: E501
    """Send a message
...
def update_message(message_id, topic=None, propagate_mode=None, send_notification_to_old_thread=None, send_notification_to_new_thread=None, content=None, stream_id=None):  # noqa: E501
    """Edit a message
...
def update_message_flags(messages, op, flag):  # noqa: E501
...
def upload_file(filename=None):  # noqa: E501
    """Upload a file
