...
void main() {
  ...
  group(MessagesApi, () {
    ...
    //
    //Future<JsonObject> checkMessagesMatchNarrow(BuiltList<int> msgIds, BuiltList<JsonObject> narrow) async
    ...
    //
    //Future<JsonSuccessBase> getMessages(int numBefore, int numAfter, { OneOfstringinteger anchor, BuiltList<JsonObject> narrow, bool clientGravatar, bool applyMarkdown, bool useFirstUnreadAnchor }) async
    ...
    //
    //Future<JsonSuccessBase> sendMessage(String type, BuiltList<int> to, String content, { String topic, String queueId, String localId }) async
    ...
    //
    //Future<JsonSuccessBase> updateMessageFlags(BuiltList<int> messages, String op, String flag) async
    ...
    //
    //Future<JsonSuccessBase> uploadFile({ Uint8List filename }) async
