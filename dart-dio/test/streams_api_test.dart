...
void main() {
  final instance = Openapi().getStreamsApi();
  ...
  group(StreamsApi, () {
    ...
    //
    //Future<OneOfobjectobject> subscribe(BuiltList<JsonObject> subscriptions, { BuiltList<OneOfstringinteger> principals, bool authorizationErrorsFatal, bool announce, bool inviteOnly, bool historyPublicToSubscribers, int streamPostPolicy, OneOfstringinteger messageRetentionDays }) async
    ...
    //
    //Future<JsonSuccessBase> unsubscribe(BuiltList<String> subscriptions, { BuiltList<OneOfstringinteger> principals }) async
    ...
    //
    //Future<JsonSuccessBase> updateSubscriptionSettings(BuiltList<JsonObject> subscriptionData) async
    ...
    //
    //Future<JsonSuccessBase> updateSubscriptions({ BuiltList<String> delete, BuiltList<JsonObject> add }) async
