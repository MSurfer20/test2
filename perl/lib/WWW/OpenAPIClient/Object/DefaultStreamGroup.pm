...
#
package WWW::OpenAPIClient::Object::DefaultStreamGroup;
...
__PACKAGE__->class_documentation({description => 'Dictionary containing details of a default stream group. ',
