...
#
package WWW::OpenAPIClient::Object::Attachments;
...
__PACKAGE__->class_documentation({description => 'Dictionary containing details of a file uploaded by a user. ',
                                  class => 'Attachments',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'messages' => {
        datatype => 'ARRAY[AttachmentsMessages]',
        base_name => 'messages',
