...
#
package WWW::OpenAPIClient::Object::RealmEmoji;
...
__PACKAGE__->class_documentation({description => '&#x60;{emoji_id}&#x60;: Object containing details about the emoji with  the specified ID. It has the following properties: ',
                                  class => 'RealmEmoji',
                                  required => [], # TODO
}                                 );
