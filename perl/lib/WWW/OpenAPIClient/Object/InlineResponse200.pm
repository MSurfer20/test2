...
__PACKAGE__->class_documentation({description => 'This is an example of the JSON payload that the Zulip server will &#x60;POST&#x60; to your server ',
