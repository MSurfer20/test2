...
-export([openapi_user_not_authorized_error/0]).

-export([openapi_user_not_authorized_error/1]).
...
openapi_user_not_authorized_error() ->
    openapi_user_not_authorized_error([]).

openapi_user_not_authorized_error(Fields) ->
