-module(openapi_get_messages).

-include("openapi.hrl").

-export([openapi_get_messages/0]).

-export([openapi_get_messages/1]).

-export_type([openapi_get_messages/0]).

-type openapi_get_messages() ::
...
openapi_get_messages() ->
    openapi_get_messages([]).

openapi_get_messages(Fields) ->
