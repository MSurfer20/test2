...
-export([openapi_json_success_base_all_of/0]).

-export([openapi_json_success_base_all_of/1]).
...
openapi_json_success_base_all_of() ->
    openapi_json_success_base_all_of([]).

openapi_json_success_base_all_of(Fields) ->
