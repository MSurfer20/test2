...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZulipRestApi.MessagesAllOf();
  });
  ...
  describe('MessagesAllOf', function() {
    it('should create an instance of MessagesAllOf', function() {
      // uncomment below and update the code to test MessagesAllOf
      //var instane = new ZulipRestApi.MessagesAllOf();
      //expect(instance).to.be.a(ZulipRestApi.MessagesAllOf);
    });
    ...
    it('should have the property avatarUrl (base name: "avatar_url")', function() {
      ...
      //var instance = new ZulipRestApi.MessagesAllOf();
