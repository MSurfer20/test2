...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZulipRestApi.BasicBotAllOf();
  });
  ...
  describe('BasicBotAllOf', function() {
    it('should create an instance of BasicBotAllOf', function() {
      // uncomment below and update the code to test BasicBotAllOf
      //var instane = new ZulipRestApi.BasicBotAllOf();
      //expect(instance).to.be.a(ZulipRestApi.BasicBotAllOf);
    });

    it('should have the property userId (base name: "user_id")', function() {
      // uncomment below and update the code to test the property userId
      //var instance = new ZulipRestApi.BasicBotAllOf();
