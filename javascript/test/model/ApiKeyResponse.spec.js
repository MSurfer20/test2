...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZulipRestApi.ApiKeyResponse();
  });
  ...
  describe('ApiKeyResponse', function() {
    it('should create an instance of ApiKeyResponse', function() {
      ...
      //var instane = new ZulipRestApi.ApiKeyResponse();
      //expect(instance).to.be.a(ZulipRestApi.ApiKeyResponse);
    });

    it('should have the property result (base name: "result")', function() {
      // uncomment below and update the code to test the property result
      //var instance = new ZulipRestApi.ApiKeyResponse();
