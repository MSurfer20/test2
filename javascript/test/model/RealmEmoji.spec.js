...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZulipRestApi.RealmEmoji();
  });
  ...
  describe('RealmEmoji', function() {
    it('should create an instance of RealmEmoji', function() {
      // uncomment below and update the code to test RealmEmoji
      //var instane = new ZulipRestApi.RealmEmoji();
      //expect(instance).to.be.a(ZulipRestApi.RealmEmoji);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new ZulipRestApi.RealmEmoji();
