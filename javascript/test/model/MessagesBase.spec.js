...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZulipRestApi.MessagesBase();
  });
  ...
  describe('MessagesBase', function() {
    it('should create an instance of MessagesBase', function() {
      // uncomment below and update the code to test MessagesBase
      //var instane = new ZulipRestApi.MessagesBase();
      //expect(instance).to.be.a(ZulipRestApi.MessagesBase);
    });
    ...
    it('should have the property avatarUrl (base name: "avatar_url")', function() {
      ...
      //var instance = new ZulipRestApi.MessagesBase();
