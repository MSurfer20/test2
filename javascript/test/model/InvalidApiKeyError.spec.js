...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZulipRestApi.InvalidApiKeyError();
  });
  ...
  describe('InvalidApiKeyError', function() {
    it('should create an instance of InvalidApiKeyError', function() {
      ...
      //var instane = new ZulipRestApi.InvalidApiKeyError();
      //expect(instance).to.be.a(ZulipRestApi.InvalidApiKeyError);
    });

    it('should have the property result (base name: "result")', function() {
      // uncomment below and update the code to test the property result
      //var instance = new ZulipRestApi.InvalidApiKeyError();
