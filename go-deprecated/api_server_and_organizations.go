 ...
 */
func (a *ServerAndOrganizationsApiService) AddCodePlayground(ctx _context.Context, name string, pygmentsLanguage string, urlPrefix string) (JsonSuccessBase, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/realm/playgrounds"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}

	localVarQueryParams.Add("name", parameterToString(name, ""))
	localVarQueryParams.Add("pygments_language", parameterToString(pygmentsLanguage, ""))
	localVarQueryParams.Add("url_prefix", parameterToString(urlPrefix, ""))
...
func (a *ServerAndOrganizationsApiService) GetLinkifiers(ctx _context.Context) (JsonSuccessBase, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/realm/linkifiers"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
 ...
 * @return JsonSuccess
 */
func (a *ServerAndOrganizationsApiService) RemoveCodePlayground(ctx _context.Context, playgroundId int32) (JsonSuccess, *_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/realm/playgrounds/{playground_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"playground_id"+"}", _neturl.PathEscape(parameterToString(playgroundId, "")) , -1)
...
func (a *ServerAndOrganizationsApiService) RemoveLinkifier(ctx _context.Context, filterId int32) (JsonSuccess, *_nethttp.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"filter_id"+"}", _neturl.PathEscape(parameterToString(filterId, "")) , -1)
 ...
 * @return JsonSuccess
 */
func (a *ServerAndOrganizationsApiService) UpdateLinkifier(ctx _context.Context, filterId int32, pattern string, urlFormatString string) (JsonSuccess, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPatch
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (a *ServerAndOrganizationsApiService) UploadCustomEmoji(ctx _context.Context, emojiName string, localVarOptionals *UploadCustomEmojiOpts) (JsonSuccess, *_nethttp.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"emoji_name"+"}", _neturl.PathEscape(parameterToString(emojiName, "")) , -1)
