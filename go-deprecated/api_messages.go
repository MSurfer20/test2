...
func (a *MessagesApiService) AddReaction(ctx _context.Context, messageId int32, emojiName string, localVarOptionals *AddReactionOpts) (JsonSuccess, *_nethttp.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"message_id"+"}", _neturl.PathEscape(parameterToString(messageId, "")) , -1)
 ...
 * @return interface{}
 */
func (a *MessagesApiService) CheckMessagesMatchNarrow(ctx _context.Context, msgIds []int32, narrow []map[string]interface{}) (interface{}, *_nethttp.Response, error) {
	var (
...
func (a *MessagesApiService) GetFileTemporaryUrl(ctx _context.Context, realmIdStr int32, filename string) (JsonSuccessBase, *_nethttp.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"realm_id_str"+"}", _neturl.PathEscape(parameterToString(realmIdStr, "")) , -1)
 ...
 * @param "Topic" (optional.String) -  The topic to move the message(s) to, to request changing the topic. Should only be sent when changing the topic, and will throw an error if the target message is not a stream message.  Maximum length of 60 characters.  **Changes**: New in Zulip 2.0.  Previous Zulip releases encoded this as `subject`, which is currently a deprecated alias. 
 * @param "PropagateMode" (optional.String) -  Which message(s) should be edited: just the one indicated in `message_id`, messages in the same topic that had been sent after this one, or all of them.  Only the default value of `change_one` is valid when editing only the content of a message.  This parameter determines both which messages get moved and also whether clients that are currently narrowed to the topic containing the message should navigate or adjust their compose box recipient to point to the post-edit stream/topic. 
 ...
 * @param "StreamId" (optional.Int32) -  The stream ID to move the message(s) to, to request moving messages to another stream.  Should only be sent when changing the stream, and will throw an error if the target message is not a stream message. 
 * @return JsonSuccess
 */
