#ifndef TINY_CPP_CLIENT_AuthenticationApi_H_
#define TINY_CPP_CLIENT_AuthenticationApi_H_
...
class AuthenticationApi : public AbstractService {
public:
...
#endif /* TINY_CPP_CLIENT_AuthenticationApi_H_ */