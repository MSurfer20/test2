#ifndef TINY_CPP_CLIENT_RealTimeEventsApi_H_
#define TINY_CPP_CLIENT_RealTimeEventsApi_H_
...
class RealTimeEventsApi : public AbstractService {
public:
    RealTimeEventsApi() = default;
...
#endif /* TINY_CPP_CLIENT_RealTimeEventsApi_H_ */