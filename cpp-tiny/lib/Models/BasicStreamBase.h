...
#ifndef TINY_CPP_CLIENT_BasicStreamBase_H_
#define TINY_CPP_CLIENT_BasicStreamBase_H_
...
public:
	 ...
	 */
    BasicStreamBase();
    BasicStreamBase(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_BasicStreamBase_H_ */
