...
#ifndef TINY_CPP_CLIENT_UserBase_H_
#define TINY_CPP_CLIENT_UserBase_H_
...
public:
	 ...
	 */
    UserBase();
    UserBase(std::string jsonString);
	 ...
	 */
	Map<std::string, std::string> getProfileData();
	 ...
	 */
	void setProfileData(Map <std::string, std::string> profile_data);
    ...
    Map<std::string, std::string> profile_data;
};
}

#endif /* TINY_CPP_CLIENT_UserBase_H_ */
