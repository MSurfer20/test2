...
#ifndef TINY_CPP_CLIENT_Messages_allOf_H_
#define TINY_CPP_CLIENT_Messages_allOf_H_
...
public:
	 ...
	 */
    Messages_allOf();
    Messages_allOf(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_Messages_allOf_H_ */
