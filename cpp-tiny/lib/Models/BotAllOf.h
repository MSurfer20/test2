...
#ifndef TINY_CPP_CLIENT_Bot_allOf_H_
#define TINY_CPP_CLIENT_Bot_allOf_H_
...
/*! \brief Object containing details of a bot. 
 *
 *  \ingroup Models
 *
 */
...
public:
	 ...
	 */
    Bot_allOf();
    Bot_allOf(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_Bot_allOf_H_ */
