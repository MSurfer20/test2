...
#ifndef TINY_CPP_CLIENT_AddSubscriptionsResponse_allOf_H_
#define TINY_CPP_CLIENT_AddSubscriptionsResponse_allOf_H_
...
public:
    ...
    AddSubscriptionsResponse_allOf(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_AddSubscriptionsResponse_allOf_H_ */
