...
#ifndef TINY_CPP_CLIENT_ApiKeyResponse_H_
#define TINY_CPP_CLIENT_ApiKeyResponse_H_
...
public:
	 ...
	 */
    ApiKeyResponse();
    ApiKeyResponse(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_ApiKeyResponse_H_ */
