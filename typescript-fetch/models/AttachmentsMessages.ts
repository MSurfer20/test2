...
export function AttachmentsMessagesFromJSON(json: any): AttachmentsMessages {
    return AttachmentsMessagesFromJSONTyped(json, false);
}

export function AttachmentsMessagesFromJSONTyped(json: any, ignoreDiscriminator: boolean): AttachmentsMessages {
...
export function AttachmentsMessagesToJSON(value?: AttachmentsMessages | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
