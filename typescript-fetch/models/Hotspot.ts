...
export function HotspotFromJSON(json: any): Hotspot {
    return HotspotFromJSONTyped(json, false);
}

export function HotspotFromJSONTyped(json: any, ignoreDiscriminator: boolean): Hotspot {
...
export function HotspotToJSON(value?: Hotspot | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
