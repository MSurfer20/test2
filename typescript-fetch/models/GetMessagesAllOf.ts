...
export function GetMessagesAllOfFromJSON(json: any): GetMessagesAllOf {
    return GetMessagesAllOfFromJSONTyped(json, false);
}

export function GetMessagesAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetMessagesAllOf {
...
export function GetMessagesAllOfToJSON(value?: GetMessagesAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
