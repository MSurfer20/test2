...
export function AddSubscriptionsResponseAllOfFromJSON(json: any): AddSubscriptionsResponseAllOf {
    return AddSubscriptionsResponseAllOfFromJSONTyped(json, false);
}

export function AddSubscriptionsResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): AddSubscriptionsResponseAllOf {
...
export function AddSubscriptionsResponseAllOfToJSON(value?: AddSubscriptionsResponseAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
