...
std::string AddSubscriptionsResponse_allOf::toJsonString(bool prettyJson)
{
	std::stringstream ss;
...
void AddSubscriptionsResponse_allOf::fromJsonString(std::string const& jsonString)
{
...
ptree AddSubscriptionsResponse_allOf::toPropertyTree()
{
	ptree pt;
	ptree tmp_node;
...
void AddSubscriptionsResponse_allOf::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
...
void AddSubscriptionsResponse_allOf::setResult(std::shared_ptr<AnyType> value)
{
	m_Result = value;
}
...
void AddSubscriptionsResponse_allOf::setMsg(std::shared_ptr<AnyType> value)
{
	m_Msg = value;
}
...
void AddSubscriptionsResponse_allOf::setSubscribed(std::map<std::string, std::vector<std::string>> value)
{
	m_Subscribed = value;
}
...
void AddSubscriptionsResponse_allOf::setAlreadySubscribed(std::map<std::string, std::vector<std::string>> value)
{
...
void AddSubscriptionsResponse_allOf::setUnauthorized(std::vector<std::string> value)
{
