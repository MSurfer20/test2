...
#include "OpenAPIRealmDeactivatedError.h"
...
void OpenAPIRealmDeactivatedError::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIRealmDeactivatedError::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
