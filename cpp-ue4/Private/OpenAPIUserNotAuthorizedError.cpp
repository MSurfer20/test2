...
#include "OpenAPIUserNotAuthorizedError.h"
...
void OpenAPIUserNotAuthorizedError::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIUserNotAuthorizedError::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
