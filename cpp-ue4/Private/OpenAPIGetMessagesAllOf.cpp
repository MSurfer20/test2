...
void OpenAPIGetMessagesAllOf::WriteJson(JsonWriter& Writer) const
{
	...
	if (LastEditTimestamp.IsSet())
	{
		Writer->WriteIdentifierPrefix(TEXT("last_edit_timestamp")); WriteJsonValue(Writer, LastEditTimestamp.GetValue());	
	}
	if (MatchContent.IsSet())
	{
		Writer->WriteIdentifierPrefix(TEXT("match_content")); WriteJsonValue(Writer, MatchContent.GetValue());	
	}
	if (MatchSubject.IsSet())
	{
		Writer->WriteIdentifierPrefix(TEXT("match_subject")); WriteJsonValue(Writer, MatchSubject.GetValue());	
	}
	Writer->WriteObjectEnd();
}

bool OpenAPIGetMessagesAllOf::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
	...
	ParseSuccess &= TryGetJsonValue(*Object, TEXT("last_edit_timestamp"), LastEditTimestamp);
	ParseSuccess &= TryGetJsonValue(*Object, TEXT("match_content"), MatchContent);
	ParseSuccess &= TryGetJsonValue(*Object, TEXT("match_subject"), MatchSubject);
