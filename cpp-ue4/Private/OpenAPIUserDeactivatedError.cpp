...
#include "OpenAPIUserDeactivatedError.h"
...
void OpenAPIUserDeactivatedError::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIUserDeactivatedError::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
