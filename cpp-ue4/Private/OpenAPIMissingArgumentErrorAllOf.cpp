...
void OpenAPIMissingArgumentErrorAllOf::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIMissingArgumentErrorAllOf::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
