...
CodedErrorBase<PSCustomObject>
#>

function Initialize-CodedErrorBase {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CodedErrorBase' | Write-Debug
...
Convert from JSON to CodedErrorBase<PSCustomObject>
...
CodedErrorBase<PSCustomObject>
#>
function ConvertFrom-JsonToCodedErrorBase {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CodedErrorBase' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CodedErrorBase
