...
ApiKeyResponse<PSCustomObject>
#>

function Initialize-ApiKeyResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApiKeyResponse' | Write-Debug
...
Convert from JSON to ApiKeyResponse<PSCustomObject>
...
ApiKeyResponse<PSCustomObject>
#>
function ConvertFrom-JsonToApiKeyResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApiKeyResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApiKeyResponse
