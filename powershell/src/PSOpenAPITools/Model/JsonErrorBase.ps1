...
JsonErrorBase<PSCustomObject>
#>

function Initialize-JsonErrorBase {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => JsonErrorBase' | Write-Debug
...
Convert from JSON to JsonErrorBase<PSCustomObject>
...
JsonErrorBase<PSCustomObject>
#>
function ConvertFrom-JsonToJsonErrorBase {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => JsonErrorBase' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in JsonErrorBase
