...
JsonSuccess<PSCustomObject>
#>

function Initialize-JsonSuccess {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => JsonSuccess' | Write-Debug
...
Convert from JSON to JsonSuccess<PSCustomObject>
...
JsonSuccess<PSCustomObject>
#>
function ConvertFrom-JsonToJsonSuccess {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => JsonSuccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in JsonSuccess
