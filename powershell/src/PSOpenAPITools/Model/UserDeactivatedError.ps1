...
UserDeactivatedError<PSCustomObject>
#>

function Initialize-UserDeactivatedError {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UserDeactivatedError' | Write-Debug
...
Convert from JSON to UserDeactivatedError<PSCustomObject>
...
UserDeactivatedError<PSCustomObject>
#>
function ConvertFrom-JsonToUserDeactivatedError {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UserDeactivatedError' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UserDeactivatedError
