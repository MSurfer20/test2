...
CodedError<PSCustomObject>
#>

function Initialize-CodedError {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CodedError' | Write-Debug
...
Convert from JSON to CodedError<PSCustomObject>
...
CodedError<PSCustomObject>
#>
function ConvertFrom-JsonToCodedError {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CodedError' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CodedError
