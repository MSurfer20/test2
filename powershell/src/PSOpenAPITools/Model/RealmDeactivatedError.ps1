...
RealmDeactivatedError<PSCustomObject>
#>

function Initialize-RealmDeactivatedError {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RealmDeactivatedError' | Write-Debug
...
Convert from JSON to RealmDeactivatedError<PSCustomObject>
...
RealmDeactivatedError<PSCustomObject>
#>
function ConvertFrom-JsonToRealmDeactivatedError {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RealmDeactivatedError' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RealmDeactivatedError
