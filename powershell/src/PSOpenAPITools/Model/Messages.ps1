...
function Initialize-Messages {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Messages' | Write-Debug
...
Convert from JSON to Messages<PSCustomObject>
...
Messages<PSCustomObject>
#>
function ConvertFrom-JsonToMessages {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Messages' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Messages
