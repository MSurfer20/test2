...
UserNotAuthorizedError<PSCustomObject>
#>

function Initialize-UserNotAuthorizedError {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UserNotAuthorizedError' | Write-Debug
...
Convert from JSON to UserNotAuthorizedError<PSCustomObject>
...
UserNotAuthorizedError<PSCustomObject>
#>
function ConvertFrom-JsonToUserNotAuthorizedError {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UserNotAuthorizedError' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UserNotAuthorizedError
