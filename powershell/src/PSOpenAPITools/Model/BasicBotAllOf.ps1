...
BasicBotAllOf<PSCustomObject>
#>

function Initialize-BasicBotAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BasicBotAllOf' | Write-Debug
...
Convert from JSON to BasicBotAllOf<PSCustomObject>
...
BasicBotAllOf<PSCustomObject>
#>
function ConvertFrom-JsonToBasicBotAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BasicBotAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BasicBotAllOf
