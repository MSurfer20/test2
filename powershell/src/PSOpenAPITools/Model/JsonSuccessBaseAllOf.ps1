...
JsonSuccessBaseAllOf<PSCustomObject>
#>

function Initialize-JsonSuccessBaseAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => JsonSuccessBaseAllOf' | Write-Debug
...
Convert from JSON to JsonSuccessBaseAllOf<PSCustomObject>
...
JsonSuccessBaseAllOf<PSCustomObject>
#>
function ConvertFrom-JsonToJsonSuccessBaseAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => JsonSuccessBaseAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in JsonSuccessBaseAllOf
