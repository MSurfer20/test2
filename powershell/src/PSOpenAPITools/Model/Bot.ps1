...
function Initialize-Bot {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Bot' | Write-Debug
...
Convert from JSON to Bot<PSCustomObject>
...
Bot<PSCustomObject>
#>
function ConvertFrom-JsonToBot {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Bot' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Bot
