...
function Initialize-JsonError {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => JsonError' | Write-Debug
...
Convert from JSON to JsonError<PSCustomObject>
...
JsonError<PSCustomObject>
#>
function ConvertFrom-JsonToJsonError {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => JsonError' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in JsonError
