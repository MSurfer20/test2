...
------------ | ------------- | ------------- | -------------
**emoji_code** | **char \*** | A unique identifier, defining the specific emoji codepoint requested, within the namespace of the &#x60;reaction_type&#x60;.  For example, for &#x60;unicode_emoji&#x60;, this will be an encoding of the Unicode codepoint.  | [optional] 
...
**user** | [**emoji_reaction_base_user_t**](emoji_reaction_base_user.md) \* |  | [optional] 
