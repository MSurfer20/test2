...
module 
  ...
  class RealmEmoji
    ...
    @[JSON::Field(key: source_url, type: String)]
    property source_url : String

    # Whether the emoji has been deactivated or not. 
    @[JSON::Field(key: deactivated, type: Bool)]
    ...
    @[JSON::Field(key: author_id, type: Int32, nilable: true, emit_null: true)]
    property author_id : Int32

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@id : String | Nil, @name : String | Nil, @source_url : String | Nil, @deactivated : Bool | Nil, @author_id : Int32 | Nil)
    end
