...
module 
  ...
  class InlineResponse200
    ...
    @[JSON::Field(key: bot_email, type: String)]
    property bot_email : String

    # The full name of the bot user. 
    @[JSON::Field(key: bot_full_name, type: String)]
    property bot_full_name : String
    ...
    @[JSON::Field(key: trigger, type: String)]
    ...
    @[JSON::Field(key: message, type: MessagesBase)]
    property message : MessagesBase

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@bot_email : String | Nil, @bot_full_name : String | Nil, @data : String | Nil, @trigger : String | Nil, @token : String | Nil, @message : MessagesBase | Nil)
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          bot_email == o.bot_email &&
          bot_full_name == o.bot_full_name &&
          data == o.data &&
          trigger == o.trigger &&
          token == o.token &&
          message == o.message
    ...
    def hash
      [bot_email, bot_full_name, data, trigger, token, message].hash
    end
