...
module 
  ...
  class DefaultStreamGroup
    ...
    @[JSON::Field(key: streams, type: Array(BasicStream))]
    property streams : Array(BasicStream)

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@name : String | Nil, @description : String | Nil, @id : Int32 | Nil, @streams : Array(BasicStream) | Nil)
    end
