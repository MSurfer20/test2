...
module 
  ...
  class BasicStreamBase
    ...
    def initialize(@stream_id : Int32 | Nil, @name : String | Nil, @description : String | Nil, @date_created : Int32 | Nil, @invite_only : Bool | Nil, @rendered_description : String | Nil, @is_web_public : Bool | Nil, @stream_post_policy : Int32 | Nil, @message_retention_days : Int32 | Nil, @history_public_to_subscribers : Bool | Nil, @first_message_id : Int32 | Nil, @is_announcement_only : Bool | Nil)
    end
