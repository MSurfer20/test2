...
module 
  ...
  class Draft
    ...
    @[JSON::Field(key: to, type: Array(Int32))]
    property to : Array(Int32)
    ...
    @[JSON::Field(key: topic, type: String)]
    ...
    @[JSON::Field(key: timestamp, type: Float64)]
    ...
    def initialize(@id : Int32 | Nil, @_type : String, @to : Array(Int32), @topic : String, @content : String, @timestamp : Float64 | Nil)
    end
    ...
    def valid?
      ...
      _type_validator = EnumAttributeValidator.new("String", ["", "stream", "private"])
    ...
    def _type=(_type)
      validator = EnumAttributeValidator.new("String", ["", "stream", "private"])
    ...
    def hash
      [id, _type, to, topic, content, timestamp].hash
    end
