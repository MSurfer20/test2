...
module 
  ...
  class EmojiReactionBaseUser
    ...
    @[JSON::Field(key: is_mirror_dummy, type: Bool)]
    property is_mirror_dummy : Bool

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@id : Int32 | Nil, @email : String | Nil, @full_name : String | Nil, @is_mirror_dummy : Bool | Nil)
    end
