...
module 
  ...
  class Attachments
    ...
    @[JSON::Field(key: path_id, type: String)]
    ...
    @[JSON::Field(key: create_time, type: Int32)]
    property create_time : Int32
    ...
    @[JSON::Field(key: messages, type: Array(AttachmentsMessages))]
    property messages : Array(AttachmentsMessages)

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@id : Int32 | Nil, @name : String | Nil, @path_id : String | Nil, @size : Int32 | Nil, @create_time : Int32 | Nil, @messages : Array(AttachmentsMessages) | Nil)
    end
    ...
    def hash
      [id, name, path_id, size, create_time, messages].hash
    end
