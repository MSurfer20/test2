...
# Unit tests for ::ServerAndOrganizationsApi
...
describe "ServerAndOrganizationsApi" do
  describe "test an instance of ServerAndOrganizationsApi" do
    it "should create an instance of ServerAndOrganizationsApi" do
      api_instance = ::ServerAndOrganizationsApi.new
      # TODO expect(api_instance).to be_instance_of(::ServerAndOrganizationsApi)
    end
  end
