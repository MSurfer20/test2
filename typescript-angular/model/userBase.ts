...
export namespace UserBase {
    export type RoleEnum = 100 | 200 | 300 | 400 | 600;
    export const RoleEnum = {
        NUMBER_100: 100 as RoleEnum,
        NUMBER_200: 200 as RoleEnum,
        NUMBER_300: 300 as RoleEnum,
        NUMBER_400: 400 as RoleEnum,
        NUMBER_600: 600 as RoleEnum
    };
}
