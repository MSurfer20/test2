...
import { BadEventQueueIdError } from '../model/models';
import { InvalidApiKeyError } from '../model/models';
import { JsonSuccess } from '../model/models';
import { JsonSuccessBase } from '../model/models';
import { MissingArgumentError } from '../model/models';
import { RateLimitedError } from '../model/models';
import { RealmDeactivatedError } from '../model/models';
import { UserDeactivatedError } from '../model/models';
import { UserNotAuthorizedError } from '../model/models';
...
export class RealTimeEventsService {
     ...
     */
    public deleteQueue(queueId: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<JsonSuccess>;
    public deleteQueue(queueId: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<JsonSuccess>>;
    public deleteQueue(queueId: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<JsonSuccess>>;
    public deleteQueue(queueId: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        ...
        return this.httpClient.delete<JsonSuccess>(`${this.configuration.basePath}/events`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getEvents(queueId: string, lastEventId?: number, dontBlock?: boolean, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<JsonSuccessBase & object>;
    public getEvents(queueId: string, lastEventId?: number, dontBlock?: boolean, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<JsonSuccessBase & object>>;
    public getEvents(queueId: string, lastEventId?: number, dontBlock?: boolean, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<JsonSuccessBase & object>>;
    public getEvents(queueId: string, lastEventId?: number, dontBlock?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        if (queueId === null || queueId === undefined) {
        ...
        if (lastEventId !== undefined && lastEventId !== null) {
          queryParameters = this.addToHttpParams(queryParameters,
            <any>lastEventId, 'last_event_id');
        }
        if (dontBlock !== undefined && dontBlock !== null) {
          queryParameters = this.addToHttpParams(queryParameters,
            <any>dontBlock, 'dont_block');
        }
        ...
        return this.httpClient.get<JsonSuccessBase & object>(`${this.configuration.basePath}/events`,
            {
                params: queryParameters,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public realTimePost(eventTypes?: Array<string>, narrow?: Array<Array<string>>, allPublicStreams?: boolean, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined}): Observable<any>;
    public realTimePost(eventTypes?: Array<string>, narrow?: Array<Array<string>>, allPublicStreams?: boolean, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined}): Observable<HttpResponse<any>>;
    public realTimePost(eventTypes?: Array<string>, narrow?: Array<Array<string>>, allPublicStreams?: boolean, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined}): Observable<HttpEvent<any>>;
    public realTimePost(eventTypes?: Array<string>, narrow?: Array<Array<string>>, allPublicStreams?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined}): Observable<any> {

        let queryParameters = new HttpParams({encoder: this.encoder});
        if (eventTypes) {
            eventTypes.forEach((element) => {
                queryParameters = this.addToHttpParams(queryParameters,
                  <any>element, 'event_types');
            })
        }
        if (narrow) {
        ...
        if (allPublicStreams !== undefined && allPublicStreams !== null) {
          queryParameters = this.addToHttpParams(queryParameters,
            <any>allPublicStreams, 'all_public_streams');
        }
        ...
        return this.httpClient.post<any>(`${this.configuration.basePath}/real-time`,
            null,
            {
                params: queryParameters,
                responseType: <any>responseType_,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public registerQueue(applyMarkdown?: boolean, clientGravatar?: boolean, slimPresence?: boolean, eventTypes?: Array<string>, allPublicStreams?: boolean, includeSubscribers?: boolean, clientCapabilities?: object, fetchEventTypes?: Array<string>, narrow?: Array<Array<string>>, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<JsonSuccessBase & object>;
    public registerQueue(applyMarkdown?: boolean, clientGravatar?: boolean, slimPresence?: boolean, eventTypes?: Array<string>, allPublicStreams?: boolean, includeSubscribers?: boolean, clientCapabilities?: object, fetchEventTypes?: Array<string>, narrow?: Array<Array<string>>, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<JsonSuccessBase & object>>;
    public registerQueue(applyMarkdown?: boolean, clientGravatar?: boolean, slimPresence?: boolean, eventTypes?: Array<string>, allPublicStreams?: boolean, includeSubscribers?: boolean, clientCapabilities?: object, fetchEventTypes?: Array<string>, narrow?: Array<Array<string>>, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<JsonSuccessBase & object>>;
    public registerQueue(applyMarkdown?: boolean, clientGravatar?: boolean, slimPresence?: boolean, eventTypes?: Array<string>, allPublicStreams?: boolean, includeSubscribers?: boolean, clientCapabilities?: object, fetchEventTypes?: Array<string>, narrow?: Array<Array<string>>, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        ...
        if (slimPresence !== undefined && slimPresence !== null) {
          queryParameters = this.addToHttpParams(queryParameters,
            <any>slimPresence, 'slim_presence');
        }
        if (eventTypes) {
            eventTypes.forEach((element) => {
                queryParameters = this.addToHttpParams(queryParameters,
        ...
        if (clientCapabilities !== undefined && clientCapabilities !== null) {
          queryParameters = this.addToHttpParams(queryParameters,
            <any>clientCapabilities, 'client_capabilities');
        }
        if (fetchEventTypes) {
            fetchEventTypes.forEach((element) => {
                queryParameters = this.addToHttpParams(queryParameters,
                  <any>element, 'fetch_event_types');
            })
        }
        if (narrow) {
            narrow.forEach((element) => {
        ...
        return this.httpClient.post<JsonSuccessBase & object>(`${this.configuration.basePath}/register`,
            null,
            {
                params: queryParameters,
                responseType: <any>responseType_,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public restErrorHandling(observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<any>;
    public restErrorHandling(observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<any>>;
    public restErrorHandling(observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<any>>;
    public restErrorHandling(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        ...
        return this.httpClient.post<any>(`${this.configuration.basePath}/rest-error-handling`,
            null,
            {
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
