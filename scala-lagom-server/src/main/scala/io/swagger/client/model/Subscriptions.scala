...
case class Subscriptions (
            ...
            /* Whether the stream has been configured to allow unauthenticated access to its message history from the web.  */
                  ...
                  role:  Option[SubscriptionsRoleEnum.SubscriptionsRoleEnum],
...
implicit val format: Format[Subscriptions] = Json.format
}

object SubscriptionsRoleEnum extends Enumeration {
  val   20, 50 = Value
  type SubscriptionsRoleEnum = Value
  implicit val format: Format[Value] = Format(Reads.enumNameReads(this), Writes.enumNameWrites[SubscriptionsRoleEnum.type])
}
