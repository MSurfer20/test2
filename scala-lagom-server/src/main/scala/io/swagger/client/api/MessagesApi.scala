...
import java.io.File
import io.swagger.client.model.InvalidMessageError
...
trait MessagesApi extends Service {


  final override def descriptor = {
    import Service._
    named("MessagesApi").withCalls(
      restCall(Method.POST, "/messages/:message_id/reactions?emojiName&emojiCode&reactionType", addReaction _), 
      restCall(Method.GET, "/messages/matches_narrow?msgIds&narrow", checkMessagesMatchNarrow _), 
      restCall(Method.DELETE, "/messages/:message_id", deleteMessage _), 
      restCall(Method.GET, "/user_uploads/:realm_id_str/:filename", getFileTemporaryUrl _), 
      restCall(Method.GET, "/messages/:message_id/history", getMessageHistory _), 
      restCall(Method.GET, "/messages?anchor&numBefore&numAfter&narrow&clientGravatar&applyMarkdown&useFirstUnreadAnchor", getMessages _), 
      restCall(Method.GET, "/messages/:message_id", getRawMessage _), 
      restCall(Method.POST, "/mark_all_as_read", markAllAsRead _), 
      restCall(Method.POST, "/mark_stream_as_read?streamId", markStreamAsRead _), 
      restCall(Method.POST, "/mark_topic_as_read?streamId&topicName", markTopicAsRead _), 
      restCall(Method.DELETE, "/messages/:message_id/reactions?emojiName&emojiCode&reactionType", removeReaction _), 
      restCall(Method.POST, "/messages/render?content", renderMessage _), 
      restCall(Method.POST, "/messages?`type`&to&content&topic&queueId&localId", sendMessage _), 
      restCall(Method.PATCH, "/messages/:message_id?topic&propagateMode&sendNotificationToOldThread&sendNotificationToNewThread&content&streamId", updateMessage _), 
      restCall(Method.POST, "/messages/flags?messages&op&flag", updateMessageFlags _), 
      restCall(Method.POST, "/user_uploads", uploadFile _)
    ).withAutoAcl(true)
  }
  ...
  /**
    ...
    * @return JsonSuccess
    */
  def addReaction(emojiName:String          ,emojiCode:           Option[String] = None,reactionType:           Option[String] = NonemessageId: Int): ServiceCall[NotUsed ,JsonSuccess]
        
  // msgIds:Seq[Int]  -- not yet supported Seq PathParamSerializers for multi value query parameters https://github.com/lagom/lagom/issues/643
      
  // narrow:Seq[Any]  -- not yet supported Seq PathParamSerializers for multi value query parameters https://github.com/lagom/lagom/issues/643
  ...
  /**
    ...
    * @return AnyType
    */
  def checkMessagesMatchNarrow(): ServiceCall[NotUsed ,AnyType]
  ...
  /**
    ...
    * @return JsonSuccess
    */
  def deleteMessage(messageId: Int): ServiceCall[NotUsed ,JsonSuccess]
  ...
  /**
    ...
    */
  def getFileTemporaryUrl(realmIdStr: Int, filename: String): ServiceCall[NotUsed ,JsonSuccessBase]
  ...
  /**
    ...
    * @return JsonSuccessBase
    */
  def getMessageHistory(messageId: Int): ServiceCall[NotUsed ,JsonSuccessBase]
  ...
  /**
    ...
    * @return JsonSuccessBase
    */
  def getMessages(anchor:           Option[OneOfstringinteger] = None,numBefore:Int          ,numAfter:Int          ,clientGravatar:           Option[Boolean] /* = false*/,applyMarkdown:           Option[Boolean] /* = true*/,useFirstUnreadAnchor:           Option[Boolean] /* = false*/): ServiceCall[NotUsed ,JsonSuccessBase]
  ...
  /**
    ...
    * @return JsonSuccessBase
    */
  def getRawMessage(messageId: Int): ServiceCall[NotUsed ,JsonSuccessBase]
  ...
  /**
    ...
    * @return JsonSuccess
    */
  def markAllAsRead(): ServiceCall[NotUsed ,JsonSuccess]
  ...
  /**
    ...
    * @return JsonSuccess
    */
  def markStreamAsRead(streamId:Int          ): ServiceCall[NotUsed ,JsonSuccess]
  ...
  /**
    ...
    * @return JsonSuccess
    */
  def markTopicAsRead(streamId:Int          ,topicName:String          ): ServiceCall[NotUsed ,JsonSuccess]
  ...
  /**
    ...
    * @return JsonSuccess
    */
  def removeReaction(emojiName:           Option[String] = None,emojiCode:           Option[String] = None,reactionType:           Option[String] = NonemessageId: Int): ServiceCall[NotUsed ,JsonSuccess]
  ...
  /**
    ...
    * @return JsonSuccessBase
    */
  def renderMessage(content:String          ): ServiceCall[NotUsed ,JsonSuccessBase]
  ...
  /**
    ...
    * @return JsonSuccessBase
    */
  def sendMessage(`type`: Option[MessagesApi&#x60;type&#x60;Enum.MessagesApi&#x60;type&#x60;Enum]content:String          ,topic:           Option[String] = None,queueId:           Option[String] = None,localId:           Option[String] = None): ServiceCall[NotUsed ,JsonSuccessBase]
  ...
  /**
    ...
    * @return JsonSuccess
    */
  def updateMessage(topic:           Option[String] = None,propagateMode: Option[MessagesApiPropagateModeEnum.MessagesApiPropagateModeEnum]sendNotificationToOldThread:           Option[Boolean] /* = true*/,sendNotificationToNewThread:           Option[Boolean] /* = true*/,content:           Option[String] = None,streamId:           Option[Int] = NonemessageId: Int): ServiceCall[NotUsed ,JsonSuccess]
        
  // messages:Seq[Int]  -- not yet supported Seq PathParamSerializers for multi value query parameters https://github.com/lagom/lagom/issues/643
  ...
  /**
    ...
    * @return JsonSuccessBase
    */
  def updateMessageFlags(op: Option[MessagesApiOpEnum.MessagesApiOpEnum]flag:String          ): ServiceCall[NotUsed ,JsonSuccessBase]
  ...
  /**
    ...
    * @return JsonSuccessBase
    */
  def uploadFile(): ServiceCall[NotUsed ,JsonSuccessBase]
  

        object MessagesApi&#x60;type&#x60;Enum extends Enumeration {
        val   private, stream = Value     
        type MessagesApi&#x60;type&#x60;Enum = Value
        implicit val format: Format[Value] = Format(Reads.enumNameReads(this), Writes.enumNameWrites[MessagesApi&#x60;type&#x60;Enum.type])
        implicit val pathParamSerializer: PathParamSerializer[MessagesApi&#x60;type&#x60;Enum] = PathParamSerializer.required("MessagesApi&#x60;type&#x60;Enum")(withName)(_.toString)
        }
        object MessagesApiPropagateModeEnum extends Enumeration {
        val   change_one, change_later, change_all = Value     
        type MessagesApiPropagateModeEnum = Value
        implicit val format: Format[Value] = Format(Reads.enumNameReads(this), Writes.enumNameWrites[MessagesApiPropagateModeEnum.type])
        implicit val pathParamSerializer: PathParamSerializer[MessagesApiPropagateModeEnum] = PathParamSerializer.required("MessagesApiPropagateModeEnum")(withName)(_.toString)
        }
        object MessagesApiOpEnum extends Enumeration {
        val   add, remove = Value     
        type MessagesApiOpEnum = Value
        implicit val format: Format[Value] = Format(Reads.enumNameReads(this), Writes.enumNameWrites[MessagesApiOpEnum.type])
        implicit val pathParamSerializer: PathParamSerializer[MessagesApiOpEnum] = PathParamSerializer.required("MessagesApiOpEnum")(withName)(_.toString)
        }
  }
