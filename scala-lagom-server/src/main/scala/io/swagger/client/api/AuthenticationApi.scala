...
trait AuthenticationApi extends Service {


  final override def descriptor = {
    import Service._
    named("AuthenticationApi").withCalls(
      restCall(Method.POST, "/dev_fetch_api_key?username", devFetchApiKey _), 
      restCall(Method.POST, "/fetch_api_key?username&password", fetchApiKey _)
    ).withAutoAcl(true)
  }
  ...
  /**
    ...
    */
  def devFetchApiKey(username:String          ): ServiceCall[NotUsed ,ApiKeyResponse]
  ...
  /**
    ...
    * @return ApiKeyResponse
    */
  def fetchApiKey(username:String          ,password:String          ): ServiceCall[NotUsed ,ApiKeyResponse]
