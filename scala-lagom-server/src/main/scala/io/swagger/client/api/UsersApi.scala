...
import io.swagger.client.model.OneOfobjectobjectobject
import io.swagger.client.model.OneOfobjectobjectobjectobjectobjectobject
...
trait UsersApi extends Service {
  ...
  final override def descriptor = {
    ...
    named("UsersApi").withCalls(
      restCall(Method.POST, "/users?email&password&fullName", createUser _), 
      restCall(Method.POST, "/user_groups/create?name&description&members", createUserGroup _), 
      restCall(Method.DELETE, "/users/me", deactivateOwnUser _), 
      restCall(Method.DELETE, "/users/:user_id", deactivateUser _), 
      restCall(Method.GET, "/attachments", getAttachments _), 
      restCall(Method.GET, "/users/me", getOwnUser _), 
      restCall(Method.GET, "/users/:user_id?clientGravatar&includeCustomProfileFields", getUser _), 
      restCall(Method.GET, "/users/:email?clientGravatar&includeCustomProfileFields", getUserByEmail _), 
      restCall(Method.GET, "/user_groups", getUserGroups _), 
      restCall(Method.GET, "/users/:user_id_or_email/presence", getUserPresence _), 
      restCall(Method.GET, "/users?clientGravatar&includeCustomProfileFields", getUsers _), 
      restCall(Method.POST, "/users/me/muted_users/:muted_user_id", muteUser _), 
      restCall(Method.POST, "/users/:user_id/reactivate", reactivateUser _), 
      restCall(Method.DELETE, "/user_groups/:user_group_id", removeUserGroup _), 
      restCall(Method.POST, "/typing?`type`&op&to&topic", setTypingStatus _), 
      restCall(Method.DELETE, "/users/me/muted_users/:muted_user_id", unmuteUser _), 
      restCall(Method.PATCH, "/settings?fullName&email&oldPassword&newPassword&twentyFourHourTime&denseMode&starredMessageCounts&fluidLayoutWidth&highContrastMode&colorScheme&enableDraftsSynchronization&translateEmoticons&defaultLanguage&defaultView&leftSideUserlist&emojiset&demoteInactiveStreams&timezone&enableStreamDesktopNotifications&enableStreamEmailNotifications&enableStreamPushNotifications&enableStreamAudibleNotifications&notificationSound&enableDesktopNotifications&enableSounds&emailNotificationsBatchingPeriodSeconds&enableOfflineEmailNotifications&enableOfflinePushNotifications&enableOnlinePushNotifications&enableDigestEmails&enableMarketingEmails&enableLoginEmails&messageContentInEmailNotifications&pmContentInDesktopNotifications&wildcardMentionsNotify&desktopIconCountDisplay&realmNameInNotifications&presenceEnabled&enterSends", updateSettings _), 
      restCall(Method.POST, "/users/me/status?statusText&away&emojiName&emojiCode&reactionType", updateStatus _), 
      restCall(Method.PATCH, "/users/:user_id?fullName&role&profileData", updateUser _), 
      restCall(Method.PATCH, "/user_groups/:user_group_id?name&description", updateUserGroup _), 
      restCall(Method.POST, "/user_groups/:user_group_id/members?delete&add", updateUserGroupMembers _)
    ).withAutoAcl(true)
  }
  ...
  /**
    ...
    */
  def createUser(email:String          ,password:String          ,fullName:String          ): ServiceCall[NotUsed ,JsonSuccessBase]
        
  // members:Seq[Int]  -- not yet supported Seq PathParamSerializers for multi value query parameters https://github.com/lagom/lagom/issues/643
  ...
  /**
    ...
    * @return JsonSuccess
    */
  def createUserGroup(name:String          ,description:String          ,): ServiceCall[NotUsed ,JsonSuccess]
  ...
  /**
    ...
    * @return JsonSuccess
    */
  def deactivateOwnUser(): ServiceCall[NotUsed ,JsonSuccess]
  ...
  /**
    ...
    * @return JsonSuccess
    */
  def deactivateUser(userId: Int): ServiceCall[NotUsed ,JsonSuccess]
  ...
  /**
    ...
    * @return JsonSuccessBase
    */
  def getAttachments(): ServiceCall[NotUsed ,JsonSuccessBase]
  ...
  /**
    ...
    * @return JsonSuccessBase
    */
  def getOwnUser(): ServiceCall[NotUsed ,JsonSuccessBase]
  ...
  /**
    ...
    * @return JsonSuccessBase
    */
  def getUser(clientGravatar:           Option[Boolean] /* = false*/,includeCustomProfileFields:           Option[Boolean] /* = false*/userId: Int): ServiceCall[NotUsed ,JsonSuccessBase]
  ...
  /**
    ...
    * @return JsonSuccessBase
    */
  def getUserByEmail(clientGravatar:           Option[Boolean] /* = false*/,includeCustomProfileFields:           Option[Boolean] /* = false*/email: String): ServiceCall[NotUsed ,JsonSuccessBase]
  ...
  /**
    ...
    * @return JsonSuccessBase
    */
  def getUserGroups(): ServiceCall[NotUsed ,JsonSuccessBase]
  ...
  /**
    ...
    * @return JsonSuccessBase
    */
  def getUserPresence(userIdOrEmail: String): ServiceCall[NotUsed ,JsonSuccessBase]
  ...
  /**
    ...
    * @return JsonSuccessBase
    */
  def getUsers(clientGravatar:           Option[Boolean] /* = false*/,includeCustomProfileFields:           Option[Boolean] /* = false*/): ServiceCall[NotUsed ,JsonSuccessBase]
  ...
  /**
    ...
    * @return JsonSuccess
    */
  def muteUser(mutedUserId: Int): ServiceCall[NotUsed ,JsonSuccess]
  ...
  /**
    ...
    * @return AnyType
    */
  def reactivateUser(userId: Int): ServiceCall[NotUsed ,AnyType]
  ...
  /**
    ...
    * @return JsonSuccess
    */
  def removeUserGroup(userGroupId: Int): ServiceCall[NotUsed ,JsonSuccess]
        
  // to:Seq[Int]  -- not yet supported Seq PathParamSerializers for multi value query parameters https://github.com/lagom/lagom/issues/643
  ...
  /**
    ...
    * @return JsonSuccess
    */
  def setTypingStatus(`type`: Option[UsersApi&#x60;type&#x60;Enum.UsersApi&#x60;type&#x60;Enum]op: Option[UsersApiOpEnum.UsersApiOpEnum]topic:           Option[String] = None): ServiceCall[NotUsed ,JsonSuccess]
  ...
  /**
    ...
    * @return JsonSuccess
    */
  def unmuteUser(mutedUserId: Int): ServiceCall[NotUsed ,JsonSuccess]
  ...
  /**
    ...
    * @return JsonSuccessBase
    */
  def updateSettings(fullName:           Option[String] = None,email:           Option[String] = None,oldPassword:           Option[String] = None,newPassword:           Option[String] = None,twentyFourHourTime:           Option[Boolean] = None,denseMode:           Option[Boolean] = None,starredMessageCounts:           Option[Boolean] = None,fluidLayoutWidth:           Option[Boolean] = None,highContrastMode:           Option[Boolean] = None,colorScheme: Option[UsersApiColorSchemeEnum.UsersApiColorSchemeEnum]enableDraftsSynchronization:           Option[Boolean] = None,translateEmoticons:           Option[Boolean] = None,defaultLanguage:           Option[String] = None,defaultView:           Option[String] = None,leftSideUserlist:           Option[Boolean] = None,emojiset:           Option[String] = None,demoteInactiveStreams: Option[UsersApiDemoteInactiveStreamsEnum.UsersApiDemoteInactiveStreamsEnum]timezone:           Option[String] = None,enableStreamDesktopNotifications:           Option[Boolean] = None,enableStreamEmailNotifications:           Option[Boolean] = None,enableStreamPushNotifications:           Option[Boolean] = None,enableStreamAudibleNotifications:           Option[Boolean] = None,notificationSound:           Option[String] = None,enableDesktopNotifications:           Option[Boolean] = None,enableSounds:           Option[Boolean] = None,emailNotificationsBatchingPeriodSeconds:           Option[Int] = None,enableOfflineEmailNotifications:           Option[Boolean] = None,enableOfflinePushNotifications:           Option[Boolean] = None,enableOnlinePushNotifications:           Option[Boolean] = None,enableDigestEmails:           Option[Boolean] = None,enableMarketingEmails:           Option[Boolean] = None,enableLoginEmails:           Option[Boolean] = None,messageContentInEmailNotifications:           Option[Boolean] = None,pmContentInDesktopNotifications:           Option[Boolean] = None,wildcardMentionsNotify:           Option[Boolean] = None,desktopIconCountDisplay: Option[UsersApiDesktopIconCountDisplayEnum.UsersApiDesktopIconCountDisplayEnum]realmNameInNotifications:           Option[Boolean] = None,presenceEnabled:           Option[Boolean] = None,enterSends:           Option[Boolean] = None): ServiceCall[NotUsed ,JsonSuccessBase]
  ...
  /**
    ...
    * @return JsonSuccess
    */
  def updateStatus(statusText:           Option[String] = None,away:           Option[Boolean] = None,emojiName:           Option[String] = None,emojiCode:           Option[String] = None,reactionType:           Option[String] = None): ServiceCall[NotUsed ,JsonSuccess]
        
  // profileData:Seq[Any]  -- not yet supported Seq PathParamSerializers for multi value query parameters https://github.com/lagom/lagom/issues/643
  ...
  /**
    ...
    * @return JsonSuccess
    */
  def updateUser(fullName:           Option[String] = None,role:           Option[Int] = None,userId: Int): ServiceCall[NotUsed ,JsonSuccess]
  ...
  /**
    ...
    * @return JsonSuccess
    */
  def updateUserGroup(name:String          ,description:String          userGroupId: Int): ServiceCall[NotUsed ,JsonSuccess]
        
  // delete:Seq[Int]  -- not yet supported Seq PathParamSerializers for multi value query parameters https://github.com/lagom/lagom/issues/643
      
  // add:Seq[Int]  -- not yet supported Seq PathParamSerializers for multi value query parameters https://github.com/lagom/lagom/issues/643
  ...
  /**
    ...
    * @return JsonSuccess
    */
  def updateUserGroupMembers(userGroupId: Int): ServiceCall[NotUsed ,JsonSuccess]
  

        object UsersApiOpEnum extends Enumeration {
        val   start, stop = Value     
        type UsersApiOpEnum = Value
        implicit val format: Format[Value] = Format(Reads.enumNameReads(this), Writes.enumNameWrites[UsersApiOpEnum.type])
        implicit val pathParamSerializer: PathParamSerializer[UsersApiOpEnum] = PathParamSerializer.required("UsersApiOpEnum")(withName)(_.toString)
        }
        object UsersApi&#x60;type&#x60;Enum extends Enumeration {
        val   private, stream = Value     
        type UsersApi&#x60;type&#x60;Enum = Value
        implicit val format: Format[Value] = Format(Reads.enumNameReads(this), Writes.enumNameWrites[UsersApi&#x60;type&#x60;Enum.type])
        implicit val pathParamSerializer: PathParamSerializer[UsersApi&#x60;type&#x60;Enum] = PathParamSerializer.required("UsersApi&#x60;type&#x60;Enum")(withName)(_.toString)
        }
        object UsersApiColorSchemeEnum extends Enumeration {
        val   1, 2, 3 = Value     
        type UsersApiColorSchemeEnum = Value
        implicit val format: Format[Value] = Format(Reads.enumNameReads(this), Writes.enumNameWrites[UsersApiColorSchemeEnum.type])
        implicit val pathParamSerializer: PathParamSerializer[UsersApiColorSchemeEnum] = PathParamSerializer.required("UsersApiColorSchemeEnum")(withName)(_.toString)
        }
        object UsersApiDemoteInactiveStreamsEnum extends Enumeration {
        val   1, 2, 3 = Value     
        type UsersApiDemoteInactiveStreamsEnum = Value
        implicit val format: Format[Value] = Format(Reads.enumNameReads(this), Writes.enumNameWrites[UsersApiDemoteInactiveStreamsEnum.type])
        implicit val pathParamSerializer: PathParamSerializer[UsersApiDemoteInactiveStreamsEnum] = PathParamSerializer.required("UsersApiDemoteInactiveStreamsEnum")(withName)(_.toString)
        }
        object UsersApiDesktopIconCountDisplayEnum extends Enumeration {
        val   1, 2, 3 = Value     
        type UsersApiDesktopIconCountDisplayEnum = Value
        implicit val format: Format[Value] = Format(Reads.enumNameReads(this), Writes.enumNameWrites[UsersApiDesktopIconCountDisplayEnum.type])
        implicit val pathParamSerializer: PathParamSerializer[UsersApiDesktopIconCountDisplayEnum] = PathParamSerializer.required("UsersApiDesktopIconCountDisplayEnum")(withName)(_.toString)
        }
  }
