...
trait UsersApi extends Service {
  ...
  final override def descriptor = {
    ...
    named("UsersApi").withCalls(
      ...
      restCall(Method.PATCH, "/settings/display?twentyFourHourTime&denseMode&starredMessageCounts&fluidLayoutWidth&highContrastMode&colorScheme&translateEmoticons&defaultLanguage&defaultView&leftSideUserlist&emojiset&demoteInactiveStreams&timezone", updateDisplaySettings _), 
      restCall(Method.PATCH, "/settings/notifications?enableStreamDesktopNotifications&enableStreamEmailNotifications&enableStreamPushNotifications&enableStreamAudibleNotifications&notificationSound&enableDesktopNotifications&enableSounds&enableOfflineEmailNotifications&enableOfflinePushNotifications&enableOnlinePushNotifications&enableDigestEmails&enableMarketingEmails&enableLoginEmails&messageContentInEmailNotifications&pmContentInDesktopNotifications&wildcardMentionsNotify&desktopIconCountDisplay&realmNameInNotifications&presenceEnabled", updateNotificationSettings _), 
  ...
  /**
    ...
    * @return JsonSuccessBase
    */
  def updateDisplaySettings(twentyFourHourTime:           Option[Boolean] = None,denseMode:           Option[Boolean] = None,starredMessageCounts:           Option[Boolean] = None,fluidLayoutWidth:           Option[Boolean] = None,highContrastMode:           Option[Boolean] = None,colorScheme: Option[UsersApiColorSchemeEnum.UsersApiColorSchemeEnum]translateEmoticons:           Option[Boolean] = None,defaultLanguage:           Option[String] = None,defaultView:           Option[String] = None,leftSideUserlist:           Option[Boolean] = None,emojiset:           Option[String] = None,demoteInactiveStreams: Option[UsersApiDemoteInactiveStreamsEnum.UsersApiDemoteInactiveStreamsEnum]timezone:           Option[String] = None): ServiceCall[NotUsed ,JsonSuccessBase]
