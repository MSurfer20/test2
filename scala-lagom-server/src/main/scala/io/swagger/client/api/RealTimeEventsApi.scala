...
import io.swagger.client.model.BadEventQueueIdError
import io.swagger.client.model.JsonSuccess
import io.swagger.client.model.JsonSuccessBase
import io.swagger.client.model.OneOfInvalidApiKeyErrorMissingArgumentErrorUserNotAuthorizedError
import io.swagger.client.model.OneOfRateLimitedError
import io.swagger.client.model.OneOfUserDeactivatedErrorRealmDeactivatedError

trait RealTimeEventsApi extends Service {


  final override def descriptor = {
    import Service._
    named("RealTimeEventsApi").withCalls(
      restCall(Method.DELETE, "/events?queueId", deleteQueue _), 
      restCall(Method.GET, "/events?queueId&lastEventId&dontBlock", getEvents _), 
      restCall(Method.POST, "/real-time?eventTypes&narrow&allPublicStreams", realTimePost _), 
      restCall(Method.POST, "/register?applyMarkdown&clientGravatar&slimPresence&eventTypes&allPublicStreams&includeSubscribers&clientCapabilities&fetchEventTypes&narrow", registerQueue _), 
      restCall(Method.POST, "/rest-error-handling", restErrorHandling _)
    ).withAutoAcl(true)
  }
  ...
  /**
    ...
    * @return JsonSuccess
    */
  def deleteQueue(queueId:String          ): ServiceCall[NotUsed ,JsonSuccess]
  ...
  /**
    ...
    */
  def getEvents(queueId:String          ,lastEventId:           Option[Int] = None,dontBlock:           Option[Boolean] /* = false*/): ServiceCall[NotUsed ,JsonSuccessBase]
        
  // eventTypes:Seq[String]  -- not yet supported Seq PathParamSerializers for multi value query parameters https://github.com/lagom/lagom/issues/643
      
  // narrow:Seq[Seq[String]]  -- not yet supported Seq PathParamSerializers for multi value query parameters https://github.com/lagom/lagom/issues/643
  ...
  /**
    ...
    * @return void
    */
  def realTimePost(allPublicStreams:           Option[Boolean] /* = false*/): ServiceCall[NotUsed ,Done]
        
  // eventTypes:Seq[String]  -- not yet supported Seq PathParamSerializers for multi value query parameters https://github.com/lagom/lagom/issues/643
      
  // fetchEventTypes:Seq[String]  -- not yet supported Seq PathParamSerializers for multi value query parameters https://github.com/lagom/lagom/issues/643
  ...
  /**
    ...
    * @return JsonSuccessBase
    */
  def registerQueue(applyMarkdown:           Option[Boolean] /* = false*/,clientGravatar:           Option[Boolean] /* = false*/,slimPresence:           Option[Boolean] /* = false*/,allPublicStreams:           Option[Boolean] /* = false*/,includeSubscribers:           Option[Boolean] /* = false*/,clientCapabilities:           Option[Any] = None,): ServiceCall[NotUsed ,JsonSuccessBase]
  ...
  /**
    ...
    * @return void
    */
  def restErrorHandling(): ServiceCall[NotUsed ,Done]
