...
@interface OAIBasicStreamBase : OAIObject

/* The unique ID of the stream.  [optional]
 */
@property(nonatomic) NSNumber* streamId;
/* The name of the stream.  [optional]
 */
@property(nonatomic) NSString* name;
/* The short description of the stream in text/markdown format, intended to be used to prepopulate UI for editing a stream's description.  [optional]
 */
...
/* Whether the given stream is announcement only or not.  **Changes**: Deprecated in Zulip 3.0 (feature level 1), use `stream_post_policy` instead.  [optional]
 */
