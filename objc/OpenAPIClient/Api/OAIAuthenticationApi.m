...
-(NSURLSessionTask*) devFetchApiKeyWithUsername: (NSString*) username
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/dev_fetch_api_key"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"OAIApiKeyResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIApiKeyResponse*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) fetchApiKeyWithUsername: (NSString*) username
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/fetch_api_key"];
