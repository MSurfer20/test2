...
import org.openapitools.model.OneOfLessThanStringCommaArrayGreaterThan
...
data class MessagesBase(
    ...
    @field:JsonProperty("content_type") val contentType: kotlin.String? = null,

    @field:Valid
    @field:JsonProperty("display_recipient") val displayRecipient: OneOfLessThanStringCommaArrayGreaterThan? = null,

    @field:JsonProperty("id") val id: kotlin.Int? = null,

    @field:JsonProperty("is_me_message") val isMeMessage: kotlin.Boolean? = null,

    @field:Valid
    @field:JsonProperty("reactions") val reactions: kotlin.collections.List<EmojiReaction>? = null,

    @field:JsonProperty("recipient_id") val recipientId: kotlin.Int? = null,

    @field:JsonProperty("sender_email") val senderEmail: kotlin.String? = null,

    @field:JsonProperty("sender_full_name") val senderFullName: kotlin.String? = null,

    @field:JsonProperty("sender_id") val senderId: kotlin.Int? = null,

    @field:JsonProperty("sender_realm_str") val senderRealmStr: kotlin.String? = null,

    @field:JsonProperty("stream_id") val streamId: kotlin.Int? = null,

    @field:JsonProperty("subject") val subject: kotlin.String? = null,

    @field:Valid
    @field:JsonProperty("topic_links") val topicLinks: kotlin.collections.List<MessagesBaseTopicLinks>? = null,

    @field:JsonProperty("submessages") val submessages: kotlin.collections.List<kotlin.String>? = null,
