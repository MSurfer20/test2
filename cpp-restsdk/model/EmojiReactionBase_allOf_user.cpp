...
void EmojiReactionBase_allOf_user::validate()
{
    // TODO: implement validation
}

web::json::value EmojiReactionBase_allOf_user::toJson() const
{
...
bool EmojiReactionBase_allOf_user::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void EmojiReactionBase_allOf_user::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool EmojiReactionBase_allOf_user::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
utility::string_t EmojiReactionBase_allOf_user::getEmail() const
{
    return m_Email;
}

void EmojiReactionBase_allOf_user::setEmail(const utility::string_t& value)
{
    m_Email = value;
    m_EmailIsSet = true;
}
...
utility::string_t EmojiReactionBase_allOf_user::getFullName() const
{
    return m_Full_name;
}

void EmojiReactionBase_allOf_user::setFullName(const utility::string_t& value)
{
    m_Full_name = value;
