...
void CodedError_allOf::validate()
{
    // TODO: implement validation
}

web::json::value CodedError_allOf::toJson() const
{
...
bool CodedError_allOf::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CodedError_allOf::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CodedError_allOf::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
std::shared_ptr<AnyType> CodedError_allOf::getResult() const
{
    return m_Result;
}

void CodedError_allOf::setResult(const std::shared_ptr<AnyType>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
...
std::shared_ptr<AnyType> CodedError_allOf::getMsg() const
{
    return m_Msg;
}

void CodedError_allOf::setMsg(const std::shared_ptr<AnyType>& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}
...
std::shared_ptr<AnyType> CodedError_allOf::getCode() const
{
    return m_Code;
}

void CodedError_allOf::setCode(const std::shared_ptr<AnyType>& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}
