...
void EmojiReaction::validate()
{
    // TODO: implement validation
}

web::json::value EmojiReaction::toJson() const
{
...
bool EmojiReaction::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void EmojiReaction::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool EmojiReaction::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
void EmojiReaction::setEmojiCode(const std::shared_ptr<AnyType>& value)
{
    m_Emoji_code = value;
    m_Emoji_codeIsSet = true;
}

bool EmojiReaction::emojiCodeIsSet() const
{
    return m_Emoji_codeIsSet;
}

void EmojiReaction::unsetEmoji_code()
{
    m_Emoji_codeIsSet = false;
}
...
void EmojiReaction::setEmojiName(const std::shared_ptr<AnyType>& value)
{
    m_Emoji_name = value;
    m_Emoji_nameIsSet = true;
}

bool EmojiReaction::emojiNameIsSet() const
{
    return m_Emoji_nameIsSet;
}

void EmojiReaction::unsetEmoji_name()
{
    m_Emoji_nameIsSet = false;
}
...
void EmojiReaction::setReactionType(const std::shared_ptr<AnyType>& value)
{
    m_Reaction_type = value;
    m_Reaction_typeIsSet = true;
}

bool EmojiReaction::reactionTypeIsSet() const
{
    return m_Reaction_typeIsSet;
}

void EmojiReaction::unsetReaction_type()
{
    m_Reaction_typeIsSet = false;
}
...
void EmojiReaction::setUserId(const std::shared_ptr<AnyType>& value)
{
    m_User_id = value;
    m_User_idIsSet = true;
}

bool EmojiReaction::userIdIsSet() const
{
    return m_User_idIsSet;
}

void EmojiReaction::unsetUser_id()
{
    m_User_idIsSet = false;
}
...
void EmojiReaction::setUser(const std::shared_ptr<AnyType>& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool EmojiReaction::userIsSet() const
{
    return m_UserIsSet;
}

void EmojiReaction::unsetUser()
{
    m_UserIsSet = false;
}
}
