...
void RateLimitedError::validate()
{
    // TODO: implement validation
}

web::json::value RateLimitedError::toJson() const
{
...
bool RateLimitedError::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void RateLimitedError::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RateLimitedError::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
std::shared_ptr<AnyType> RateLimitedError::getResult() const
{
    return m_Result;
}

void RateLimitedError::setResult(const std::shared_ptr<AnyType>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool RateLimitedError::resultIsSet() const
{
    return m_ResultIsSet;
}

void RateLimitedError::unsetResult()
{
    m_ResultIsSet = false;
}
std::shared_ptr<AnyType> RateLimitedError::getMsg() const
{
    return m_Msg;
}

void RateLimitedError::setMsg(const std::shared_ptr<AnyType>& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool RateLimitedError::msgIsSet() const
{
    return m_MsgIsSet;
}

void RateLimitedError::unsetMsg()
{
    m_MsgIsSet = false;
}
std::shared_ptr<AnyType> RateLimitedError::getCode() const
{
    return m_Code;
}

void RateLimitedError::setCode(const std::shared_ptr<AnyType>& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}
