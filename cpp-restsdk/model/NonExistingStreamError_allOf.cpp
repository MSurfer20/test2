...
void NonExistingStreamError_allOf::validate()
{
    // TODO: implement validation
}

web::json::value NonExistingStreamError_allOf::toJson() const
{
...
bool NonExistingStreamError_allOf::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void NonExistingStreamError_allOf::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool NonExistingStreamError_allOf::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
void NonExistingStreamError_allOf::setResult(const std::shared_ptr<AnyType>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
...
void NonExistingStreamError_allOf::setMsg(const std::shared_ptr<AnyType>& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}
...
void NonExistingStreamError_allOf::setCode(const std::shared_ptr<AnyType>& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}
...
utility::string_t NonExistingStreamError_allOf::getStream() const
{
    return m_Stream;
}

void NonExistingStreamError_allOf::setStream(const utility::string_t& value)
{
    m_Stream = value;
    m_StreamIsSet = true;
}
