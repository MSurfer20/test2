...
void JsonErrorBase::validate()
{
    // TODO: implement validation
}

web::json::value JsonErrorBase::toJson() const
{
...
bool JsonErrorBase::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void JsonErrorBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool JsonErrorBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
utility::string_t JsonErrorBase::getResult() const
{
    return m_Result;
}

void JsonErrorBase::setResult(const utility::string_t& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool JsonErrorBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void JsonErrorBase::unsetResult()
{
    m_ResultIsSet = false;
}
utility::string_t JsonErrorBase::getMsg() const
{
    return m_Msg;
}

void JsonErrorBase::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool JsonErrorBase::msgIsSet() const
{
    return m_MsgIsSet;
}

void JsonErrorBase::unsetMsg()
{
    m_MsgIsSet = false;
}
}
