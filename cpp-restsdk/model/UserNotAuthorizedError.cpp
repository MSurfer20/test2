...
void UserNotAuthorizedError::validate()
{
    // TODO: implement validation
}

web::json::value UserNotAuthorizedError::toJson() const
{
...
bool UserNotAuthorizedError::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void UserNotAuthorizedError::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UserNotAuthorizedError::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
void UserNotAuthorizedError::setResult(const std::shared_ptr<AnyType>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool UserNotAuthorizedError::resultIsSet() const
{
    return m_ResultIsSet;
}

void UserNotAuthorizedError::unsetResult()
{
    m_ResultIsSet = false;
}
...
void UserNotAuthorizedError::setMsg(const std::shared_ptr<AnyType>& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool UserNotAuthorizedError::msgIsSet() const
{
    return m_MsgIsSet;
}

void UserNotAuthorizedError::unsetMsg()
{
    m_MsgIsSet = false;
}
...
void UserNotAuthorizedError::setCode(const std::shared_ptr<AnyType>& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}
