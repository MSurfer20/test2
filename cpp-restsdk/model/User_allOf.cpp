...
void User_allOf::validate()
{
    // TODO: implement validation
}

web::json::value User_allOf::toJson() const
{
...
bool User_allOf::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void User_allOf::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool User_allOf::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
void User_allOf::setEmail(const std::shared_ptr<AnyType>& value)
{
    m_Email = value;
    m_EmailIsSet = true;
}
...
void User_allOf::setIsBot(const std::shared_ptr<AnyType>& value)
{
    m_Is_bot = value;
    m_Is_botIsSet = true;
}
...
void User_allOf::setAvatarUrl(const std::shared_ptr<AnyType>& value)
{
    m_Avatar_url = value;
...
void User_allOf::setAvatarVersion(const std::shared_ptr<AnyType>& value)
{
...
void User_allOf::setFullName(const std::shared_ptr<AnyType>& value)
{
    m_Full_name = value;
...
void User_allOf::setIsAdmin(const std::shared_ptr<AnyType>& value)
{
    m_Is_admin = value;
...
void User_allOf::setIsOwner(const std::shared_ptr<AnyType>& value)
{
    m_Is_owner = value;
...
void User_allOf::setIsBillingAdmin(const std::shared_ptr<AnyType>& value)
{
...
void User_allOf::setRole(const std::shared_ptr<AnyType>& value)
{
    m_Role = value;
    m_RoleIsSet = true;
}
...
void User_allOf::setBotType(const std::shared_ptr<AnyType>& value)
{
    m_Bot_type = value;
...
void User_allOf::setUserId(const std::shared_ptr<AnyType>& value)
{
    m_User_id = value;
    m_User_idIsSet = true;
}
...
void User_allOf::setBotOwnerId(const std::shared_ptr<AnyType>& value)
{
...
void User_allOf::setIsActive(const std::shared_ptr<AnyType>& value)
{
    m_Is_active = value;
...
void User_allOf::setIsGuest(const std::shared_ptr<AnyType>& value)
{
    m_Is_guest = value;
...
void User_allOf::setTimezone(const std::shared_ptr<AnyType>& value)
{
    m_Timezone = value;
...
void User_allOf::setDateJoined(const std::shared_ptr<AnyType>& value)
{
    m_Date_joined = value;
...
void User_allOf::setDeliveryEmail(const std::shared_ptr<AnyType>& value)
{
...
void User_allOf::setProfileData(const std::shared_ptr<AnyType>& value)
{
