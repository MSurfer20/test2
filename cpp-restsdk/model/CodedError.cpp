...
void CodedError::validate()
{
    // TODO: implement validation
}

web::json::value CodedError::toJson() const
{
...
bool CodedError::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CodedError::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CodedError::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
void CodedError::setResult(const std::shared_ptr<AnyType>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool CodedError::resultIsSet() const
{
    return m_ResultIsSet;
}

void CodedError::unsetResult()
{
    m_ResultIsSet = false;
}
...
void CodedError::setMsg(const std::shared_ptr<AnyType>& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool CodedError::msgIsSet() const
{
    return m_MsgIsSet;
}

void CodedError::unsetMsg()
{
    m_MsgIsSet = false;
}
...
void CodedError::setCode(const std::shared_ptr<AnyType>& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}
