...
void JsonError::validate()
{
    // TODO: implement validation
}

web::json::value JsonError::toJson() const
{
...
bool JsonError::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void JsonError::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool JsonError::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
std::shared_ptr<AnyType> JsonError::getResult() const
{
    return m_Result;
}

void JsonError::setResult(const std::shared_ptr<AnyType>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool JsonError::resultIsSet() const
{
    return m_ResultIsSet;
}

void JsonError::unsetResult()
{
    m_ResultIsSet = false;
}
std::shared_ptr<AnyType> JsonError::getMsg() const
{
    return m_Msg;
}

void JsonError::setMsg(const std::shared_ptr<AnyType>& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool JsonError::msgIsSet() const
{
    return m_MsgIsSet;
}

void JsonError::unsetMsg()
{
    m_MsgIsSet = false;
}
}
