...
void RealmDeactivatedError::validate()
{
    // TODO: implement validation
}

web::json::value RealmDeactivatedError::toJson() const
{
...
bool RealmDeactivatedError::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void RealmDeactivatedError::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RealmDeactivatedError::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
std::shared_ptr<AnyType> RealmDeactivatedError::getResult() const
{
    return m_Result;
}

void RealmDeactivatedError::setResult(const std::shared_ptr<AnyType>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool RealmDeactivatedError::resultIsSet() const
{
    return m_ResultIsSet;
}

void RealmDeactivatedError::unsetResult()
{
    m_ResultIsSet = false;
}
std::shared_ptr<AnyType> RealmDeactivatedError::getMsg() const
{
    return m_Msg;
}

void RealmDeactivatedError::setMsg(const std::shared_ptr<AnyType>& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool RealmDeactivatedError::msgIsSet() const
{
    return m_MsgIsSet;
}

void RealmDeactivatedError::unsetMsg()
{
    m_MsgIsSet = false;
}
std::shared_ptr<AnyType> RealmDeactivatedError::getCode() const
{
    return m_Code;
}

void RealmDeactivatedError::setCode(const std::shared_ptr<AnyType>& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}
