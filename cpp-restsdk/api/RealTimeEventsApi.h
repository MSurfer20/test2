...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_RealTimeEventsApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_RealTimeEventsApi_H_
...
public:
    ...
    explicit RealTimeEventsApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~RealTimeEventsApi();
    ...
    pplx::task<std::shared_ptr<JsonSuccess>> deleteQueue(
    ...
    pplx::task<std::shared_ptr<JsonSuccessBase>> getEvents(
        utility::string_t queueId,
        boost::optional<int32_t> lastEventId,
        boost::optional<bool> dontBlock
    ) const;
    /// <summary>
    /// 
    /// </summary>
    ...
    /// (Ignored) 
    /// </remarks>
    /// <param name="eventTypes">A JSON-encoded array indicating which types of events you&#39;re interested in. Values that you might find useful include:    * **message** (messages)   * **subscription** (changes in your subscriptions)   * **realm_user** (changes to users in the organization and     their properties, such as their name).  If you do not specify this parameter, you will receive all events, and have to filter out the events not relevant to your client in your client code.  For most applications, one is only interested in messages, so one specifies: &#x60;event_types&#x3D;[&#39;message&#39;]&#x60;  Event types not supported by the server are ignored, in order to simplify the implementation of client apps that support multiple server versions.  (optional, default to std::vector&lt;std::shared_ptr&lt;utility::string_t&gt;&gt;())</param>
    /// <param name="narrow">A JSON-encoded array of arrays of length 2 indicating the narrow for which you&#39;d like to receive events for. For instance, to receive events for the stream &#x60;Denmark&#x60;, you would specify &#x60;narrow&#x3D;[[&#39;stream&#39;, &#39;Denmark&#39;]]&#x60;.  Another example is &#x60;narrow&#x3D;[[&#39;is&#39;, &#39;private&#39;]]&#x60; for private messages. Default is &#x60;[]&#x60;.  (optional, default to std::vector&lt;std::shared_ptr&lt;std::vector&gt;&gt;())</param>
    ...
    pplx::task<void> realTimePost(
        boost::optional<std::vector<utility::string_t>> eventTypes,
        boost::optional<std::vector<std::vector<utility::string_t>>> narrow,
        boost::optional<bool> allPublicStreams
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> restErrorHandling(
    ) const;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_RealTimeEventsApi_H_ */
