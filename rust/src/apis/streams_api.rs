...
/// struct for typed errors of method `archive_stream`
...
pub async fn archive_stream(configuration: &configuration::Configuration, stream_id: i32) -> Result<crate::models::JsonSuccess, Error<ArchiveStreamError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ArchiveStreamError> = serde_json::from_str(&local_var_content).ok();
