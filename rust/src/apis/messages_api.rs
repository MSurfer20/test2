...
pub async fn check_messages_match_narrow(configuration: &configuration::Configuration, msg_ids: Vec<i32>, narrow: Vec<serde_json::Value>) -> Result<serde_json::Value, Error<CheckMessagesMatchNarrowError>> {
