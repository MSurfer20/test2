...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZulipRestApi.Messages();
  });
  ...
  describe('Messages', function() {
    it('should create an instance of Messages', function() {
      ...
      //var instance = new ZulipRestApi.Messages();
      //expect(instance).to.be.a(ZulipRestApi.Messages);
    });
    ...
    it('should have the property avatarUrl (base name: "avatar_url")', function() {
      ...
      //var instane = new ZulipRestApi.Messages();
