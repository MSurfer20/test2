...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZulipRestApi.BasicBot();
  });
  ...
  describe('BasicBot', function() {
    it('should create an instance of BasicBot', function() {
      // uncomment below and update the code to test BasicBot
      //var instance = new ZulipRestApi.BasicBot();
      //expect(instance).to.be.a(ZulipRestApi.BasicBot);
    });

    it('should have the property userId (base name: "user_id")', function() {
      // uncomment below and update the code to test the property userId
      //var instane = new ZulipRestApi.BasicBot();
