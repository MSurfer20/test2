    ...
    */
    ...
    async createUserGroup(name, description, members) {
      ...
      let queryParams = {
        ...
        'members': this.buildCollectionParam(members, 'multi')
      };
      let headerParams = {
        'User-Agent': 'OpenAPI-Generator/1.0.0/Javascript',
      };
     ...
     * @return {Promise<JsonSuccessBase>}
     */
    async getUserPresence(userIdOrEmail) {
      let postBody = null;
     ...
     * @return {Promise<JsonSuccess>}
     */
    async removeUserGroup(userGroupId) {
      let postBody = null;
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.type Type of the message being composed.  (default to 'private')
     ...
     * @return {Promise<JsonSuccess>}
     */
    async setTypingStatus(op, to, opts) {
      opts = opts || {};
      let postBody = null;
     ...
     * @param {Number} opts.colorScheme Controls which [color theme](/help/night-mode) to use.  * 1 - Automatic * 2 - Night mode * 3 - Day mode  Automatic detection is implementing using the standard `prefers-color-scheme` media query.  **Changes**: Before Zulip 5.0 (feature level 80), this setting was managed by the `PATCH /settings/display` endpoint. 
     ...
     * @param {Number} opts.demoteInactiveStreams Whether to [demote inactive streams](/help/manage-inactive-streams) in the left sidebar.  * 1 - Automatic * 2 - Always * 3 - Never  **Changes**: Before Zulip 5.0 (feature level 80), this setting was managed by the `PATCH /settings/display` endpoint. 
     ...
     * @param {Number} opts.desktopIconCountDisplay Unread count summary (appears in desktop sidebar and browser tab)  * 1 - All unreads * 2 - Private messages and mentions * 3 - None  **Changes**: Before Zulip 5.0 (feature level 80), this setting was managed by the `PATCH /settings/notifications` endpoint. 
    ...
    async updateUser(userId, opts) {
      ...
      let queryParams = {
        'full_name': opts['fullName'],
        'role': opts['role'],
        'profile_data': this.buildCollectionParam(opts['profileData'], 'multi')
      };
      let headerParams = {
        'User-Agent': 'OpenAPI-Generator/1.0.0/Javascript',
      };
     ...
     * @return {Promise<JsonSuccess>}
     */
    async updateUserGroup(userGroupId, name, description) {
      let postBody = null;
      // verify the required parameter 'userGroupId' is set
      if (userGroupId === undefined || userGroupId === null) {
     ...
     * @return {Promise<JsonSuccess>}
     */
    async updateUserGroupMembers(userGroupId, opts) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'userGroupId' is set
      if (userGroupId === undefined || userGroupId === null) {
