...
export default class UsersApi extends ApiClient {
    ...
    */
     ...
     * @param {Number} opts.colorScheme Controls which [color theme](/help/night-mode) to use.  * 1 - Automatic * 2 - Night mode * 3 - Day mode  Automatic detection is implementing using the standard `prefers-color-scheme` media query. 
     ...
     * @param {Number} opts.demoteInactiveStreams Whether to [demote inactive streams](/help/manage-inactive-streams) in the left sidebar.  * 1 - Automatic * 2 - Always * 3 - Never 
     ...
     * @return {Promise<JsonSuccessBase>}
     */
    async updateDisplaySettings(opts) {
      opts = opts || {};
      let postBody = null;
     ...
     * @param {Number} opts.desktopIconCountDisplay Unread count summary (appears in desktop sidebar and browser tab)  * 1 - All unreads * 2 - Private messages and mentions * 3 - None 
     ...
     * @return {Promise<JsonSuccessBase>}
     */
    async updateNotificationSettings(opts) {
      opts = opts || {};
      let postBody = null;
