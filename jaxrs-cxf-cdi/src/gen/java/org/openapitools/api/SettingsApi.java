...
public class SettingsApi  {
  ...
  @Inject SettingsApiService delegate;
    ...
    @ApiOperation(value = "Update display settings", notes = "This endpoint is used to edit the current user's user interface settings.  `PATCH {{ api_url }}/v1/settings/display` ", response = JsonSuccessBase.class, tags={ "users" })
    @ApiResponses(value = { 
