...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EmojiReactionBase_allOf_user")]
    public partial class EmojiReactionBaseAllOfUser : IEquatable<EmojiReactionBaseAllOfUser>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmojiReactionBaseAllOfUser" /> class.
        /// </summary>
        ...
        public EmojiReactionBaseAllOfUser(int id = default(int), string email = default(string), string fullName = default(string), bool isMirrorDummy = default(bool))
        {
            this.Id = id;
            this.Email = email;
        ...
        {
            return this.Equals(input as EmojiReactionBaseAllOfUser);
        }

        /// <summary>
        /// Returns true if EmojiReactionBaseAllOfUser instances are equal
        /// </summary>
        /// <param name="input">Instance of EmojiReactionBaseAllOfUser to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmojiReactionBaseAllOfUser input)
        {
            if (input == null)
                return false;
