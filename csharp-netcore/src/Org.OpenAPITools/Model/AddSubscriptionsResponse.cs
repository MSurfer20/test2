...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AddSubscriptionsResponse")]
    public partial class AddSubscriptionsResponse : IEquatable<AddSubscriptionsResponse>, IValidatableObject
    {
        ...
        public AddSubscriptionsResponse(Object result = default(Object), Object msg = default(Object), Dictionary<string, List<string>> subscribed = default(Dictionary<string, List<string>>), Dictionary<string, List<string>> alreadySubscribed = default(Dictionary<string, List<string>>), List<string> unauthorized = default(List<string>))
        {
            ...
            this.Result = result ?? throw new ArgumentNullException("result is a required property for AddSubscriptionsResponse and cannot be null");
            // to ensure "msg" is required (not null)
            this.Msg = msg ?? throw new ArgumentNullException("msg is a required property for AddSubscriptionsResponse and cannot be null");
