...
namespace Org.OpenAPITools.Model
{
    ...
    /// CodedErrorBase
    /// </summary>
    [DataContract(Name = "CodedErrorBase")]
    public partial class CodedErrorBase : IEquatable<CodedErrorBase>, IValidatableObject
    {
        ...
        public CodedErrorBase(Object result = default(Object), Object msg = default(Object), string code = default(string))
        {
            ...
            this.Result = result ?? throw new ArgumentNullException("result is a required property for CodedErrorBase and cannot be null");
            // to ensure "msg" is required (not null)
            this.Msg = msg ?? throw new ArgumentNullException("msg is a required property for CodedErrorBase and cannot be null");
            this.Code = code;
        }
