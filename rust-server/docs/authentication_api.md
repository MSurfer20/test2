...
------------- | ------------- | -------------
**dev-fetch-api-key**](authentication_api.md#dev-fetch-api-key) | **POST** /dev_fetch_api_key | Fetch an API key (development only)
**fetch-api-key**](authentication_api.md#fetch-api-key) | **POST** /fetch_api_key | Fetch an API key (production)


# **dev-fetch-api-key**
> ApiKeyResponse dev-fetch-api-key(username)
...
# **fetch-api-key**
> ApiKeyResponse fetch-api-key(username, password)
