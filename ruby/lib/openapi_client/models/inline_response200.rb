...
module OpenapiClient
  ...
  class InlineResponse200
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'bot_email')
        self.bot_email = attributes[:'bot_email']
      end

      if attributes.key?(:'bot_full_name')
        self.bot_full_name = attributes[:'bot_full_name']
      end
