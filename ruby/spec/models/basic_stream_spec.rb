...
# Unit tests for OpenapiClient::BasicStream
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::BasicStream do
  let(:instance) { OpenapiClient::BasicStream.new }

  describe 'test an instance of BasicStream' do
    it 'should create an instance of BasicStream' do
      expect(instance).to be_instance_of(OpenapiClient::BasicStream)
    end
  end
