...
# Unit tests for OpenapiClient::Subscriptions
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Subscriptions do
  let(:instance) { OpenapiClient::Subscriptions.new }

  describe 'test an instance of Subscriptions' do
    it 'should create an instance of Subscriptions' do
      expect(instance).to be_instance_of(OpenapiClient::Subscriptions)
    end
  end
  ...
  describe 'test attribute "role"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Integer', [20, 50])
