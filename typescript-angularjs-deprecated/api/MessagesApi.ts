...
export class MessagesApi {
     ...
     */
    public addReaction (messageId: number, emojiName: string, emojiCode?: string, reactionType?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.models.JsonSuccess> {
     ...
     */
    public checkMessagesMatchNarrow (msgIds: Array<number>, narrow: Array<object>, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.models.JsonSuccessBase & object> {
     ...
     * @param messageId The target message\&#39;s ID. 
     */
    public deleteMessage (messageId: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.models.JsonSuccess> {
     ...
     */
    public getFileTemporaryUrl (realmIdStr: number, filename: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.models.JsonSuccessBase & object> {
     ...
     * @param messageId The target message\&#39;s ID. 
     */
    public getMessageHistory (messageId: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.models.JsonSuccessBase & object> {
     ...
     */
    public getMessages (numBefore: number, numAfter: number, anchor?: models.string | number, narrow?: Array<object>, clientGravatar?: boolean, applyMarkdown?: boolean, useFirstUnreadAnchor?: boolean, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.models.JsonSuccessBase & object> {
        ...
        if (useFirstUnreadAnchor !== undefined) {
            queryParameters['use_first_unread_anchor'] = useFirstUnreadAnchor;
        }
     ...
     * @param messageId The target message\&#39;s ID. 
     */
    public getRawMessage (messageId: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.models.JsonSuccessBase & object> {
        const localVarPath = this.basePath + '/messages/{message_id}'
            .replace('{' + 'message_id' + '}', encodeURIComponent(String(messageId)));
     ...
     */
    public markAllAsRead (extraHttpRequestParams?: any ) : ng.IHttpPromise<models.models.JsonSuccess> {
     ...
     */
    public markStreamAsRead (streamId: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.models.JsonSuccess> {
     ...
     */
    public markTopicAsRead (streamId: number, topicName: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.models.JsonSuccess> {
     ...
     * @param reactionType If an app is adding/removing a vote on an existing reaction, it should pass this parameter using the value the server provided for the existing reaction for specificity.  Supported values:  * &#x60;unicode_emoji&#x60;: Unicode emoji (&#x60;emoji_code&#x60; will be its Unicode codepoint). * &#x60;realm_emoji&#x60;: Custom emoji. (&#x60;emoji_code&#x60; will be its ID). * &#x60;zulip_extra_emoji&#x60;: Special emoji included with Zulip.  Exists to    namespace the &#x60;zulip&#x60; emoji.  **Changes**: In Zulip 3.0 (feature level 2), this become optional for [custom emoji](/help/add-custom-emoji); previously, this endpoint assumed &#x60;unicode_emoji&#x60; if this parameter was not specified. 
     */
    public removeReaction (messageId: number, emojiName?: string, emojiCode?: string, reactionType?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.models.JsonSuccess> {
        const localVarPath = this.basePath + '/messages/{message_id}/reactions'
            .replace('{' + 'message_id' + '}', encodeURIComponent(String(messageId)));
     ...
     */
    public renderMessage (content: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.models.JsonSuccessBase & object> {
     ...
     */
    public sendMessage (type: 'private' | 'stream', to: Array<number>, content: string, topic?: string, queueId?: string, localId?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.models.JsonSuccessBase & object> {
        const localVarPath = this.basePath + '/messages';
     ...
     */
    public updateMessage (messageId: number, topic?: string, propagateMode?: 'change_one' | 'change_later' | 'change_all', sendNotificationToOldThread?: boolean, sendNotificationToNewThread?: boolean, content?: string, streamId?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.models.JsonSuccess> {
        const localVarPath = this.basePath + '/messages/{message_id}'
            .replace('{' + 'message_id' + '}', encodeURIComponent(String(messageId)));
        ...
        if (propagateMode !== undefined) {
            queryParameters['propagate_mode'] = propagateMode;
        }

        if (sendNotificationToOldThread !== undefined) {
            queryParameters['send_notification_to_old_thread'] = sendNotificationToOldThread;
        }

        if (sendNotificationToNewThread !== undefined) {
            queryParameters['send_notification_to_new_thread'] = sendNotificationToNewThread;
        }
     ...
     */
    public updateMessageFlags (messages: Array<number>, op: 'add' | 'remove', flag: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.models.JsonSuccessBase & object> {
     ...
     * @param filename 
     */
    public uploadFile (filename?: any, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.models.JsonSuccessBase & object> {
