...
OAIAnyType OAIBot::getUserId() const {
    return user_id;
}
void OAIBot::setUserId(const OAIAnyType &user_id) {
...
OAIAnyType OAIBot::getFullName() const {
    return full_name;
}
void OAIBot::setFullName(const OAIAnyType &full_name) {
    this->full_name = full_name;
    this->m_full_name_isSet = true;
}

bool OAIBot::is_full_name_Set() const{
    return m_full_name_isSet;
}

bool OAIBot::is_full_name_Valid() const{
    return m_full_name_isValid;
}

OAIAnyType OAIBot::getApiKey() const {
    return api_key;
}
void OAIBot::setApiKey(const OAIAnyType &api_key) {
    this->api_key = api_key;
    this->m_api_key_isSet = true;
}

bool OAIBot::is_api_key_Set() const{
    return m_api_key_isSet;
}

bool OAIBot::is_api_key_Valid() const{
    return m_api_key_isValid;
}

OAIAnyType OAIBot::getDefaultSendingStream() const {
    return default_sending_stream;
}
void OAIBot::setDefaultSendingStream(const OAIAnyType &default_sending_stream) {
    this->default_sending_stream = default_sending_stream;
    this->m_default_sending_stream_isSet = true;
}

bool OAIBot::is_default_sending_stream_Set() const{
    return m_default_sending_stream_isSet;
}

bool OAIBot::is_default_sending_stream_Valid() const{
    return m_default_sending_stream_isValid;
}

OAIAnyType OAIBot::getDefaultEventsRegisterStream() const {
    return default_events_register_stream;
}
void OAIBot::setDefaultEventsRegisterStream(const OAIAnyType &default_events_register_stream) {
    this->default_events_register_stream = default_events_register_stream;
    this->m_default_events_register_stream_isSet = true;
}

bool OAIBot::is_default_events_register_stream_Set() const{
    return m_default_events_register_stream_isSet;
}

bool OAIBot::is_default_events_register_stream_Valid() const{
    return m_default_events_register_stream_isValid;
}

OAIAnyType OAIBot::getDefaultAllPublicStreams() const {
    return default_all_public_streams;
}
void OAIBot::setDefaultAllPublicStreams(const OAIAnyType &default_all_public_streams) {
    this->default_all_public_streams = default_all_public_streams;
    this->m_default_all_public_streams_isSet = true;
}

bool OAIBot::is_default_all_public_streams_Set() const{
    return m_default_all_public_streams_isSet;
}

bool OAIBot::is_default_all_public_streams_Valid() const{
    return m_default_all_public_streams_isValid;
}

OAIAnyType OAIBot::getAvatarUrl() const {
    return avatar_url;
}
void OAIBot::setAvatarUrl(const OAIAnyType &avatar_url) {
    this->avatar_url = avatar_url;
    this->m_avatar_url_isSet = true;
}

bool OAIBot::is_avatar_url_Set() const{
    return m_avatar_url_isSet;
}

bool OAIBot::is_avatar_url_Valid() const{
    return m_avatar_url_isValid;
}

OAIAnyType OAIBot::getOwnerId() const {
    return owner_id;
}
void OAIBot::setOwnerId(const OAIAnyType &owner_id) {
    this->owner_id = owner_id;
    this->m_owner_id_isSet = true;
}

bool OAIBot::is_owner_id_Set() const{
    return m_owner_id_isSet;
}

bool OAIBot::is_owner_id_Valid() const{
    return m_owner_id_isValid;
}

OAIAnyType OAIBot::getServices() const {
    return services;
}
void OAIBot::setServices(const OAIAnyType &services) {
    this->services = services;
    this->m_services_isSet = true;
}

bool OAIBot::is_services_Set() const{
    return m_services_isSet;
}

bool OAIBot::is_services_Valid() const{
    return m_services_isValid;
}

QString OAIBot::getEmail() const {
    return email;
}
void OAIBot::setEmail(const QString &email) {
    this->email = email;
    this->m_email_isSet = true;
}

bool OAIBot::is_email_Set() const{
    return m_email_isSet;
}

bool OAIBot::is_email_Valid() const{
    return m_email_isValid;
}

qint32 OAIBot::getBotType() const {
    return bot_type;
}
void OAIBot::setBotType(const qint32 &bot_type) {
...
bool OAIBot::isIsActive() const {
    return is_active;
}
void OAIBot::setIsActive(const bool &is_active) {
    this->is_active = is_active;
    this->m_is_active_isSet = true;
}

bool OAIBot::is_is_active_Set() const{
    return m_is_active_isSet;
}

bool OAIBot::is_is_active_Valid() const{
