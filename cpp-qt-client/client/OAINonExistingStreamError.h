...
/*
 * OAINonExistingStreamError.h
 *
 * 
 */

#ifndef OAINonExistingStreamError_H
#define OAINonExistingStreamError_H
...
class OAINonExistingStreamError : public OAIObject {
public:
    OAINonExistingStreamError();
    OAINonExistingStreamError(QString json);
    ~OAINonExistingStreamError() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINonExistingStreamError)

#endif // OAINonExistingStreamError_H
