...
OAIBasicStream_allOf::OAIBasicStream_allOf(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBasicStream_allOf::OAIBasicStream_allOf() {
    this->initializeModel();
}

OAIBasicStream_allOf::~OAIBasicStream_allOf() {}

void OAIBasicStream_allOf::initializeModel() {
...
void OAIBasicStream_allOf::fromJson(QString jsonString) {
...
void OAIBasicStream_allOf::fromJsonObject(QJsonObject json) {
...
QString OAIBasicStream_allOf::asJson() const {
...
QJsonObject OAIBasicStream_allOf::asJsonObject() const {
    QJsonObject obj;
...
OAIAnyType OAIBasicStream_allOf::getStreamId() const {
    return stream_id;
}
void OAIBasicStream_allOf::setStreamId(const OAIAnyType &stream_id) {
    this->stream_id = stream_id;
    this->m_stream_id_isSet = true;
}

bool OAIBasicStream_allOf::is_stream_id_Set() const{
    return m_stream_id_isSet;
}

bool OAIBasicStream_allOf::is_stream_id_Valid() const{
    return m_stream_id_isValid;
}

OAIAnyType OAIBasicStream_allOf::getName() const {
    return name;
}
void OAIBasicStream_allOf::setName(const OAIAnyType &name) {
    this->name = name;
    this->m_name_isSet = true;
}

bool OAIBasicStream_allOf::is_name_Set() const{
    return m_name_isSet;
}

bool OAIBasicStream_allOf::is_name_Valid() const{
    return m_name_isValid;
}

OAIAnyType OAIBasicStream_allOf::getDescription() const {
    return description;
}
void OAIBasicStream_allOf::setDescription(const OAIAnyType &description) {
    this->description = description;
    this->m_description_isSet = true;
}

bool OAIBasicStream_allOf::is_description_Set() const{
    return m_description_isSet;
}

bool OAIBasicStream_allOf::is_description_Valid() const{
    return m_description_isValid;
}

OAIAnyType OAIBasicStream_allOf::getDateCreated() const {
    return date_created;
}
void OAIBasicStream_allOf::setDateCreated(const OAIAnyType &date_created) {
    this->date_created = date_created;
    this->m_date_created_isSet = true;
}

bool OAIBasicStream_allOf::is_date_created_Set() const{
    return m_date_created_isSet;
}

bool OAIBasicStream_allOf::is_date_created_Valid() const{
    return m_date_created_isValid;
}

OAIAnyType OAIBasicStream_allOf::getInviteOnly() const {
    return invite_only;
}
void OAIBasicStream_allOf::setInviteOnly(const OAIAnyType &invite_only) {
    this->invite_only = invite_only;
    this->m_invite_only_isSet = true;
}

bool OAIBasicStream_allOf::is_invite_only_Set() const{
    return m_invite_only_isSet;
}

bool OAIBasicStream_allOf::is_invite_only_Valid() const{
    return m_invite_only_isValid;
}

OAIAnyType OAIBasicStream_allOf::getRenderedDescription() const {
    return rendered_description;
}
void OAIBasicStream_allOf::setRenderedDescription(const OAIAnyType &rendered_description) {
    this->rendered_description = rendered_description;
    this->m_rendered_description_isSet = true;
}

bool OAIBasicStream_allOf::is_rendered_description_Set() const{
    return m_rendered_description_isSet;
}

bool OAIBasicStream_allOf::is_rendered_description_Valid() const{
    return m_rendered_description_isValid;
}

OAIAnyType OAIBasicStream_allOf::getIsWebPublic() const {
    return is_web_public;
}
void OAIBasicStream_allOf::setIsWebPublic(const OAIAnyType &is_web_public) {
    this->is_web_public = is_web_public;
    this->m_is_web_public_isSet = true;
}

bool OAIBasicStream_allOf::is_is_web_public_Set() const{
    return m_is_web_public_isSet;
}

bool OAIBasicStream_allOf::is_is_web_public_Valid() const{
    return m_is_web_public_isValid;
}

OAIAnyType OAIBasicStream_allOf::getStreamPostPolicy() const {
    return stream_post_policy;
}
void OAIBasicStream_allOf::setStreamPostPolicy(const OAIAnyType &stream_post_policy) {
    this->stream_post_policy = stream_post_policy;
    this->m_stream_post_policy_isSet = true;
}

bool OAIBasicStream_allOf::is_stream_post_policy_Set() const{
    return m_stream_post_policy_isSet;
}

bool OAIBasicStream_allOf::is_stream_post_policy_Valid() const{
    return m_stream_post_policy_isValid;
}

OAIAnyType OAIBasicStream_allOf::getMessageRetentionDays() const {
    return message_retention_days;
}
void OAIBasicStream_allOf::setMessageRetentionDays(const OAIAnyType &message_retention_days) {
    this->message_retention_days = message_retention_days;
    this->m_message_retention_days_isSet = true;
}

bool OAIBasicStream_allOf::is_message_retention_days_Set() const{
    return m_message_retention_days_isSet;
}

bool OAIBasicStream_allOf::is_message_retention_days_Valid() const{
    return m_message_retention_days_isValid;
}

OAIAnyType OAIBasicStream_allOf::getHistoryPublicToSubscribers() const {
    return history_public_to_subscribers;
}
void OAIBasicStream_allOf::setHistoryPublicToSubscribers(const OAIAnyType &history_public_to_subscribers) {
    this->history_public_to_subscribers = history_public_to_subscribers;
    this->m_history_public_to_subscribers_isSet = true;
}

bool OAIBasicStream_allOf::is_history_public_to_subscribers_Set() const{
    return m_history_public_to_subscribers_isSet;
}

bool OAIBasicStream_allOf::is_history_public_to_subscribers_Valid() const{
    return m_history_public_to_subscribers_isValid;
}

OAIAnyType OAIBasicStream_allOf::getFirstMessageId() const {
    return first_message_id;
}
void OAIBasicStream_allOf::setFirstMessageId(const OAIAnyType &first_message_id) {
    this->first_message_id = first_message_id;
    this->m_first_message_id_isSet = true;
}

bool OAIBasicStream_allOf::is_first_message_id_Set() const{
    return m_first_message_id_isSet;
}

bool OAIBasicStream_allOf::is_first_message_id_Valid() const{
    return m_first_message_id_isValid;
}

OAIAnyType OAIBasicStream_allOf::getIsAnnouncementOnly() const {
    return is_announcement_only;
}
void OAIBasicStream_allOf::setIsAnnouncementOnly(const OAIAnyType &is_announcement_only) {
    this->is_announcement_only = is_announcement_only;
    this->m_is_announcement_only_isSet = true;
}

bool OAIBasicStream_allOf::is_is_announcement_only_Set() const{
    return m_is_announcement_only_isSet;
}

bool OAIBasicStream_allOf::is_is_announcement_only_Valid() const{
    return m_is_announcement_only_isValid;
}

bool OAIBasicStream_allOf::isSet() const {
...
bool OAIBasicStream_allOf::isValid() const {
