...
#ifndef OAIMessages_allOf_H
#define OAIMessages_allOf_H
...
class OAIMessages_allOf : public OAIObject {
public:
    OAIMessages_allOf();
    OAIMessages_allOf(QString json);
    ~OAIMessages_allOf() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessages_allOf)

#endif // OAIMessages_allOf_H
