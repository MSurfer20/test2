...
/*
 * OAIEmojiReactionBase_allOf_user.h
 *
...
#ifndef OAIEmojiReactionBase_allOf_user_H
#define OAIEmojiReactionBase_allOf_user_H
...
class OAIEmojiReactionBase_allOf_user : public OAIObject {
public:
    OAIEmojiReactionBase_allOf_user();
    OAIEmojiReactionBase_allOf_user(QString json);
    ~OAIEmojiReactionBase_allOf_user() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEmojiReactionBase_allOf_user)

#endif // OAIEmojiReactionBase_allOf_user_H
