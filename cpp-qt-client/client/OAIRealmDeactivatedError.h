...
/*
 * OAIRealmDeactivatedError.h
 *
 * 
 */

#ifndef OAIRealmDeactivatedError_H
#define OAIRealmDeactivatedError_H
...
class OAIRealmDeactivatedError : public OAIObject {
public:
    OAIRealmDeactivatedError();
    OAIRealmDeactivatedError(QString json);
    ~OAIRealmDeactivatedError() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRealmDeactivatedError)

#endif // OAIRealmDeactivatedError_H
