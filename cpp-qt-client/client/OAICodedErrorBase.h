...
#ifndef OAICodedErrorBase_H
#define OAICodedErrorBase_H
...
class OAICodedErrorBase : public OAIObject {
public:
    OAICodedErrorBase();
    OAICodedErrorBase(QString json);
    ~OAICodedErrorBase() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICodedErrorBase)

#endif // OAICodedErrorBase_H
