...
#ifndef OAIJsonSuccess_H
#define OAIJsonSuccess_H
...
class OAIJsonSuccess : public OAIObject {
public:
    OAIJsonSuccess();
    OAIJsonSuccess(QString json);
    ~OAIJsonSuccess() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJsonSuccess)

#endif // OAIJsonSuccess_H
