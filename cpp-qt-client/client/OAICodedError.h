...
#ifndef OAICodedError_H
#define OAICodedError_H
...
class OAICodedError : public OAIObject {
public:
    OAICodedError();
    OAICodedError(QString json);
    ~OAICodedError() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICodedError)

#endif // OAICodedError_H
