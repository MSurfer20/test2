(ns zulip-rest-api.specs.basic-stream-all-of
...
(def basic-stream-all-of-spec
  (ds/spec
    {:name ::basic-stream-all-of
     :spec basic-stream-all-of-data}))
