(ns zulip-rest-api.specs.get-messages-all-of
...
(def get-messages-all-of-spec
  (ds/spec
    {:name ::get-messages-all-of
     :spec get-messages-all-of-data}))
