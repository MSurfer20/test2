...
/**
 * BadEventQueueIdErrorAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BadEventQueueIdErrorAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BadEventQueueIdError_allOf';
     ...
     * Sets queue_id
     *
     * @param string|null $queue_id The string that identifies the invalid event queue.
     *
     * @return self
     */
