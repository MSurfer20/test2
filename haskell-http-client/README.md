## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `Zulip REST API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the Zulip REST API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | ZulipREST                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | zulip-rest                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | ZulipRESTConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | ZulipRESTRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| ZulipREST.Client    | use the "dispatch" functions to send requests       |
| ZulipREST.Core      | core funcions, config and request types             |
| ZulipREST.API       | construct api requests                              |
| ZulipREST.Model     | describes api models                                |
| ZulipREST.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| ZulipREST.ModelLens | lenses for model fields                             |
| ZulipREST.Logging   | logging functions and utils                         |
