...
-- | 
data ZulipRESTConfig = ZulipRESTConfig
...
-- | display the config
instance P.Show ZulipRESTConfig where
  show c =
    T.printf
...
-- | constructs a default ZulipRESTConfig
--
-- configHost:
--
...
-- @"zulip-rest/0.1.0.0"@
--
newConfig :: IO ZulipRESTConfig
newConfig = do
    logCxt <- initLogContext
    return $ ZulipRESTConfig
        { configHost = "https://example.zulipchat.com/api/v1"
        , configUserAgent = "zulip-rest/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => ZulipRESTConfig -> auth -> ZulipRESTConfig
addAuthMethod config@ZulipRESTConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: ZulipRESTConfig -> IO ZulipRESTConfig
...
withStderrLogging :: ZulipRESTConfig -> IO ZulipRESTConfig
...
withNoLogging :: ZulipRESTConfig -> ZulipRESTConfig
...
data ZulipRESTRequest req contentType res accept = ZulipRESTRequest
  { rMethod  :: NH.Method   -- ^ Method of ZulipRESTRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of ZulipRESTRequest
  , rParams   :: Params -- ^ params of ZulipRESTRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (ZulipRESTRequest req contentType res accept) NH.Method
rMethodL f ZulipRESTRequest{..} = (\rMethod -> ZulipRESTRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (ZulipRESTRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f ZulipRESTRequest{..} = (\rUrlPath -> ZulipRESTRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (ZulipRESTRequest req contentType res accept) Params
rParamsL f ZulipRESTRequest{..} = (\rParams -> ZulipRESTRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (ZulipRESTRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f ZulipRESTRequest{..} = (\rAuthTypes -> ZulipRESTRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => ZulipRESTRequest req contentType res accept -> param -> ZulipRESTRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: ZulipRESTRequest req contentType res accept -> param -> ZulipRESTRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: ZulipRESTRequest req contentType res accept -> param -> ZulipRESTRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** ZulipRESTRequest Utils

_mkRequest :: NH.Method -- ^ Method 
          -> [BCL.ByteString] -- ^ Endpoint
          -> ZulipRESTRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = ZulipRESTRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     ZulipRESTRequest req contentType res accept
  -> [NH.Header]
  -> ZulipRESTRequest req contentType res accept
...
removeHeader :: ZulipRESTRequest req contentType res accept -> [NH.HeaderName] -> ZulipRESTRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => ZulipRESTRequest req contentType res accept -> ZulipRESTRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of 
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => ZulipRESTRequest req contentType res accept -> ZulipRESTRequest req contentType res accept
...
addForm :: ZulipRESTRequest req contentType res accept -> WH.Form -> ZulipRESTRequest req contentType res accept
addForm req newform = 
...
_addMultiFormPart :: ZulipRESTRequest req contentType res accept -> NH.Part -> ZulipRESTRequest req contentType res accept
...
_setBodyBS :: ZulipRESTRequest req contentType res accept -> B.ByteString -> ZulipRESTRequest req contentType res accept
_setBodyBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: ZulipRESTRequest req contentType res accept -> BL.ByteString -> ZulipRESTRequest req contentType res accept
_setBodyLBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => ZulipRESTRequest req contentType res accept -> P.Proxy authMethod -> ZulipRESTRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> ZulipRESTRequest req contentType res accept
    -> IO (ZulipRESTRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> ZulipRESTConfig
  -> IO (ZulipRESTRequest req contentType res accept)
_applyAuthMethods req config@(ZulipRESTConfig {configAuthMethods = as}) =
  foldlM go req as
  where
