...
export interface DraftsApiCreateDraftsRequest {
    /**
     * A JSON-encoded list of containing new draft objects. 
     * @type Array&lt;Draft&gt;
     * @memberof DraftsApicreateDrafts
     */
    drafts?: Array<Draft>
}

export interface DraftsApiDeleteDraftRequest {
    /**
     * The ID of the draft you want to delete. 
     * @type number
     * @memberof DraftsApideleteDraft
     */
    draftId: number
}

export interface DraftsApiEditDraftRequest {
    /**
     * The ID of the draft to be edited. 
     * @type number
     * @memberof DraftsApieditDraft
     */
    draftId: number
    /**
...
export interface DraftsApiGetDraftsRequest {
}
...
export class ObjectDraftsApi {
     ...
     * @param param the request object
     */
    public createDrafts(param: DraftsApiCreateDraftsRequest, options?: Configuration): Promise<JsonSuccess> {
        return this.api.createDrafts(param.drafts,  options).toPromise();
    }
     ...
     * @param param the request object
     */
    public deleteDraft(param: DraftsApiDeleteDraftRequest, options?: Configuration): Promise<JsonSuccess> {
        return this.api.deleteDraft(param.draftId,  options).toPromise();
    }
     ...
     * @param param the request object
     */
    public editDraft(param: DraftsApiEditDraftRequest, options?: Configuration): Promise<JsonSuccess> {
        return this.api.editDraft(param.draftId, param.draft,  options).toPromise();
    }
     ...
     * @param param the request object
     */
    public getDrafts(param: DraftsApiGetDraftsRequest, options?: Configuration): Promise<JsonSuccess> {
        return this.api.getDrafts( options).toPromise();
    }
...
export interface StreamsApiDeleteTopicRequest {
    /**
     * The ID of the stream to access. 
     * @type number
     * @memberof StreamsApideleteTopic
     */
    streamId: number
    /**
...
export interface StreamsApiGetSubscribersRequest {
    /**
     * The ID of the stream to access. 
     * @type number
     * @memberof StreamsApigetSubscribers
     */
    streamId: number
}
...
export class ObjectStreamsApi {
     ...
     * @param param the request object
     */
    public deleteTopic(param: StreamsApiDeleteTopicRequest, options?: Configuration): Promise<JsonSuccess> {
        return this.api.deleteTopic(param.streamId, param.topicName,  options).toPromise();
    }
     ...
     * @param param the request object
     */
    public getSubscribers(param: StreamsApiGetSubscribersRequest, options?: Configuration): Promise<JsonSuccessBase> {
        return this.api.getSubscribers(param.streamId,  options).toPromise();
    }
...
export interface UsersApiUpdateSettingsRequest {
    /**
     * A new display name for the user. 
     * @type string
     * @memberof UsersApiupdateSettings
     */
    fullName?: string
    /**
...
export interface UsersApiUpdateStatusRequest {
    /**
...
export class ObjectUsersApi {
     ...
     * @param param the request object
     */
    public updateSettings(param: UsersApiUpdateSettingsRequest, options?: Configuration): Promise<JsonSuccessBase> {
        return this.api.updateSettings(param.fullName, param.email, param.oldPassword, param.newPassword, param.twentyFourHourTime, param.denseMode, param.starredMessageCounts, param.fluidLayoutWidth, param.highContrastMode, param.colorScheme, param.enableDraftsSynchronization, param.translateEmoticons, param.defaultLanguage, param.defaultView, param.leftSideUserlist, param.emojiset, param.demoteInactiveStreams, param.timezone, param.enableStreamDesktopNotifications, param.enableStreamEmailNotifications, param.enableStreamPushNotifications, param.enableStreamAudibleNotifications, param.notificationSound, param.enableDesktopNotifications, param.enableSounds, param.emailNotificationsBatchingPeriodSeconds, param.enableOfflineEmailNotifications, param.enableOfflinePushNotifications, param.enableOnlinePushNotifications, param.enableDigestEmails, param.enableMarketingEmails, param.enableLoginEmails, param.messageContentInEmailNotifications, param.pmContentInDesktopNotifications, param.wildcardMentionsNotify, param.desktopIconCountDisplay, param.realmNameInNotifications, param.presenceEnabled, param.enterSends,  options).toPromise();
    }
     ...
     * @param param the request object
     */
    public updateStatus(param: UsersApiUpdateStatusRequest, options?: Configuration): Promise<JsonSuccess> {
        return this.api.updateStatus(param.statusText, param.away, param.emojiName, param.emojiCode, param.reactionType,  options).toPromise();
    }
