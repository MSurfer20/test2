...
public class DraftsApi  {
    ...
    @Inject DraftsApiService service;
    ...
    throws NotFoundException {
        return service.createDrafts(drafts,securityContext);
    }
    @DELETE
    @Path("/{draft_id}")
    ...
    throws NotFoundException {
        return service.deleteDraft(draftId,securityContext);
    }
    @PATCH
    @Path("/{draft_id}")
    ...
    throws NotFoundException {
        return service.editDraft(draftId,draft,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getDrafts(securityContext);
    }
}
