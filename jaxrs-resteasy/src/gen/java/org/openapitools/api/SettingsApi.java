...
public class SettingsApi  {
    ...
    @Inject SettingsApiService service;
    ...
    throws NotFoundException {
        return service.updateDisplaySettings(twentyFourHourTime,denseMode,starredMessageCounts,fluidLayoutWidth,highContrastMode,colorScheme,translateEmoticons,defaultLanguage,defaultView,leftSideUserlist,emojiset,demoteInactiveStreams,timezone,securityContext);
    }
    @PATCH
    @Path("/notifications")
