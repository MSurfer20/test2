...
public class UserUploadsApi  {
    ...
    @Inject UserUploadsApiService service;
    ...
    throws NotFoundException {
        return service.getFileTemporaryUrl(realmIdStr,filename,securityContext);
    }
    @POST
    ...
    throws NotFoundException {
        return service.uploadFile(input,securityContext);
    }
}
