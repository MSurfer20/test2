...
public class DevFetchApiKeyApiServiceImpl implements DevFetchApiKeyApiService {
      public Response devFetchApiKey(String username,SecurityContext securityContext)
