%% basic handler
-module(openapi_server_and_organizations_handler).
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'AddCodePlayground'
    }
) ->
    {[<<"POST">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'GetCustomProfileFields'
    }
) ->
    {[<<"GET">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'GetServerSettings'
    }
) ->
    {[<<"GET">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'RemoveCodePlayground'
    }
) ->
    {[<<"DELETE">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'ReorderCustomProfileFields'
    }
) ->
    {[<<"PATCH">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'UploadCustomEmoji'
    }
) ->
    {[<<"POST">>], Req, State};
