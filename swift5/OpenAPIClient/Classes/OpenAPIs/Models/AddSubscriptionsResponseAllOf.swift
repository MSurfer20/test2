//
// AddSubscriptionsResponseAllOf.swift
//
...
public struct AddSubscriptionsResponseAllOf: Codable, Hashable {
    ...
    public init(result: AnyCodable? = nil, msg: AnyCodable? = nil, subscribed: [String: [String]]? = nil, alreadySubscribed: [String: [String]]? = nil, unauthorized: [String]? = nil) {
        self.result = result
        self.msg = msg
