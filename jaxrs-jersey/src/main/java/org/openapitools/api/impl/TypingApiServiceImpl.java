...
public class TypingApiServiceImpl extends TypingApiService {
    @Override
    public Response setTypingStatus( @NotNull String op,  @NotNull List<Integer> to, String type, String topic, SecurityContext securityContext) throws NotFoundException {
        // do some magic!
