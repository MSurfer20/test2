...
@JsonPropertyOrder({
  BotAllOf.JSON_PROPERTY_USER_ID,
  BotAllOf.JSON_PROPERTY_FULL_NAME,
  BotAllOf.JSON_PROPERTY_API_KEY,
  BotAllOf.JSON_PROPERTY_DEFAULT_SENDING_STREAM,
  BotAllOf.JSON_PROPERTY_DEFAULT_EVENTS_REGISTER_STREAM,
  BotAllOf.JSON_PROPERTY_DEFAULT_ALL_PUBLIC_STREAMS,
  BotAllOf.JSON_PROPERTY_AVATAR_URL,
  BotAllOf.JSON_PROPERTY_OWNER_ID,
  BotAllOf.JSON_PROPERTY_SERVICES,
  BotAllOf.JSON_PROPERTY_EMAIL,
  BotAllOf.JSON_PROPERTY_BOT_TYPE,
  BotAllOf.JSON_PROPERTY_IS_ACTIVE
})
