 ...
 */
@JsonPropertyOrder({
  BasicStream.JSON_PROPERTY_STREAM_ID,
  BasicStream.JSON_PROPERTY_NAME,
  BasicStream.JSON_PROPERTY_DESCRIPTION,
  BasicStream.JSON_PROPERTY_DATE_CREATED,
  BasicStream.JSON_PROPERTY_INVITE_ONLY,
  BasicStream.JSON_PROPERTY_RENDERED_DESCRIPTION,
  BasicStream.JSON_PROPERTY_IS_WEB_PUBLIC,
  BasicStream.JSON_PROPERTY_STREAM_POST_POLICY,
  BasicStream.JSON_PROPERTY_MESSAGE_RETENTION_DAYS,
  BasicStream.JSON_PROPERTY_HISTORY_PUBLIC_TO_SUBSCRIBERS,
  BasicStream.JSON_PROPERTY_FIRST_MESSAGE_ID,
  BasicStream.JSON_PROPERTY_IS_ANNOUNCEMENT_ONLY
})
