...
@JsonPropertyOrder({
  ...
  User.JSON_PROPERTY_AVATAR_VERSION,
  User.JSON_PROPERTY_FULL_NAME,
  User.JSON_PROPERTY_IS_ADMIN,
  User.JSON_PROPERTY_IS_OWNER,
  User.JSON_PROPERTY_IS_BILLING_ADMIN,
  User.JSON_PROPERTY_ROLE,
  User.JSON_PROPERTY_BOT_TYPE,
  User.JSON_PROPERTY_USER_ID,
  User.JSON_PROPERTY_BOT_OWNER_ID,
  User.JSON_PROPERTY_IS_ACTIVE,
  User.JSON_PROPERTY_IS_GUEST,
  User.JSON_PROPERTY_TIMEZONE,
  User.JSON_PROPERTY_DATE_JOINED,
  User.JSON_PROPERTY_DELIVERY_EMAIL,
  User.JSON_PROPERTY_PROFILE_DATA
})
