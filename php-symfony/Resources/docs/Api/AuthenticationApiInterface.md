...
------------- | ------------- | -------------
[**devFetchApiKey**](AuthenticationApiInterface.md#devFetchApiKey) | **POST** /dev_fetch_api_key | Fetch an API key (development only)
[**fetchApiKey**](AuthenticationApiInterface.md#fetchApiKey) | **POST** /fetch_api_key | Fetch an API key (production)
...
class AuthenticationApi implements AuthenticationApiInterface
{
    ...
    /**
     * Implementation of AuthenticationApiInterface#devFetchApiKey
     */
...
class AuthenticationApi implements AuthenticationApiInterface
{
    ...
    /**
     * Implementation of AuthenticationApiInterface#fetchApiKey
     */
