...
/**
 * Class representing the GetMessagesAllOf model.
 *
 * @package OpenAPI\Server\Model
 * @author  OpenAPI Generator team
 */
class GetMessagesAllOf 
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->flags = isset($data['flags']) ? $data['flags'] : null;
        $this->lastEditTimestamp = isset($data['lastEditTimestamp']) ? $data['lastEditTimestamp'] : null;
        $this->matchContent = isset($data['matchContent']) ? $data['matchContent'] : null;
        $this->matchSubject = isset($data['matchSubject']) ? $data['matchSubject'] : null;
    }
    ...
    /**
     * Sets lastEditTimestamp.
     *
     * @param int|null $lastEditTimestamp  The UNIX timestamp for when the message was last edited, in UTC seconds.
     *
     * @return $this
     */
    public function setLastEditTimestamp($lastEditTimestamp = null)
    {
     ...
     * Sets matchContent.
     *
     * @param string|null $matchContent  Only present if keyword search was included among the narrow parameters. HTML content of a queried message that matches the narrow, with `<span class=\"highlight\">` elements wrapping the matches for the search keywords.
     *
     * @return $this
     */
    public function setMatchContent($matchContent = null)
    {
     ...
     * Sets matchSubject.
     *
     * @param string|null $matchSubject  Only present if keyword search was included among the narrow parameters. HTML-escaped topic of a queried message that matches the narrow, with `<span class=\"highlight\">` elements wrapping the matches for the search keywords.
     *
     * @return $this
     */
    public function setMatchSubject($matchSubject = null)
    {
