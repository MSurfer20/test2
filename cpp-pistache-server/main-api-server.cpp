...
int main() {
    ...
    RealTimeEventsApiserver.init();
    ServerAndOrganizationsApiImpl ServerAndOrganizationsApiserver(router);
    ServerAndOrganizationsApiserver.init();
    StreamsApiImpl StreamsApiserver(router);
    StreamsApiserver.init();
    UsersApiImpl UsersApiserver(router);
    UsersApiserver.init();
    WebhooksApiImpl WebhooksApiserver(router);
    WebhooksApiserver.init();
