...
void BasicStream_allOf::validate() const
{
...
bool BasicStream_allOf::validate(std::stringstream& msg) const
{
    return validate(msg, "");
}

bool BasicStream_allOf::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "BasicStream_allOf" : pathPrefix;

                                                    
    return success;
}

bool BasicStream_allOf::operator==(const BasicStream_allOf& rhs) const
{
    return
...
void to_json(nlohmann::json& j, const BasicStream_allOf& o)
{
    j = nlohmann::json();
    if(o.streamIdIsSet())
...
void from_json(const nlohmann::json& j, BasicStream_allOf& o)
{
...
AnyType BasicStream_allOf::getStreamId() const
{
    return m_Stream_id;
}
void BasicStream_allOf::setStreamId(AnyType const& value)
{
    m_Stream_id = value;
...
AnyType BasicStream_allOf::getName() const
{
    return m_Name;
}
void BasicStream_allOf::setName(AnyType const& value)
{
    m_Name = value;
    m_NameIsSet = true;
}
...
AnyType BasicStream_allOf::getDescription() const
{
    return m_Description;
}
void BasicStream_allOf::setDescription(AnyType const& value)
{
    m_Description = value;
...
AnyType BasicStream_allOf::getDateCreated() const
{
    return m_Date_created;
}
void BasicStream_allOf::setDateCreated(AnyType const& value)
{
...
AnyType BasicStream_allOf::getInviteOnly() const
{
    return m_Invite_only;
}
void BasicStream_allOf::setInviteOnly(AnyType const& value)
{
    m_Invite_only = value;
...
AnyType BasicStream_allOf::getRenderedDescription() const
{
    return m_Rendered_description;
}
void BasicStream_allOf::setRenderedDescription(AnyType const& value)
{
...
AnyType BasicStream_allOf::getIsWebPublic() const
{
    return m_Is_web_public;
}
void BasicStream_allOf::setIsWebPublic(AnyType const& value)
{
...
AnyType BasicStream_allOf::getStreamPostPolicy() const
{
    return m_Stream_post_policy;
}
void BasicStream_allOf::setStreamPostPolicy(AnyType const& value)
{
...
AnyType BasicStream_allOf::getMessageRetentionDays() const
{
    return m_Message_retention_days;
}
void BasicStream_allOf::setMessageRetentionDays(AnyType const& value)
{
...
AnyType BasicStream_allOf::getHistoryPublicToSubscribers() const
{
    return m_History_public_to_subscribers;
}
void BasicStream_allOf::setHistoryPublicToSubscribers(AnyType const& value)
{
...
AnyType BasicStream_allOf::getFirstMessageId() const
{
    return m_First_message_id;
}
void BasicStream_allOf::setFirstMessageId(AnyType const& value)
{
...
AnyType BasicStream_allOf::getIsAnnouncementOnly() const
{
    return m_Is_announcement_only;
}
void BasicStream_allOf::setIsAnnouncementOnly(AnyType const& value)
{
