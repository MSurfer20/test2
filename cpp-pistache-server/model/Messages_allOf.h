...
public:
    Messages_allOf();
    virtual ~Messages_allOf() = default;
    ...
    bool operator==(const Messages_allOf& rhs) const;
    bool operator!=(const Messages_allOf& rhs) const;
    ...
    friend void to_json(nlohmann::json& j, const Messages_allOf& o);
    friend void from_json(const nlohmann::json& j, Messages_allOf& o);
protected:
