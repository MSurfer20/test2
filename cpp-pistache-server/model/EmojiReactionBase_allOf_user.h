...
public:
    ...
    virtual ~EmojiReactionBase_allOf_user() = default;
    ...
    bool operator==(const EmojiReactionBase_allOf_user& rhs) const;
    bool operator!=(const EmojiReactionBase_allOf_user& rhs) const;
    ...
    friend void to_json(nlohmann::json& j, const EmojiReactionBase_allOf_user& o);
    friend void from_json(const nlohmann::json& j, EmojiReactionBase_allOf_user& o);
protected:
    int32_t m_Id;
    bool m_IdIsSet;
    std::string m_Email;
