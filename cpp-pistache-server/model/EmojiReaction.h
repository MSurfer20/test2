...
public:
    ...
    bool operator==(const EmojiReaction& rhs) const;
    bool operator!=(const EmojiReaction& rhs) const;
    ...
    friend void to_json(nlohmann::json& j, const EmojiReaction& o);
    friend void from_json(const nlohmann::json& j, EmojiReaction& o);
protected:
