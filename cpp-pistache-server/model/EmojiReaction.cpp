...
void EmojiReaction::validate() const
{
...
bool EmojiReaction::validate(std::stringstream& msg) const
{
    return validate(msg, "");
}

bool EmojiReaction::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "EmojiReaction" : pathPrefix;

                        
    return success;
}

bool EmojiReaction::operator==(const EmojiReaction& rhs) const
{
    return
...
void to_json(nlohmann::json& j, const EmojiReaction& o)
{
    j = nlohmann::json();
    if(o.emojiCodeIsSet())
...
void from_json(const nlohmann::json& j, EmojiReaction& o)
{
...
AnyType EmojiReaction::getEmojiCode() const
{
    return m_Emoji_code;
}
void EmojiReaction::setEmojiCode(AnyType const& value)
{
    m_Emoji_code = value;
...
AnyType EmojiReaction::getEmojiName() const
{
    return m_Emoji_name;
}
void EmojiReaction::setEmojiName(AnyType const& value)
{
    m_Emoji_name = value;
...
AnyType EmojiReaction::getReactionType() const
{
    return m_Reaction_type;
}
void EmojiReaction::setReactionType(AnyType const& value)
{
...
AnyType EmojiReaction::getUserId() const
{
    return m_User_id;
}
void EmojiReaction::setUserId(AnyType const& value)
{
    m_User_id = value;
    m_User_idIsSet = true;
}
...
AnyType EmojiReaction::getUser() const
{
    return m_User;
}
void EmojiReaction::setUser(AnyType const& value)
{
    m_User = value;
    m_UserIsSet = true;
}
