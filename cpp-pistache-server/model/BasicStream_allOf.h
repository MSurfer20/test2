...
public:
    BasicStream_allOf();
    virtual ~BasicStream_allOf() = default;
    ...
    bool operator==(const BasicStream_allOf& rhs) const;
    bool operator!=(const BasicStream_allOf& rhs) const;
    ...
    friend void to_json(nlohmann::json& j, const BasicStream_allOf& o);
    friend void from_json(const nlohmann::json& j, BasicStream_allOf& o);
protected:
    AnyType m_Stream_id;
