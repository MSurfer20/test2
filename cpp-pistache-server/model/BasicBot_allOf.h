...
public:
    BasicBot_allOf();
    virtual ~BasicBot_allOf() = default;
    ...
    bool operator==(const BasicBot_allOf& rhs) const;
    bool operator!=(const BasicBot_allOf& rhs) const;
    ...
    friend void to_json(nlohmann::json& j, const BasicBot_allOf& o);
    friend void from_json(const nlohmann::json& j, BasicBot_allOf& o);
protected:
    AnyType m_User_id;
    bool m_User_idIsSet;
    AnyType m_Full_name;
