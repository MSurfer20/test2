...
public:
    ...
    bool operator==(const GetMessages& rhs) const;
    bool operator!=(const GetMessages& rhs) const;
    ...
    friend void to_json(nlohmann::json& j, const GetMessages& o);
    friend void from_json(const nlohmann::json& j, GetMessages& o);
protected:
