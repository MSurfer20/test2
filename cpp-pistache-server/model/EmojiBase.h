...
public:
    ...
    bool operator==(const EmojiBase& rhs) const;
    bool operator!=(const EmojiBase& rhs) const;
    ...
    friend void to_json(nlohmann::json& j, const EmojiBase& o);
    friend void from_json(const nlohmann::json& j, EmojiBase& o);
protected:
