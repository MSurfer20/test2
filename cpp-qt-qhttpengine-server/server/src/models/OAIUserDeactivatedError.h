...
/*
 * OAIUserDeactivatedError.h
 *
 * 
 */

#ifndef OAIUserDeactivatedError_H
#define OAIUserDeactivatedError_H
...
class OAIUserDeactivatedError : public OAIObject {
public:
    OAIUserDeactivatedError();
    OAIUserDeactivatedError(QString json);
    ~OAIUserDeactivatedError() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserDeactivatedError)

#endif // OAIUserDeactivatedError_H
