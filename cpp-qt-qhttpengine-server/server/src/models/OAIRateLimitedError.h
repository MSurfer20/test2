...
/*
 * OAIRateLimitedError.h
 *
 * 
 */

#ifndef OAIRateLimitedError_H
#define OAIRateLimitedError_H
...
class OAIRateLimitedError : public OAIObject {
public:
    OAIRateLimitedError();
    OAIRateLimitedError(QString json);
    ~OAIRateLimitedError() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRateLimitedError)

#endif // OAIRateLimitedError_H
