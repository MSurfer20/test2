...
#ifndef OAIEmojiReaction_H
#define OAIEmojiReaction_H
...
class OAIEmojiReaction : public OAIObject {
public:
    OAIEmojiReaction();
    OAIEmojiReaction(QString json);
    ~OAIEmojiReaction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEmojiReaction)

#endif // OAIEmojiReaction_H
