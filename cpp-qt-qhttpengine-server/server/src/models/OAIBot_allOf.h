...
#ifndef OAIBot_allOf_H
#define OAIBot_allOf_H
...
class OAIBot_allOf : public OAIObject {
public:
    OAIBot_allOf();
    OAIBot_allOf(QString json);
    ~OAIBot_allOf() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBot_allOf)

#endif // OAIBot_allOf_H
