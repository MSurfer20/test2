...
#ifndef OAIJsonError_H
#define OAIJsonError_H
...
class OAIJsonError : public OAIObject {
public:
    OAIJsonError();
    OAIJsonError(QString json);
    ~OAIJsonError() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJsonError)

#endif // OAIJsonError_H
