...
/*
 * OAICodedError_allOf.h
 *
 * 
 */

#ifndef OAICodedError_allOf_H
#define OAICodedError_allOf_H
...
class OAICodedError_allOf : public OAIObject {
public:
    OAICodedError_allOf();
    OAICodedError_allOf(QString json);
    ~OAICodedError_allOf() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICodedError_allOf)

#endif // OAICodedError_allOf_H
