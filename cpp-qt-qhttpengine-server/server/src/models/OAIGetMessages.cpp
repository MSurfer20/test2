...
OAIGetMessages::OAIGetMessages(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetMessages::OAIGetMessages() {
    this->initializeModel();
}

OAIGetMessages::~OAIGetMessages() {}

void OAIGetMessages::initializeModel() {
...
void OAIGetMessages::fromJson(QString jsonString) {
...
void OAIGetMessages::fromJsonObject(QJsonObject json) {
...
QString OAIGetMessages::asJson() const {
...
QJsonObject OAIGetMessages::asJsonObject() const {
    QJsonObject obj;
...
OAIAnyType OAIGetMessages::getAvatarUrl() const {
    return avatar_url;
}
void OAIGetMessages::setAvatarUrl(const OAIAnyType &avatar_url) {
    this->avatar_url = avatar_url;
    this->m_avatar_url_isSet = true;
}

bool OAIGetMessages::is_avatar_url_Set() const{
    return m_avatar_url_isSet;
}

bool OAIGetMessages::is_avatar_url_Valid() const{
    return m_avatar_url_isValid;
}

OAIAnyType OAIGetMessages::getClient() const {
    return client;
}
void OAIGetMessages::setClient(const OAIAnyType &client) {
    this->client = client;
    this->m_client_isSet = true;
}

bool OAIGetMessages::is_client_Set() const{
    return m_client_isSet;
}

bool OAIGetMessages::is_client_Valid() const{
    return m_client_isValid;
}

OAIAnyType OAIGetMessages::getContent() const {
    return content;
}
void OAIGetMessages::setContent(const OAIAnyType &content) {
    this->content = content;
    this->m_content_isSet = true;
}

bool OAIGetMessages::is_content_Set() const{
    return m_content_isSet;
}

bool OAIGetMessages::is_content_Valid() const{
    return m_content_isValid;
}

OAIAnyType OAIGetMessages::getContentType() const {
    return content_type;
}
void OAIGetMessages::setContentType(const OAIAnyType &content_type) {
    this->content_type = content_type;
    this->m_content_type_isSet = true;
}

bool OAIGetMessages::is_content_type_Set() const{
    return m_content_type_isSet;
}

bool OAIGetMessages::is_content_type_Valid() const{
    return m_content_type_isValid;
}

OAIAnyType OAIGetMessages::getDisplayRecipient() const {
    return display_recipient;
}
void OAIGetMessages::setDisplayRecipient(const OAIAnyType &display_recipient) {
    this->display_recipient = display_recipient;
    this->m_display_recipient_isSet = true;
}

bool OAIGetMessages::is_display_recipient_Set() const{
    return m_display_recipient_isSet;
}

bool OAIGetMessages::is_display_recipient_Valid() const{
    return m_display_recipient_isValid;
}

OAIAnyType OAIGetMessages::getId() const {
    return id;
}
void OAIGetMessages::setId(const OAIAnyType &id) {
    this->id = id;
    this->m_id_isSet = true;
}

bool OAIGetMessages::is_id_Set() const{
    return m_id_isSet;
}

bool OAIGetMessages::is_id_Valid() const{
    return m_id_isValid;
}

OAIAnyType OAIGetMessages::getIsMeMessage() const {
    return is_me_message;
}
void OAIGetMessages::setIsMeMessage(const OAIAnyType &is_me_message) {
    this->is_me_message = is_me_message;
    this->m_is_me_message_isSet = true;
}

bool OAIGetMessages::is_is_me_message_Set() const{
    return m_is_me_message_isSet;
}

bool OAIGetMessages::is_is_me_message_Valid() const{
    return m_is_me_message_isValid;
}

OAIAnyType OAIGetMessages::getReactions() const {
    return reactions;
}
void OAIGetMessages::setReactions(const OAIAnyType &reactions) {
    this->reactions = reactions;
    this->m_reactions_isSet = true;
}

bool OAIGetMessages::is_reactions_Set() const{
    return m_reactions_isSet;
}

bool OAIGetMessages::is_reactions_Valid() const{
    return m_reactions_isValid;
}

OAIAnyType OAIGetMessages::getRecipientId() const {
    return recipient_id;
}
void OAIGetMessages::setRecipientId(const OAIAnyType &recipient_id) {
    this->recipient_id = recipient_id;
    this->m_recipient_id_isSet = true;
}

bool OAIGetMessages::is_recipient_id_Set() const{
    return m_recipient_id_isSet;
}

bool OAIGetMessages::is_recipient_id_Valid() const{
    return m_recipient_id_isValid;
}

OAIAnyType OAIGetMessages::getSenderEmail() const {
    return sender_email;
}
void OAIGetMessages::setSenderEmail(const OAIAnyType &sender_email) {
    this->sender_email = sender_email;
    this->m_sender_email_isSet = true;
}

bool OAIGetMessages::is_sender_email_Set() const{
    return m_sender_email_isSet;
}

bool OAIGetMessages::is_sender_email_Valid() const{
    return m_sender_email_isValid;
}

OAIAnyType OAIGetMessages::getSenderFullName() const {
    return sender_full_name;
}
void OAIGetMessages::setSenderFullName(const OAIAnyType &sender_full_name) {
    this->sender_full_name = sender_full_name;
    this->m_sender_full_name_isSet = true;
}

bool OAIGetMessages::is_sender_full_name_Set() const{
    return m_sender_full_name_isSet;
}

bool OAIGetMessages::is_sender_full_name_Valid() const{
    return m_sender_full_name_isValid;
}

OAIAnyType OAIGetMessages::getSenderId() const {
    return sender_id;
}
void OAIGetMessages::setSenderId(const OAIAnyType &sender_id) {
    this->sender_id = sender_id;
    this->m_sender_id_isSet = true;
}

bool OAIGetMessages::is_sender_id_Set() const{
    return m_sender_id_isSet;
}

bool OAIGetMessages::is_sender_id_Valid() const{
    return m_sender_id_isValid;
}

OAIAnyType OAIGetMessages::getSenderRealmStr() const {
    return sender_realm_str;
}
void OAIGetMessages::setSenderRealmStr(const OAIAnyType &sender_realm_str) {
    this->sender_realm_str = sender_realm_str;
    this->m_sender_realm_str_isSet = true;
}

bool OAIGetMessages::is_sender_realm_str_Set() const{
    return m_sender_realm_str_isSet;
}

bool OAIGetMessages::is_sender_realm_str_Valid() const{
    return m_sender_realm_str_isValid;
}

OAIAnyType OAIGetMessages::getStreamId() const {
    return stream_id;
}
void OAIGetMessages::setStreamId(const OAIAnyType &stream_id) {
    this->stream_id = stream_id;
    this->m_stream_id_isSet = true;
}

bool OAIGetMessages::is_stream_id_Set() const{
    return m_stream_id_isSet;
}

bool OAIGetMessages::is_stream_id_Valid() const{
    return m_stream_id_isValid;
}

OAIAnyType OAIGetMessages::getSubject() const {
    return subject;
}
void OAIGetMessages::setSubject(const OAIAnyType &subject) {
    this->subject = subject;
    this->m_subject_isSet = true;
}

bool OAIGetMessages::is_subject_Set() const{
    return m_subject_isSet;
}

bool OAIGetMessages::is_subject_Valid() const{
    return m_subject_isValid;
}

OAIAnyType OAIGetMessages::getTopicLinks() const {
    return topic_links;
}
void OAIGetMessages::setTopicLinks(const OAIAnyType &topic_links) {
    this->topic_links = topic_links;
    this->m_topic_links_isSet = true;
}

bool OAIGetMessages::is_topic_links_Set() const{
    return m_topic_links_isSet;
}

bool OAIGetMessages::is_topic_links_Valid() const{
    return m_topic_links_isValid;
}

OAIAnyType OAIGetMessages::getSubmessages() const {
    return submessages;
}
void OAIGetMessages::setSubmessages(const OAIAnyType &submessages) {
    this->submessages = submessages;
    this->m_submessages_isSet = true;
}

bool OAIGetMessages::is_submessages_Set() const{
    return m_submessages_isSet;
}

bool OAIGetMessages::is_submessages_Valid() const{
    return m_submessages_isValid;
}

OAIAnyType OAIGetMessages::getTimestamp() const {
    return timestamp;
}
void OAIGetMessages::setTimestamp(const OAIAnyType &timestamp) {
    this->timestamp = timestamp;
    this->m_timestamp_isSet = true;
}

bool OAIGetMessages::is_timestamp_Set() const{
    return m_timestamp_isSet;
}

bool OAIGetMessages::is_timestamp_Valid() const{
    return m_timestamp_isValid;
}

OAIAnyType OAIGetMessages::getType() const {
    return type;
}
void OAIGetMessages::setType(const OAIAnyType &type) {
    this->type = type;
    this->m_type_isSet = true;
}

bool OAIGetMessages::is_type_Set() const{
    return m_type_isSet;
}

bool OAIGetMessages::is_type_Valid() const{
    return m_type_isValid;
}

QList<QString> OAIGetMessages::getFlags() const {
    return flags;
}
void OAIGetMessages::setFlags(const QList<QString> &flags) {
    this->flags = flags;
    this->m_flags_isSet = true;
}

bool OAIGetMessages::is_flags_Set() const{
    return m_flags_isSet;
}

bool OAIGetMessages::is_flags_Valid() const{
    return m_flags_isValid;
}

qint32 OAIGetMessages::getLastEditTimestamp() const {
    return last_edit_timestamp;
}
void OAIGetMessages::setLastEditTimestamp(const qint32 &last_edit_timestamp) {
    this->last_edit_timestamp = last_edit_timestamp;
    this->m_last_edit_timestamp_isSet = true;
}

bool OAIGetMessages::is_last_edit_timestamp_Set() const{
    return m_last_edit_timestamp_isSet;
}

bool OAIGetMessages::is_last_edit_timestamp_Valid() const{
    return m_last_edit_timestamp_isValid;
}

QString OAIGetMessages::getMatchContent() const {
    return match_content;
}
void OAIGetMessages::setMatchContent(const QString &match_content) {
    this->match_content = match_content;
    this->m_match_content_isSet = true;
}

bool OAIGetMessages::is_match_content_Set() const{
    return m_match_content_isSet;
}

bool OAIGetMessages::is_match_content_Valid() const{
    return m_match_content_isValid;
}

QString OAIGetMessages::getMatchSubject() const {
    return match_subject;
}
void OAIGetMessages::setMatchSubject(const QString &match_subject) {
    this->match_subject = match_subject;
    this->m_match_subject_isSet = true;
}

bool OAIGetMessages::is_match_subject_Set() const{
    return m_match_subject_isSet;
}

bool OAIGetMessages::is_match_subject_Valid() const{
    return m_match_subject_isValid;
}

bool OAIGetMessages::isSet() const {
...
bool OAIGetMessages::isValid() const {
