...
#ifndef OAIBasicBot_allOf_H
#define OAIBasicBot_allOf_H
...
class OAIBasicBot_allOf : public OAIObject {
public:
    OAIBasicBot_allOf();
    OAIBasicBot_allOf(QString json);
    ~OAIBasicBot_allOf() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBasicBot_allOf)

#endif // OAIBasicBot_allOf_H
