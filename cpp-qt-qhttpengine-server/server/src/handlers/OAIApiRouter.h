...
public:
    ...
    void setOAIStreamsApiHandler(QSharedPointer<OAIStreamsApiHandler> handler);
    void setOAIUsersApiHandler(QSharedPointer<OAIUsersApiHandler> handler);
    void setOAIWebhooksApiHandler(QSharedPointer<OAIWebhooksApiHandler> handler);
private:
    ...
    QSharedPointer<OAIStreamsApiHandler> mOAIStreamsApiHandler;
    QSharedPointer<OAIUsersApiHandler> mOAIUsersApiHandler;
    QSharedPointer<OAIWebhooksApiHandler> mOAIWebhooksApiHandler;
protected:
