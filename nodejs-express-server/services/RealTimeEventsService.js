...
* returns JsonSuccess
* */
const deleteQueue = ({ queueUnderscoreid }) => new Promise(
...
* */
const getEvents = ({ queueUnderscoreid, lastUnderscoreeventUnderscoreid, dontUnderscoreblock }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        queueUnderscoreid,
...
* returns JsonSuccessBase
* */
const registerQueue = ({ applyUnderscoremarkdown, clientUnderscoregravatar, slimUnderscorepresence, eventUnderscoretypes, allUnderscorepublicUnderscorestreams, includeUnderscoresubscribers, clientUnderscorecapabilities, fetchUnderscoreeventUnderscoretypes, narrow }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
...
* no response value expected for this operation
* */
const restErrorHandling = () => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
      }));
