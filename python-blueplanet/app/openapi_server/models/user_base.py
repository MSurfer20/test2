...
class UserBase(Model):
    ...
    def __init__(self, email: str=None, is_bot: bool=None, avatar_url: str=None, avatar_version: int=None, full_name: str=None, is_admin: bool=None, is_owner: bool=None, is_billing_admin: bool=None, role: int=None, bot_type: int=None, user_id: int=None, bot_owner_id: int=None, is_active: bool=None, is_guest: bool=None, timezone: str=None, date_joined: str=None, delivery_email: str=None, profile_data: Dict[str, object]=None):  # noqa: E501
    ...
    def avatar_version(self, avatar_version: int):
    ...
    def is_billing_admin(self, is_billing_admin: bool):
    ...
    @bot_owner_id.setter
    def bot_owner_id(self, bot_owner_id: int):
    ...
    @date_joined.setter
    def date_joined(self, date_joined: str):
    ...
    def delivery_email(self, delivery_email: str):
    ...
    @profile_data.setter
    def profile_data(self, profile_data: Dict[str, object]):
