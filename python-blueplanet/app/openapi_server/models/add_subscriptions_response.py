...
from app.openapi_server.models.add_subscriptions_response_all_of import AddSubscriptionsResponseAllOf  # noqa: F401,E501
...
class AddSubscriptionsResponse(Model):
    ...
    def __init__(self, result: object=None, msg: object=None, subscribed: Dict[str, List[str]]=None, already_subscribed: Dict[str, List[str]]=None, unauthorized: List[str]=None):  # noqa: E501
        """AddSubscriptionsResponse - a model defined in Swagger
