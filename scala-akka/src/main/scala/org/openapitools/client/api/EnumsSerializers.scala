...
object EnumsSerializers {
  ...
  def all: Seq[Serializer[_]] = Seq[Serializer[_]]() :+
    ...
    new EnumNameSerializer(JsonSuccessBaseAllOfEnums.Result) :+
    new EnumNameSerializer(PresenceEnums.Status) :+
    new EnumNameSerializer(SubscriptionsEnums.Role) :+
    new EnumNameSerializer(UserBaseEnums.Role)
