...
class ServerAndOrganizationsApi(baseUrl: String) {
   ...
   */
  def addCodePlayground(name: String, pygmentsLanguage: String, urlPrefix: String): ApiRequest[JsonSuccessBase] =
    ApiRequest[JsonSuccessBase](ApiMethods.POST, baseUrl, "/realm/playgrounds", "application/json")
      .withQueryParam("name", name)
      .withQueryParam("pygments_language", pygmentsLanguage)
      .withQueryParam("url_prefix", urlPrefix)
   ...
   */
  def addLinkifier(pattern: String, urlFormatString: String): ApiRequest[JsonSuccessBase] =
    ApiRequest[JsonSuccessBase](ApiMethods.POST, baseUrl, "/realm/filters", "application/json")
      .withQueryParam("pattern", pattern)
      .withQueryParam("url_format_string", urlFormatString)
      .withSuccessResponse[JsonSuccessBase](200)
   ...
   */
  def createCustomProfileField(fieldType: Int, name: Option[String] = None, hint: Option[String] = None, fieldData: Option[Any] = None): ApiRequest[JsonSuccessBase] =
    ApiRequest[JsonSuccessBase](ApiMethods.POST, baseUrl, "/realm/profile_fields", "application/json")
      .withQueryParam("name", name)
      .withQueryParam("hint", hint)
      .withQueryParam("field_type", fieldType)
      .withQueryParam("field_data", fieldData)
      .withSuccessResponse[JsonSuccessBase](200)
   ...
   *   code 200 : JsonSuccessBase (Success.)
   */
  def getCustomEmoji(): ApiRequest[JsonSuccessBase] =
    ApiRequest[JsonSuccessBase](ApiMethods.GET, baseUrl, "/realm/emoji", "application/json")
      .withSuccessResponse[JsonSuccessBase](200)
   ...
   *   code 200 : JsonSuccessBase (Success.)
   */
  def getCustomProfileFields(): ApiRequest[JsonSuccessBase] =
    ApiRequest[JsonSuccessBase](ApiMethods.GET, baseUrl, "/realm/profile_fields", "application/json")
      .withSuccessResponse[JsonSuccessBase](200)
   ...
   *   code 200 : JsonSuccessBase (Success.)
   */
  def getLinkifiers(): ApiRequest[JsonSuccessBase] =
    ApiRequest[JsonSuccessBase](ApiMethods.GET, baseUrl, "/realm/linkifiers", "application/json")
      .withSuccessResponse[JsonSuccessBase](200)
   ...
   *   code 200 : JsonSuccessBase (Success.)
   */
  def getServerSettings(): ApiRequest[JsonSuccessBase] =
    ApiRequest[JsonSuccessBase](ApiMethods.GET, baseUrl, "/server_settings", "application/json")
      .withSuccessResponse[JsonSuccessBase](200)
   ...
   */
  def removeCodePlayground(playgroundId: Int): ApiRequest[JsonSuccess] =
    ApiRequest[JsonSuccess](ApiMethods.DELETE, baseUrl, "/realm/playgrounds/{playground_id}", "application/json")
      .withPathParam("playground_id", playgroundId)
   ...
   */
  def removeLinkifier(filterId: Int): ApiRequest[JsonSuccess] =
    ApiRequest[JsonSuccess](ApiMethods.DELETE, baseUrl, "/realm/filters/{filter_id}", "application/json")
      .withPathParam("filter_id", filterId)
      .withSuccessResponse[JsonSuccess](200)
   ...
   */
  def reorderCustomProfileFields(order: Seq[Int]): ApiRequest[JsonSuccess] =
    ApiRequest[JsonSuccess](ApiMethods.PATCH, baseUrl, "/realm/profile_fields", "application/json")
      .withQueryParam("order", ArrayValues(order, MULTI))
      .withSuccessResponse[JsonSuccess](200)
   ...
   * @param urlFormatString The URL used for the link. If you used named groups for the `pattern`, you can insert their content here with `%(name_of_the_capturing_group)s`. 
   */
  def updateLinkifier(filterId: Int, pattern: String, urlFormatString: String): ApiRequest[JsonSuccess] =
    ApiRequest[JsonSuccess](ApiMethods.PATCH, baseUrl, "/realm/filters/{filter_id}", "application/json")
      .withQueryParam("pattern", pattern)
      .withQueryParam("url_format_string", urlFormatString)
      .withPathParam("filter_id", filterId)
      .withSuccessResponse[JsonSuccess](200)
   ...
   * @param filename 
   */
  def uploadCustomEmoji(emojiName: String, filename: Option[File] = None): ApiRequest[JsonSuccess] =
    ApiRequest[JsonSuccess](ApiMethods.POST, baseUrl, "/realm/emoji/{emoji_name}", "multipart/form-data")
      .withFormParam("filename", filename)
      .withPathParam("emoji_name", emojiName)
      .withSuccessResponse[JsonSuccess](200)
