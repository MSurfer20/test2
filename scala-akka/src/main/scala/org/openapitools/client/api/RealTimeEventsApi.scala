...
class RealTimeEventsApi(baseUrl: String) {
   ...
   */
  def deleteQueue(queueId: String): ApiRequest[JsonSuccess] =
    ApiRequest[JsonSuccess](ApiMethods.DELETE, baseUrl, "/events", "application/json")
      .withQueryParam("queue_id", queueId)
      .withSuccessResponse[JsonSuccess](200)
      .withErrorResponse[BadEventQueueIdError](400)
   ...
   */
  def getEvents(queueId: String, lastEventId: Option[Int] = None, dontBlock: Option[Boolean] = None): ApiRequest[JsonSuccessBase] =
    ApiRequest[JsonSuccessBase](ApiMethods.GET, baseUrl, "/events", "application/json")
      .withQueryParam("queue_id", queueId)
      .withQueryParam("last_event_id", lastEventId)
      .withQueryParam("dont_block", dontBlock)
   ...
   */
  def realTimePost(eventTypes: Seq[String], narrow: Seq[Seq[String]], allPublicStreams: Option[Boolean] = None): ApiRequest[Unit] =
    ApiRequest[Unit](ApiMethods.POST, baseUrl, "/real-time", "application/json")
      .withQueryParam("event_types", ArrayValues(eventTypes, MULTI))
      .withQueryParam("narrow", ArrayValues(narrow, MULTI))
      .withQueryParam("all_public_streams", allPublicStreams)
   ...
   * @param narrow A JSON-encoded array of arrays of length 2 indicating the narrow for which you'd like to receive events for. For instance, to receive events for the stream `Denmark`, you would specify `narrow=[['stream', 'Denmark']]`.  Another example is `narrow=[['is', 'private']]` for private messages. Default is `[]`. 
   */
  def registerQueue(applyMarkdown: Option[Boolean] = None, clientGravatar: Option[Boolean] = None, slimPresence: Option[Boolean] = None, eventTypes: Seq[String], allPublicStreams: Option[Boolean] = None, includeSubscribers: Option[Boolean] = None, clientCapabilities: Option[Any] = None, fetchEventTypes: Seq[String], narrow: Seq[Seq[String]]): ApiRequest[JsonSuccessBase] =
    ApiRequest[JsonSuccessBase](ApiMethods.POST, baseUrl, "/register", "application/json")
      .withQueryParam("apply_markdown", applyMarkdown)
      .withQueryParam("client_gravatar", clientGravatar)
      .withQueryParam("slim_presence", slimPresence)
      .withQueryParam("event_types", ArrayValues(eventTypes, MULTI))
      .withQueryParam("all_public_streams", allPublicStreams)
      .withQueryParam("include_subscribers", includeSubscribers)
      .withQueryParam("client_capabilities", clientCapabilities)
      .withQueryParam("fetch_event_types", ArrayValues(fetchEventTypes, MULTI))
      .withQueryParam("narrow", ArrayValues(narrow, MULTI))
      .withSuccessResponse[JsonSuccessBase](200)
   ...
   */
  def restErrorHandling(): ApiRequest[Unit] =
    ApiRequest[Unit](ApiMethods.POST, baseUrl, "/rest-error-handling", "application/json")
      .withErrorResponse[OneOfInvalidApiKeyErrorMissingArgumentErrorUserNotAuthorizedError](400)
      .withErrorResponse[OneOfUserDeactivatedErrorRealmDeactivatedError](401)
      .withErrorResponse[OneOfRateLimitedError](429)
