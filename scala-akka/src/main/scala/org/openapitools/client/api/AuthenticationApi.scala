...
class AuthenticationApi(baseUrl: String) {
   ...
   */
  def devFetchApiKey(username: String): ApiRequest[ApiKeyResponse] =
    ApiRequest[ApiKeyResponse](ApiMethods.POST, baseUrl, "/dev_fetch_api_key", "application/json")
      .withQueryParam("username", username)
      .withSuccessResponse[ApiKeyResponse](200)
   ...
   */
  def fetchApiKey(username: String, password: String): ApiRequest[ApiKeyResponse] =
    ApiRequest[ApiKeyResponse](ApiMethods.POST, baseUrl, "/fetch_api_key", "application/json")
      .withQueryParam("username", username)
