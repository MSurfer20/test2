...
object JsonErrorBase {
  ...
  implicit val JsonErrorBaseCodecJson: CodecJson[JsonErrorBase] = CodecJson.derive[JsonErrorBase]
  implicit val JsonErrorBaseDecoder: EntityDecoder[JsonErrorBase] = jsonOf[JsonErrorBase]
  implicit val JsonErrorBaseEncoder: EntityEncoder[JsonErrorBase] = jsonEncoderOf[JsonErrorBase]
}
