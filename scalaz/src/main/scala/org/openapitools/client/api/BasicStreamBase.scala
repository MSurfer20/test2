...
object BasicStreamBase {
  ...
  implicit val BasicStreamBaseCodecJson: CodecJson[BasicStreamBase] = CodecJson.derive[BasicStreamBase]
  implicit val BasicStreamBaseDecoder: EntityDecoder[BasicStreamBase] = jsonOf[BasicStreamBase]
  implicit val BasicStreamBaseEncoder: EntityEncoder[BasicStreamBase] = jsonEncoderOf[BasicStreamBase]
}
