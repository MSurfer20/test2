...
import org.openapitools.client.api.OneOfobjectobjectobjectobjectobjectobject
...
object UsersApi {
  ...
  def updateSettings(host: String, fullName: String, email: String, oldPassword: String, newPassword: String, twentyFourHourTime: Boolean, denseMode: Boolean, starredMessageCounts: Boolean, fluidLayoutWidth: Boolean, highContrastMode: Boolean, colorScheme: Integer, enableDraftsSynchronization: Boolean, translateEmoticons: Boolean, defaultLanguage: String, defaultView: String, leftSideUserlist: Boolean, emojiset: String, demoteInactiveStreams: Integer, timezone: String, enableStreamDesktopNotifications: Boolean, enableStreamEmailNotifications: Boolean, enableStreamPushNotifications: Boolean, enableStreamAudibleNotifications: Boolean, notificationSound: String, enableDesktopNotifications: Boolean, enableSounds: Boolean, emailNotificationsBatchingPeriodSeconds: Integer, enableOfflineEmailNotifications: Boolean, enableOfflinePushNotifications: Boolean, enableOnlinePushNotifications: Boolean, enableDigestEmails: Boolean, enableMarketingEmails: Boolean, enableLoginEmails: Boolean, messageContentInEmailNotifications: Boolean, pmContentInDesktopNotifications: Boolean, wildcardMentionsNotify: Boolean, desktopIconCountDisplay: Integer, realmNameInNotifications: Boolean, presenceEnabled: Boolean, enterSends: Boolean)(implicit fullNameQuery: QueryParam[String], emailQuery: QueryParam[String], oldPasswordQuery: QueryParam[String], newPasswordQuery: QueryParam[String], twentyFourHourTimeQuery: QueryParam[Boolean], denseModeQuery: QueryParam[Boolean], starredMessageCountsQuery: QueryParam[Boolean], fluidLayoutWidthQuery: QueryParam[Boolean], highContrastModeQuery: QueryParam[Boolean], colorSchemeQuery: QueryParam[Integer], enableDraftsSynchronizationQuery: QueryParam[Boolean], translateEmoticonsQuery: QueryParam[Boolean], defaultLanguageQuery: QueryParam[String], defaultViewQuery: QueryParam[String], leftSideUserlistQuery: QueryParam[Boolean], emojisetQuery: QueryParam[String], demoteInactiveStreamsQuery: QueryParam[Integer], timezoneQuery: QueryParam[String], enableStreamDesktopNotificationsQuery: QueryParam[Boolean], enableStreamEmailNotificationsQuery: QueryParam[Boolean], enableStreamPushNotificationsQuery: QueryParam[Boolean], enableStreamAudibleNotificationsQuery: QueryParam[Boolean], notificationSoundQuery: QueryParam[String], enableDesktopNotificationsQuery: QueryParam[Boolean], enableSoundsQuery: QueryParam[Boolean], emailNotificationsBatchingPeriodSecondsQuery: QueryParam[Integer], enableOfflineEmailNotificationsQuery: QueryParam[Boolean], enableOfflinePushNotificationsQuery: QueryParam[Boolean], enableOnlinePushNotificationsQuery: QueryParam[Boolean], enableDigestEmailsQuery: QueryParam[Boolean], enableMarketingEmailsQuery: QueryParam[Boolean], enableLoginEmailsQuery: QueryParam[Boolean], messageContentInEmailNotificationsQuery: QueryParam[Boolean], pmContentInDesktopNotificationsQuery: QueryParam[Boolean], wildcardMentionsNotifyQuery: QueryParam[Boolean], desktopIconCountDisplayQuery: QueryParam[Integer], realmNameInNotificationsQuery: QueryParam[Boolean], presenceEnabledQuery: QueryParam[Boolean], enterSendsQuery: QueryParam[Boolean]): Task[JsonSuccessBase] = {
    implicit val returnTypeDecoder: EntityDecoder[JsonSuccessBase] = jsonOf[JsonSuccessBase]
  ...
  def updateStatus(host: String, statusText: String, away: Boolean, emojiName: String, emojiCode: String, reactionType: String)(implicit statusTextQuery: QueryParam[String], awayQuery: QueryParam[Boolean], emojiNameQuery: QueryParam[String], emojiCodeQuery: QueryParam[String], reactionTypeQuery: QueryParam[String]): Task[JsonSuccess] = {
    implicit val returnTypeDecoder: EntityDecoder[JsonSuccess] = jsonOf[JsonSuccess]

    val path = "/users/me/status"
    ...
    val queryParams = Query(
      ("statusText", Some(status_textQuery.toParamString(status_text))), ("away", Some(awayQuery.toParamString(away))), ("emojiName", Some(emoji_nameQuery.toParamString(emoji_name))), ("emojiCode", Some(emoji_codeQuery.toParamString(emoji_code))), ("reactionType", Some(reaction_typeQuery.toParamString(reaction_type))))
...
class HttpServiceUsersApi(service: HttpService) {
  ...
  def updateSettings(fullName: String, email: String, oldPassword: String, newPassword: String, twentyFourHourTime: Boolean, denseMode: Boolean, starredMessageCounts: Boolean, fluidLayoutWidth: Boolean, highContrastMode: Boolean, colorScheme: Integer, enableDraftsSynchronization: Boolean, translateEmoticons: Boolean, defaultLanguage: String, defaultView: String, leftSideUserlist: Boolean, emojiset: String, demoteInactiveStreams: Integer, timezone: String, enableStreamDesktopNotifications: Boolean, enableStreamEmailNotifications: Boolean, enableStreamPushNotifications: Boolean, enableStreamAudibleNotifications: Boolean, notificationSound: String, enableDesktopNotifications: Boolean, enableSounds: Boolean, emailNotificationsBatchingPeriodSeconds: Integer, enableOfflineEmailNotifications: Boolean, enableOfflinePushNotifications: Boolean, enableOnlinePushNotifications: Boolean, enableDigestEmails: Boolean, enableMarketingEmails: Boolean, enableLoginEmails: Boolean, messageContentInEmailNotifications: Boolean, pmContentInDesktopNotifications: Boolean, wildcardMentionsNotify: Boolean, desktopIconCountDisplay: Integer, realmNameInNotifications: Boolean, presenceEnabled: Boolean, enterSends: Boolean)(implicit fullNameQuery: QueryParam[String], emailQuery: QueryParam[String], oldPasswordQuery: QueryParam[String], newPasswordQuery: QueryParam[String], twentyFourHourTimeQuery: QueryParam[Boolean], denseModeQuery: QueryParam[Boolean], starredMessageCountsQuery: QueryParam[Boolean], fluidLayoutWidthQuery: QueryParam[Boolean], highContrastModeQuery: QueryParam[Boolean], colorSchemeQuery: QueryParam[Integer], enableDraftsSynchronizationQuery: QueryParam[Boolean], translateEmoticonsQuery: QueryParam[Boolean], defaultLanguageQuery: QueryParam[String], defaultViewQuery: QueryParam[String], leftSideUserlistQuery: QueryParam[Boolean], emojisetQuery: QueryParam[String], demoteInactiveStreamsQuery: QueryParam[Integer], timezoneQuery: QueryParam[String], enableStreamDesktopNotificationsQuery: QueryParam[Boolean], enableStreamEmailNotificationsQuery: QueryParam[Boolean], enableStreamPushNotificationsQuery: QueryParam[Boolean], enableStreamAudibleNotificationsQuery: QueryParam[Boolean], notificationSoundQuery: QueryParam[String], enableDesktopNotificationsQuery: QueryParam[Boolean], enableSoundsQuery: QueryParam[Boolean], emailNotificationsBatchingPeriodSecondsQuery: QueryParam[Integer], enableOfflineEmailNotificationsQuery: QueryParam[Boolean], enableOfflinePushNotificationsQuery: QueryParam[Boolean], enableOnlinePushNotificationsQuery: QueryParam[Boolean], enableDigestEmailsQuery: QueryParam[Boolean], enableMarketingEmailsQuery: QueryParam[Boolean], enableLoginEmailsQuery: QueryParam[Boolean], messageContentInEmailNotificationsQuery: QueryParam[Boolean], pmContentInDesktopNotificationsQuery: QueryParam[Boolean], wildcardMentionsNotifyQuery: QueryParam[Boolean], desktopIconCountDisplayQuery: QueryParam[Integer], realmNameInNotificationsQuery: QueryParam[Boolean], presenceEnabledQuery: QueryParam[Boolean], enterSendsQuery: QueryParam[Boolean]): Task[JsonSuccessBase] = {
    implicit val returnTypeDecoder: EntityDecoder[JsonSuccessBase] = jsonOf[JsonSuccessBase]
  ...
  def updateStatus(statusText: String, away: Boolean, emojiName: String, emojiCode: String, reactionType: String)(implicit statusTextQuery: QueryParam[String], awayQuery: QueryParam[Boolean], emojiNameQuery: QueryParam[String], emojiCodeQuery: QueryParam[String], reactionTypeQuery: QueryParam[String]): Task[JsonSuccess] = {
    implicit val returnTypeDecoder: EntityDecoder[JsonSuccess] = jsonOf[JsonSuccess]
