...
// BasicStreamAllOf struct for BasicStreamAllOf
...
func (o *BasicStreamAllOf) SetStreamId(v interface{}) {
	o.StreamId = v
}
...
func (o *BasicStreamAllOf) GetDescription() interface{} {
	if o == nil  {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BasicStreamAllOf) GetRenderedDescriptionOk() (*interface{}, bool) {
...
func (o BasicStreamAllOf) MarshalJSON() ([]byte, error) {
...
type NullableBasicStreamAllOf struct {
	value *BasicStreamAllOf
	isSet bool
}

func (v NullableBasicStreamAllOf) Get() *BasicStreamAllOf {
	return v.value
}

func (v *NullableBasicStreamAllOf) Set(val *BasicStreamAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableBasicStreamAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableBasicStreamAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBasicStreamAllOf(val *BasicStreamAllOf) *NullableBasicStreamAllOf {
	return &NullableBasicStreamAllOf{value: val, isSet: true}
}

func (v NullableBasicStreamAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBasicStreamAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
