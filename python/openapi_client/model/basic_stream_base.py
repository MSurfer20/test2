...
class BasicStreamBase(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            stream_id (int): The unique ID of the stream. . [optional]  # noqa: E501
            name (str): The name of the stream. . [optional]  # noqa: E501
            description (str): The short description of the stream in text/markdown format, intended to be used to prepopulate UI for editing a stream's description. . [optional]  # noqa: E501
            ...
            is_announcement_only (bool): Whether the given stream is announcement only or not.  **Changes**: Deprecated in Zulip 3.0 (feature level 1), use `stream_post_policy` instead. . [optional]  # noqa: E501
        """
