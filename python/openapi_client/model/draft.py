...
class Draft(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, to, topic, content, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            id (int): The unique ID of the draft. It will only used whenever the drafts are fetched. This field should not be specified when the draft is being created or edited. . [optional]  # noqa: E501
            timestamp (float): A Unix timestamp (seconds only) representing when the draft was last edited. When creating a draft, this key need not be present and it will be filled in automatically by the server. . [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, to, topic, content, *args, **kwargs):  # noqa: E501
        """Draft - a model defined in OpenAPI
