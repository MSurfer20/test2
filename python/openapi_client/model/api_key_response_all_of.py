...
class ApiKeyResponseAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, api_key, email, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, api_key, email, *args, **kwargs):  # noqa: E501
        """ApiKeyResponseAllOf - a model defined in OpenAPI
