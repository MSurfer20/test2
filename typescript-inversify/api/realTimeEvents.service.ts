...
export class RealTimeEventsService {
     ...
     */
    public deleteQueue(queueId: string, observe?: 'body', headers?: Headers): Observable<JsonSuccess>;
    public deleteQueue(queueId: string, observe?: 'response', headers?: Headers): Observable<HttpResponse<JsonSuccess>>;
    public deleteQueue(queueId: string, observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        const response: Observable<HttpResponse<JsonSuccess>> = this.httpClient.delete(`${this.basePath}/events?${queryParameters.join('&')}`, headers);
        if (observe === 'body') {
     ...
     */
    public getEvents(queueId: string, lastEventId?: number, dontBlock?: boolean, observe?: 'body', headers?: Headers): Observable<JsonSuccessBase & object>;
    public getEvents(queueId: string, lastEventId?: number, dontBlock?: boolean, observe?: 'response', headers?: Headers): Observable<HttpResponse<JsonSuccessBase & object>>;
    public getEvents(queueId: string, lastEventId?: number, dontBlock?: boolean, observe: any = 'body', headers: Headers = {}): Observable<any> {
        if (queueId === null || queueId === undefined){
        ...
        if (lastEventId !== undefined) {
            queryParameters.push('lastEventId='+encodeURIComponent(String(lastEventId)));
        }
        if (dontBlock !== undefined) {
            queryParameters.push('dontBlock='+encodeURIComponent(String(dontBlock)));
        }

        headers['Accept'] = 'application/json';

        const response: Observable<HttpResponse<JsonSuccessBase & object>> = this.httpClient.get(`${this.basePath}/events?${queryParameters.join('&')}`, headers);
        if (observe === 'body') {
               return response.pipe(
     ...
     */
    public realTimePost(eventTypes?: Array<string>, narrow?: Array<Array<string>>, allPublicStreams?: boolean, observe?: 'body', headers?: Headers): Observable<any>;
    public realTimePost(eventTypes?: Array<string>, narrow?: Array<Array<string>>, allPublicStreams?: boolean, observe?: 'response', headers?: Headers): Observable<HttpResponse<any>>;
    public realTimePost(eventTypes?: Array<string>, narrow?: Array<Array<string>>, allPublicStreams?: boolean, observe: any = 'body', headers: Headers = {}): Observable<any> {
        let queryParameters: string[] = [];
        if (eventTypes) {
        ...
        if (allPublicStreams !== undefined) {
            queryParameters.push('allPublicStreams='+encodeURIComponent(String(allPublicStreams)));
        }

        headers['Accept'] = 'application/json';

        const response: Observable<HttpResponse<any>> = this.httpClient.post(`${this.basePath}/real-time?${queryParameters.join('&')}`, headers);
        if (observe === 'body') {
               return response.pipe(
     ...
     */
    public registerQueue(applyMarkdown?: boolean, clientGravatar?: boolean, slimPresence?: boolean, eventTypes?: Array<string>, allPublicStreams?: boolean, includeSubscribers?: boolean, clientCapabilities?: object, fetchEventTypes?: Array<string>, narrow?: Array<Array<string>>, observe?: 'body', headers?: Headers): Observable<JsonSuccessBase & object>;
    public registerQueue(applyMarkdown?: boolean, clientGravatar?: boolean, slimPresence?: boolean, eventTypes?: Array<string>, allPublicStreams?: boolean, includeSubscribers?: boolean, clientCapabilities?: object, fetchEventTypes?: Array<string>, narrow?: Array<Array<string>>, observe?: 'response', headers?: Headers): Observable<HttpResponse<JsonSuccessBase & object>>;
    public registerQueue(applyMarkdown?: boolean, clientGravatar?: boolean, slimPresence?: boolean, eventTypes?: Array<string>, allPublicStreams?: boolean, includeSubscribers?: boolean, clientCapabilities?: object, fetchEventTypes?: Array<string>, narrow?: Array<Array<string>>, observe: any = 'body', headers: Headers = {}): Observable<any> {
        let queryParameters: string[] = [];
        ...
        if (slimPresence !== undefined) {
            queryParameters.push('slimPresence='+encodeURIComponent(String(slimPresence)));
        }
        if (eventTypes) {
            eventTypes.forEach((element) => {
                queryParameters.push('eventTypes='+encodeURIComponent(String(element)));
        ...
        if (clientCapabilities !== undefined) {
            queryParameters.push('clientCapabilities='+encodeURIComponent(String(clientCapabilities)));
        }
        if (fetchEventTypes) {
            fetchEventTypes.forEach((element) => {
                queryParameters.push('fetchEventTypes='+encodeURIComponent(String(element)));
            })
        }
        if (narrow) {
            narrow.forEach((element) => {
        ...
        const response: Observable<HttpResponse<JsonSuccessBase & object>> = this.httpClient.post(`${this.basePath}/register?${queryParameters.join('&')}`, headers);
        if (observe === 'body') {
               return response.pipe(
                   map((httpResponse: HttpResponse) => <JsonSuccessBase & object>(httpResponse.response))
               );
     ...
     */
    public restErrorHandling(observe?: 'body', headers?: Headers): Observable<any>;
    public restErrorHandling(observe?: 'response', headers?: Headers): Observable<HttpResponse<any>>;
    public restErrorHandling(observe: any = 'body', headers: Headers = {}): Observable<any> {
        headers['Accept'] = 'application/json';

        const response: Observable<HttpResponse<any>> = this.httpClient.post(`${this.basePath}/rest-error-handling`, headers);
        if (observe === 'body') {
               return response.pipe(
                   map((httpResponse: HttpResponse) => <any>(httpResponse.response))
               );
