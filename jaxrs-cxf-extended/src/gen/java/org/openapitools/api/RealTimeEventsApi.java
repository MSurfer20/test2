...
public interface RealTimeEventsApi  {
    ...
    @ApiOperation(value = "Delete an event queue", tags={ "real_time_events" })
    @ApiResponses(value = { 
    ...
    public JsonSuccess deleteQueue(@QueryParam("queue_id") @NotNull  String queueId);
    ...
    @Path("/events")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get events from an event queue", tags={ "real_time_events" })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success.", response = JsonSuccessBase.class),
        @ApiResponse(code = 400, message = "Bad request.", response = BadEventQueueIdError.class) })
    public JsonSuccessBase getEvents(@QueryParam("queue_id") @NotNull  String queueId, @QueryParam("last_event_id")  Integer lastEventId, @QueryParam("dont_block")  @DefaultValue("false") Boolean dontBlock);

    @POST
    @Path("/real-time")
    @ApiOperation(value = "", tags={ "real_time_events" })
    @ApiResponses(value = { 
    ...
    @Path("/register")
    @Produces({ "application/json" })
    @ApiOperation(value = "Register an event queue", tags={ "real_time_events" })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success.", response = JsonSuccessBase.class) })
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Error handling", tags={ "real_time_events" })
    @ApiResponses(value = { 
