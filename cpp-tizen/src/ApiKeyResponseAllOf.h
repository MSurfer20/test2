...
#ifndef _ApiKeyResponse_allOf_H_
#define _ApiKeyResponse_allOf_H_
...
class ApiKeyResponse_allOf : public Object {
public:
	/*! \brief Constructor.
	 */
	ApiKeyResponse_allOf();
	ApiKeyResponse_allOf(char* str);
...
#endif /* _ApiKeyResponse_allOf_H_ */
