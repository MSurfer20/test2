...
#ifndef _AddSubscriptionsResponse_allOf_H_
#define _AddSubscriptionsResponse_allOf_H_
...
class AddSubscriptionsResponse_allOf : public Object {
public:
	/*! \brief Constructor.
	 */
	AddSubscriptionsResponse_allOf();
	AddSubscriptionsResponse_allOf(char* str);
...
#endif /* _AddSubscriptionsResponse_allOf_H_ */
