...
void
NonExistingStreamError_allOf::__init()
{
	//result = null;
	//msg = null;
	//code = null;
...
void
NonExistingStreamError_allOf::__cleanup()
{
	//if(result != NULL) {
	//
	//delete result;
...
void
NonExistingStreamError_allOf::fromJson(char* jsonStr)
{
...
NonExistingStreamError_allOf::NonExistingStreamError_allOf(char* json)
{
	this->fromJson(json);
}
