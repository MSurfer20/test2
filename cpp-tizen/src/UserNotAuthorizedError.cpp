...
void
UserNotAuthorizedError::__cleanup()
{
	//if(result != NULL) {
	//
	//delete result;
...
void
UserNotAuthorizedError::fromJson(char* jsonStr)
{
...
UserNotAuthorizedError::UserNotAuthorizedError(char* json)
{
	this->fromJson(json);
}
