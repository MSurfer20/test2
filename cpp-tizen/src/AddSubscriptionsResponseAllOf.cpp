...
void
AddSubscriptionsResponse_allOf::__init()
{
	//result = null;
	//msg = null;
...
void
AddSubscriptionsResponse_allOf::__cleanup()
{
	//if(result != NULL) {
	//
	//delete result;
...
void
AddSubscriptionsResponse_allOf::fromJson(char* jsonStr)
{
...
AddSubscriptionsResponse_allOf::AddSubscriptionsResponse_allOf(char* json)
{
	this->fromJson(json);
}
...
void
AddSubscriptionsResponse_allOf::setSubscribed(std::map <string, string> subscribed)
{
...
void
AddSubscriptionsResponse_allOf::setAlreadySubscribed(std::map <string, string> already_subscribed)
{
