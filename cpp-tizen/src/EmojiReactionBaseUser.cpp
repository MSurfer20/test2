...
void
EmojiReactionBase_user::__cleanup()
{
	//if(id != NULL) {
	//
	//delete id;
...
void
EmojiReactionBase_user::fromJson(char* jsonStr)
{
...
EmojiReactionBase_user::EmojiReactionBase_user(char* json)
{
	this->fromJson(json);
}
...
bool
EmojiReactionBase_user::getIsMirrorDummy()
{
