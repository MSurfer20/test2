...
#ifndef _EmojiReactionBase_user_H_
#define _EmojiReactionBase_user_H_
...
class EmojiReactionBase_user : public Object {
public:
	/*! \brief Constructor.
	 */
	EmojiReactionBase_user();
	EmojiReactionBase_user(char* str);
...
#endif /* _EmojiReactionBase_user_H_ */
