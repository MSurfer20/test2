...
class UsersApi(baseUrl: String) {
  ...
  def updateNotificationSettings(enableStreamDesktopNotifications: Option[Boolean] = None, enableStreamEmailNotifications: Option[Boolean] = None, enableStreamPushNotifications: Option[Boolean] = None, enableStreamAudibleNotifications: Option[Boolean] = None, notificationSound: Option[String] = None, enableDesktopNotifications: Option[Boolean] = None, enableSounds: Option[Boolean] = None, enableOfflineEmailNotifications: Option[Boolean] = None, enableOfflinePushNotifications: Option[Boolean] = None, enableOnlinePushNotifications: Option[Boolean] = None, enableDigestEmails: Option[Boolean] = None, enableMarketingEmails: Option[Boolean] = None, enableLoginEmails: Option[Boolean] = None, messageContentInEmailNotifications: Option[Boolean] = None, pmContentInDesktopNotifications: Option[Boolean] = None, wildcardMentionsNotify: Option[Boolean] = None, desktopIconCountDisplay: Option[Int] = None, realmNameInNotifications: Option[Boolean] = None, presenceEnabled: Option[Boolean] = None
    ...
    basicRequest
      .method(Method.PATCH, uri"$baseUrl/settings/notifications?enable_stream_desktop_notifications=${ enableStreamDesktopNotifications }&enable_stream_email_notifications=${ enableStreamEmailNotifications }&enable_stream_push_notifications=${ enableStreamPushNotifications }&enable_stream_audible_notifications=${ enableStreamAudibleNotifications }&notification_sound=${ notificationSound }&enable_desktop_notifications=${ enableDesktopNotifications }&enable_sounds=${ enableSounds }&enable_offline_email_notifications=${ enableOfflineEmailNotifications }&enable_offline_push_notifications=${ enableOfflinePushNotifications }&enable_online_push_notifications=${ enableOnlinePushNotifications }&enable_digest_emails=${ enableDigestEmails }&enable_marketing_emails=${ enableMarketingEmails }&enable_login_emails=${ enableLoginEmails }&message_content_in_email_notifications=${ messageContentInEmailNotifications }&pm_content_in_desktop_notifications=${ pmContentInDesktopNotifications }&wildcard_mentions_notify=${ wildcardMentionsNotify }&desktop_icon_count_display=${ desktopIconCountDisplay }&realm_name_in_notifications=${ realmNameInNotifications }&presence_enabled=${ presenceEnabled }")
      .contentType("application/json")
      .response(asJson[JsonSuccessBase])
