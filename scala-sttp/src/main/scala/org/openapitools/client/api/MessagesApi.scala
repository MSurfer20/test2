...
class MessagesApi(baseUrl: String) {
   ...
   */
  def addReaction(messageId: Int, emojiName: String, emojiCode: Option[String] = None, reactionType: Option[String] = None
): Request[Either[ResponseError[Exception], JsonSuccess], Nothing] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/messages/${messageId}/reactions?emoji_name=${ emojiName }&emoji_code=${ emojiCode }&reaction_type=${ reactionType }")
   ...
   */
  def checkMessagesMatchNarrow(msgIds: Seq[Int], narrow: Seq[Any]
): Request[Either[ResponseError[Exception], AnyType], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/messages/matches_narrow?msg_ids=${ msgIds }&narrow=${ narrow }")
      .contentType("application/json")
  ...
  def deleteMessage(messageId: Int
    ...
    basicRequest
      .method(Method.DELETE, uri"$baseUrl/messages/${messageId}")
      .contentType("application/json")
      .response(asJson[JsonSuccess])
  ...
  def getFileTemporaryUrl(realmIdStr: Int, filename: String
    ...
    basicRequest
      .method(Method.GET, uri"$baseUrl/user_uploads/${realmIdStr}/${filename}")
      .contentType("application/json")
  ...
  def getMessageHistory(messageId: Int
    ...
    basicRequest
      .method(Method.GET, uri"$baseUrl/messages/${messageId}/history")
      .contentType("application/json")
      .response(asJson[JsonSuccessBase])
   ...
   */
  def getMessages(numBefore: Int, numAfter: Int, anchor: Option[OneOfstringinteger] = None, narrow: Seq[Any], clientGravatar: Option[Boolean] = None, applyMarkdown: Option[Boolean] = None, useFirstUnreadAnchor: Option[Boolean] = None
): Request[Either[ResponseError[Exception], JsonSuccessBase], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/messages?anchor=${ anchor }&num_before=${ numBefore }&num_after=${ numAfter }&narrow=${ narrow }&client_gravatar=${ clientGravatar }&apply_markdown=${ applyMarkdown }&use_first_unread_anchor=${ useFirstUnreadAnchor }")
      .contentType("application/json")
      .response(asJson[JsonSuccessBase])
  ...
  def getRawMessage(messageId: Int
    ...
    basicRequest
      .method(Method.GET, uri"$baseUrl/messages/${messageId}")
      .contentType("application/json")
      .response(asJson[JsonSuccessBase])
  ...
  def markAllAsRead(
    ...
    basicRequest
      .method(Method.POST, uri"$baseUrl/mark_all_as_read")
      .contentType("application/json")
      .response(asJson[JsonSuccess])
  ...
  def markStreamAsRead(streamId: Int
    ...
    basicRequest
      .method(Method.POST, uri"$baseUrl/mark_stream_as_read?stream_id=${ streamId }")
      .contentType("application/json")
      .response(asJson[JsonSuccess])
  ...
  def markTopicAsRead(streamId: Int, topicName: String
    ...
    basicRequest
      .method(Method.POST, uri"$baseUrl/mark_topic_as_read?stream_id=${ streamId }&topic_name=${ topicName }")
      .contentType("application/json")
      .response(asJson[JsonSuccess])
   ...
   * @param reactionType If an app is adding/removing a vote on an existing reaction, it should pass this parameter using the value the server provided for the existing reaction for specificity.  Supported values:  * `unicode_emoji`: Unicode emoji (`emoji_code` will be its Unicode codepoint). * `realm_emoji`: Custom emoji. (`emoji_code` will be its ID). * `zulip_extra_emoji`: Special emoji included with Zulip.  Exists to    namespace the `zulip` emoji.  **Changes**: In Zulip 3.0 (feature level 2), this become optional for [custom emoji](/help/add-custom-emoji); previously, this endpoint assumed `unicode_emoji` if this parameter was not specified. 
   */
  def removeReaction(messageId: Int, emojiName: Option[String] = None, emojiCode: Option[String] = None, reactionType: Option[String] = None
): Request[Either[ResponseError[Exception], JsonSuccess], Nothing] =
    basicRequest
      .method(Method.DELETE, uri"$baseUrl/messages/${messageId}/reactions?emoji_name=${ emojiName }&emoji_code=${ emojiCode }&reaction_type=${ reactionType }")
      .contentType("application/json")
      .response(asJson[JsonSuccess])
  ...
  def renderMessage(content: String
    ...
    basicRequest
      .method(Method.POST, uri"$baseUrl/messages/render?content=${ content }")
      .contentType("application/json")
      .response(asJson[JsonSuccessBase])
   ...
   */
  def sendMessage(`type`: String, to: Seq[Int], content: String, topic: Option[String] = None, queueId: Option[String] = None, localId: Option[String] = None
): Request[Either[ResponseError[Exception], JsonSuccessBase], Nothing] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/messages?type=${ `type` }&to=${ to }&content=${ content }&topic=${ topic }&queue_id=${ queueId }&local_id=${ localId }")
      .contentType("application/json")
      .response(asJson[JsonSuccessBase])
   ...
   */
  def updateMessage(messageId: Int, topic: Option[String] = None, propagateMode: Option[String] = None, sendNotificationToOldThread: Option[Boolean] = None, sendNotificationToNewThread: Option[Boolean] = None, content: Option[String] = None, streamId: Option[Int] = None
): Request[Either[ResponseError[Exception], JsonSuccess], Nothing] =
    basicRequest
      .method(Method.PATCH, uri"$baseUrl/messages/${messageId}?topic=${ topic }&propagate_mode=${ propagateMode }&send_notification_to_old_thread=${ sendNotificationToOldThread }&send_notification_to_new_thread=${ sendNotificationToNewThread }&content=${ content }&stream_id=${ streamId }")
      .contentType("application/json")
      .response(asJson[JsonSuccess])
   ...
   */
  def updateMessageFlags(messages: Seq[Int], op: String, flag: String
): Request[Either[ResponseError[Exception], JsonSuccessBase], Nothing] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/messages/flags?messages=${ messages }&op=${ op }&flag=${ flag }")
      .contentType("application/json")
      .response(asJson[JsonSuccessBase])
  ...
  def uploadFile(filename: Option[File] = None
    ...
    basicRequest
      .method(Method.POST, uri"$baseUrl/user_uploads")
