...
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaJAXRSSpecServerCodegen", date = "2021-08-08T21:20:13.432792Z[Etc/UTC]")public class Subscriptions   {
  ...
  private @Valid List<Integer> subscribers = new ArrayList<Integer>();
  private @Valid Boolean desktopNotifications;
  private @Valid Boolean emailNotifications;
  private @Valid Boolean wildcardMentionsNotify;
  private @Valid Boolean pushNotifications;
  private @Valid Boolean audibleNotifications;
  private @Valid Boolean pinToTop;
  private @Valid String emailAddress;
  private @Valid Boolean isMuted;
  private @Valid Boolean inHomeView;
  private @Valid Boolean isAnnouncementOnly;
  private @Valid Boolean isWebPublic;

public enum RoleEnum {

    NUMBER_20(Integer.valueOf(20)), NUMBER_50(Integer.valueOf(50));
  ...
  private @Valid Integer streamWeeklyTraffic;
