...
/// * [timestamp] 
/// * [type] 
abstract class MessagesAllOf implements Built<MessagesAllOf, MessagesAllOfBuilder> {
    ...
    static void _initializeBuilder(MessagesAllOfBuilder b) => b;

    factory MessagesAllOf([void updates(MessagesAllOfBuilder b)]) = _$MessagesAllOf;

    @BuiltValueSerializer(custom: true)
    static Serializer<MessagesAllOf> get serializer => _$MessagesAllOfSerializer();
}

class _$MessagesAllOfSerializer implements StructuredSerializer<MessagesAllOf> {
    @override
    final Iterable<Type> types = const [MessagesAllOf, _$MessagesAllOf];

    @override
    final String wireName = r'MessagesAllOf';

    @override
    Iterable<Object?> serialize(Serializers serializers, MessagesAllOf object,
    ...
    @override
    MessagesAllOf deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = MessagesAllOfBuilder();
