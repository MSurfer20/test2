...
class DraftsApi {
  ...
  ///
  /// Parameters:
  /// * [drafts] - A JSON-encoded list of containing new draft objects. 
  ...
  Future<Response<JsonSuccess>> createDrafts({ 
    ...
    final _queryParameters = <String, dynamic>{
      if (drafts != null) r'drafts': encodeCollectionQueryParameter<Draft>(_serializers, drafts, const FullType(BuiltList, [FullType(Draft)]), format: ListFormat.multi),
    };
  ...
  ///
  /// Parameters:
  /// * [draftId] - The ID of the draft you want to delete. 
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<JsonSuccess>> deleteDraft({ 
    ...
    final _path = r'/drafts/{draft_id}'.replaceAll('{' r'draft_id' '}', draftId.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  ///
  /// Parameters:
  /// * [draftId] - The ID of the draft to be edited. 
  /// * [draft] - A JSON-encoded object containing a replacement draft object for this ID. 
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<JsonSuccess>> editDraft({ 
    ...
    final _queryParameters = <String, dynamic>{
      r'draft': encodeQueryParameter(_serializers, draft, const FullType(Draft)),
    };
