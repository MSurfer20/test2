...
void main() {
  ...
  group(UsersApi, () {
    ...
    //
    //Future<JsonSuccess> createUserGroup(String name, String description, BuiltList<int> members) async
    ...
    //
    //Future<JsonObject> reactivateUser(int userId) async
    ...
    //
    //Future<JsonSuccess> setTypingStatus(String op, BuiltList<int> to, { String type, String topic }) async
    ...
    //
    //Future<JsonSuccess> updateUser(int userId, { String fullName, int role, BuiltList<JsonObject> profileData }) async
    ...
    //
    //Future<JsonSuccess> updateUserGroupMembers(int userGroupId, { BuiltList<int> delete, BuiltList<int> add }) async
