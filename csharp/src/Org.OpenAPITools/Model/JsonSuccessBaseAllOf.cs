...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class JsonSuccessBaseAllOf :  IEquatable<JsonSuccessBaseAllOf>, IValidatableObject
    {
        ...
        public JsonSuccessBaseAllOf(ResultEnum result = default(ResultEnum), string msg = default(string))
        {
            ...
            if (result == null)
            {
                throw new InvalidDataException("result is a required property for JsonSuccessBaseAllOf and cannot be null");
            }
            else
            {
                this.Result = result;
            ...
            if (msg == null)
            {
                throw new InvalidDataException("msg is a required property for JsonSuccessBaseAllOf and cannot be null");
            }
            else
            {
                this.Msg = msg;
