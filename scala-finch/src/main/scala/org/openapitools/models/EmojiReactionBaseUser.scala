 ...
 */
case class EmojiReactionBaseUser(id: Option[Int],
                email: Option[String],
...
object EmojiReactionBaseUser {
    /**
     * Creates the codec for converting EmojiReactionBaseUser from and to JSON.
     */
    implicit val decoder: Decoder[EmojiReactionBaseUser] = deriveDecoder
    implicit val encoder: ObjectEncoder[EmojiReactionBaseUser] = deriveEncoder
}
