 ...
 */
case class GetMessagesAllOf(avatarUnderscoreurl: Option[AnyType],
...
object GetMessagesAllOf {
    /**
     * Creates the codec for converting GetMessagesAllOf from and to JSON.
     */
    implicit val decoder: Decoder[GetMessagesAllOf] = deriveDecoder
    implicit val encoder: ObjectEncoder[GetMessagesAllOf] = deriveEncoder
}
