...
import org.openapitools.models.BasicStreamAllOf
import org.openapitools.models.BasicStreamBase
 ...
 */
case class BasicStream(streamUnderscoreid: Option[AnyType],
                name: Option[AnyType],
...
object BasicStream {
    /**
     * Creates the codec for converting BasicStream from and to JSON.
     */
    implicit val decoder: Decoder[BasicStream] = deriveDecoder
    implicit val encoder: ObjectEncoder[BasicStream] = deriveEncoder
}
