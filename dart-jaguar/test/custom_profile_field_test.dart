...
void main() {
  var instance = new CustomProfileField();

  group('test CustomProfileField', () {
    ...
    // String hint (default value: null)
    ...
    // String fieldData (default value: null)
